...
public class class_all extends Block {
	...
	public void b(class_ago var1, class_cj var2, class_apn var3, Random var4) {
		if (!var1.D) {
			if ((var1.l(var2.a()) < 4) && (var1.p(var2.a()).c().r() > 2)) {
				var1.a(var2, Blocks.d.S().a(class_ajl.a, class_ajl.class_a_in_class_ajl.a));
			} else {
				if (var1.l(var2.a()) >= 9) {
					for (int var5 = 0; var5 < 4; ++var5) {
						...
						if ((var7.c() == Blocks.d) && (var7.b(class_ajl.a) == class_ajl.class_a_in_class_ajl.a) && (var1.l(var6.a()) >= 4) && (var8.r() <= 2)) {
							var1.a(var6, S());
						}
					}
				}
