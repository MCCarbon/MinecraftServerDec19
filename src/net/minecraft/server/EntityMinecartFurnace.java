...
public class EntityMinecartFurnace extends EntityMinecartAbstract {
	...
	public EntityMinecartFurnace(class_ago var1) {
		super(var1);
	}

	public EntityMinecartFurnace(class_ago var1, double var2, double var4, double var6) {
	...
	@Override
	public class_apn u() {
		return (this.i() ? Blocks.LIT_FURNACE : Blocks.FURNACE).getBlockData().a(class_akj.a, class_cq.c);
	}

	static {
		c = DataWatcher.claimId(EntityMinecartFurnace.class, class_kb.g);
	}
}
