...
public class class_amm extends Block {
	...
	public static final class_aqa O = class_aqa.a("west", class_amm.class_a_in_class_amm.class);
	...
	public class_amm() {
		super(class_avq.q);
		this.j(M.b().a(a, class_amm.class_a_in_class_amm.c).a(b, class_amm.class_a_in_class_amm.c).a(N, class_amm.class_a_in_class_amm.c).a(O, class_amm.class_a_in_class_amm.c).a(P, Integer.valueOf(0)));
	...
	public class_apn a(class_apn var1, Block.class_c_in_class_ail var2) {
		if (var1.c() != this) {
			...
			switch (class_amm.SyntheticClass_1.a[var2.ordinal()]) {
				case 1:
	...
	public class_apn a(class_apn var1, Block.class_a_in_class_ail var2) {
		if (var1.c() != this) {
			...
			switch (class_amm.SyntheticClass_1.b[var2.ordinal()]) {
				case 1:
