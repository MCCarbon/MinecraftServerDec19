...
public class BlockPistonExtension extends class_ajk {
	public static final class_aqa a = class_aqa.a("type", BlockPistonExtension.class_a_in_class_aph.class);
	public static final class_apy N = class_apy.a("short");

	public BlockPistonExtension() {
		super(class_avq.H);
		this.j(M.b().a(b, class_cq.c).a(a, BlockPistonExtension.class_a_in_class_aph.a).a(N, Boolean.valueOf(false)));
		this.a(i);
		this.c(0.5F);
	}
	...
	private void e(class_apn var1) {
		...
		float var5 = 0.25F;
		float var6 = 0.75F;
		switch (BlockPistonExtension.SyntheticClass_1.a[((class_cq) var1.b(b)).ordinal()]) {
			case 1:
	...
	public int c(class_apn var1) {
		...
		if (var1.b(a) == BlockPistonExtension.class_a_in_class_aph.b) {
			var3 |= 8;
		}
