...
public class EntityBoat extends Entity {
	...
	public EntityBoat(class_ago var1) {
		super(var1);
		d = true;
		e = 0.07D;
		k = true;
	...
	public EntityBoat(class_ago var1, double var2, double var4, double var6) {
		this(var1);
	...
	public void r_() {
		...
		if (o.D && d) {
			...
			if (l instanceof EntityLiving) {
				EntityLiving var20 = (EntityLiving) l;
			...
			if (!o.D) {
				...
				if ((var16 != null) && !var16.isEmpty()) {
					for (int var29 = 0; var29 < var16.size(); ++var29) {
						...
						if ((var18 != l) && var18.ah() && (var18 instanceof EntityBoat)) {
							var18.i(this);
						}
					}
				}
	...
	static {
		a = DataWatcher.claimId(EntityBoat.class, class_kb.b);
		b = DataWatcher.claimId(EntityBoat.class, class_kb.b);
		c = DataWatcher.claimId(EntityBoat.class, class_kb.c);
	}
}
