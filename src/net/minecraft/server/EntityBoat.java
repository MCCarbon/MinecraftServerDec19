...
public class EntityBoat extends Entity {
   private static final int a = Datawathcer.claimId(EntityBoat.class);
   private static final int b = Datawathcer.claimId(EntityBoat.class);
   private static final int c = Datawathcer.claimId(EntityBoat.class);
   private boolean d;
   private double e;
   private int f;
   private double g;
