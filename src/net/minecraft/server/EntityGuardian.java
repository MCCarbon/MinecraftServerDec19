...
public class EntityGuardian extends EntityMonster {
	...
	public EntityGuardian(class_ago var1) {
		super(var1);
		b_ = 10;
		this.a(0.85F, 0.85F);
		i.a(4, new EntityGuardian.class_a_in_class_ya(this));
		class_td var2;
		i.a(5, var2 = new class_td(this, 1.0D));
		i.a(7, bA = new class_tn(this, 1.0D, 80));
		i.a(8, new class_sw(this, class_yu.class, 8.0F));
		i.a(8, new class_sw(this, EntityGuardian.class, 12.0F, 0.01F));
		i.a(9, new class_tm(this));
		bA.a(3);
		var2.a(3);
		bo.a(1, new class_uf(this, EntityLiving.class, 10, true, false, new EntityGuardian.class_b_in_class_ya(this)));
		f = new EntityGuardian.class_c_in_class_ya(this);
		bt = c = V.nextFloat();
	}
			...
			if (((W + G()) % 1200) == 0) {
				...
				List var6 = o.b(class_lm.class, new Predicate() {
					public boolean a(class_lm var1) {
						return (EntityGuardian.this.h(var1) < 2500.0D) && var1.c.c();
					}
	...
	static {
		a = DataWatcher.claimId(EntityGuardian.class, class_kb.a);
		b = DataWatcher.claimId(EntityGuardian.class, class_kb.b);
	}

	static class class_c_in_class_ya extends class_se {
		private EntityGuardian g;

		public class_c_in_class_ya(EntityGuardian var1) {
			super(var1);
			g = var1;
		}
	...
	static class class_a_in_class_ya extends class_sr {
		...
		public class_a_in_class_ya(EntityGuardian var1) {
			a = var1;
			this.a(3);
		}
	...
	static class class_b_in_class_ya implements Predicate {
		...
		public class_b_in_class_ya(EntityGuardian var1) {
			a = var1;
		}

		public boolean a(EntityLiving var1) {
			return ((var1 instanceof class_yu) || (var1 instanceof EntitySquid)) && (var1.h(a) > 9.0D);
		}
