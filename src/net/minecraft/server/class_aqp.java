...
public class class_aqp extends class_aql {
   public boolean b(class_aen var1, Random var2, class_cj var3) {
      if(!var1.d(var3)) {
         return false;
      } else if(var1.p(var3.a()).getBlock() != class_agk.aV) {
         return false;
      } else {
         var1.a((class_cj)var3, (IBlockData)class_agk.aX.S(), 2);
         ...
         for(int var4 = 0; var4 < 1500; ++var4) {
            ...
            if(var1.p(var5).getBlock().v() == class_atk.a) {
               int var6 = 0;
               ...
               for(int var9 = 0; var9 < var8; ++var9) {
                  ...
                  if(var1.p(var5.a(var10)).getBlock() == class_agk.aX) {
                     ++var6;
                  }
               ...
               if(var6 == 1) {
                  var1.a((class_cj)var5, (IBlockData)class_agk.aX.S(), 2);
               }
            }
         }
