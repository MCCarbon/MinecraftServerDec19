...
public class EntityPotion extends class_zj {
	private class_aco d;
	private boolean e;

	public EntityPotion(class_ago var1) {
		super(var1);
		d = class_adb.a(new class_aco(Items.bB), class_aee.a);
	}

	public EntityPotion(class_ago var1, EntityLiving var2, class_aco var3, boolean var4) {
		super(var1, var2);
		d = class_adb.a(new class_aco(Items.bB), class_aee.a);
		d = var3;
		e = var4;
	...
	public EntityPotion(class_ago var1, double var2, double var4, double var6, class_aco var8, boolean var9) {
		...
		if (!o.D) {
			...
			if ((var1.a == class_ayl.class_a_in_class_ayl.b) && (var2 == class_aee.a) && var3.isEmpty()) {
				...
				if (!var3.isEmpty()) {
					...
					double var22;
					if (e) {
						List var4 = o.a(EntityLiving.class, aX().b(4.0D, 2.0D, 4.0D));
						EntityAreaEffectCloud var5 = new EntityAreaEffectCloud(o, s, t, u);
						var5.a(this.j());
						var5.a(3.0F);
						var5.b(-0.5F);
						var5.c(10);
						...
						List var18 = o.a(EntityLiving.class, var16);
						if (!var18.isEmpty()) {
							var6 = var18.iterator();
	...
	private void a(class_cj var1) {
		if (o.p(var1).c() == Blocks.FIRE) {
			o.a(var1, Blocks.AIR.getBlockData(), 2);
		}
