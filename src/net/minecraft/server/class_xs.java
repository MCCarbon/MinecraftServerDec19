...
public class class_xs extends class_yc {
	private float a = 0.5F;
	private int b;
	private static final class_jz c;

	public class_xs(class_ago var1) {
		super(var1);
		ab = true;
		b_ = 10;
		i.a(4, new class_xs.class_a_in_class_xs(this));
	...
	static {
		c = class_kc.a(class_xs.class, class_kb.a);
	}
	...
	static class class_a_in_class_xs extends class_sr {
		...
		public class_a_in_class_xs(class_xs var1) {
			a = var1;
			this.a(3);
		}
				...
				if (c <= 0) {
					...
					if (b > 1) {
						...
						for (int var11 = 0; var11 < 1; ++var11) {
							class_zg var12 = new class_zg(a.o, a, var4 + (a.bj().nextGaussian() * var10), var6, var8 + (a.bj().nextGaussian() * var10));
