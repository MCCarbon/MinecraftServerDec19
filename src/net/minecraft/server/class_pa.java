...
public class class_pa implements class_ok {
	...
	public class_dn a(class_dn var1) {
		if ("minecraft:potion".equals(var1.l("id"))) {
			class_dn var2 = var1.o("tag");
			short var3 = var1.g("Damage");
			if (!var2.b("Potion", 8)) {
				String var4 = a[var3 & 127];
				var2.a("Potion", var4 == null ? "minecraft:water" : var4);
				var1.a("tag", var2);
				if ((var3 & 16384) == 16384) {
					var1.a("id", "minecraft:splash_potion");
				}
			}
