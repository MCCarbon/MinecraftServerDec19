...
public class EntitySpider extends EntityMonster {
	...
	public EntitySpider(class_ago var1) {
		super(var1);
		this.a(1.4F, 0.9F);
		i.a(1, new class_so(this));
		i.a(3, new class_sv(this, 0.4F));
		i.a(4, new EntitySpider.class_a_in_class_yj(this, class_yu.class));
		i.a(4, new EntitySpider.class_a_in_class_yj(this, EntityVillagerGolem.class));
		...
		bo.a(2, new EntitySpider.class_c_in_class_yj(this, class_yu.class));
		bo.a(3, new EntitySpider.class_c_in_class_yj(this, EntityVillagerGolem.class));
	}
	...
	public class_rj a(class_pt var1, class_rj var2) {
		...
		if (o.s.nextInt(100) == 0) {
			EntitySkeleton var3 = new EntitySkeleton(o);
			var3.b(s, t, u, y, 0.0F);
		...
		if (var4 == null) {
			var4 = new EntitySpider.class_b_in_class_yj();
			if ((o.ac() == class_ps.d) && (o.s.nextFloat() < (0.1F * var1.c()))) {
				((EntitySpider.class_b_in_class_yj) var4).a(o.s);
			}
		}

		if (var4 instanceof EntitySpider.class_b_in_class_yj) {
			class_qq var5 = ((EntitySpider.class_b_in_class_yj) var4).a;
			if (var5 != null) {
	...
	static {
		a = DataWatcher.claimId(EntitySpider.class, class_kb.a);
	}

	static class class_c_in_class_yj extends class_uf {
		public class_c_in_class_yj(EntitySpider var1, Class var2) {
	...
	static class class_a_in_class_yj extends class_sz {
		public class_a_in_class_yj(EntitySpider var1, Class var2) {
