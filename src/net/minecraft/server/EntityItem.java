...
public class EntityItem extends Entity {
	...
	public EntityItem(class_ago var1, double var2, double var4, double var6) {
		super(var1);
		f = 5;
	...
	public EntityItem(class_ago var1, double var2, double var4, double var6, class_aco var8) {
	...
	public EntityItem(class_ago var1) {
		super(var1);
		f = 5;
		a = (float) (Math.random() * 3.141592653589793D * 2.0D);
		this.a(0.25F, 0.25F);
	...
	private void v() {
		Iterator var1 = o.a(EntityItem.class, aX().b(0.5D, 0.0D, 0.5D)).iterator();
	...
	public void d(class_yu var1) {
		if (!o.D) {
			...
			if ((e == 0) && ((h == null) || ((6000 - d) <= 200) || h.equals(var1.e_())) && var1.bq.a(var2)) {
				...
				var1.a(StatisticList.e(Item.b(var2.b())), var3);
			}
	...
	public Entity a(int var1, class_cj var2) {
		...
		if (!o.D && (var3 instanceof EntityItem)) {
			((EntityItem) var3).v();
		}
	...
	static {
		c = DataWatcher.claimId(EntityItem.class, class_kb.f);
	}
}
