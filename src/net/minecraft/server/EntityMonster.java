...
public abstract class EntityMonster extends EntityCreature implements class_xx {
	public EntityMonster(class_ago var1) {
		super(var1);
		b_ = 5;
	}
	...
	public boolean r(Entity var1) {
		...
		if (var1 instanceof EntityLiving) {
			var2 += class_afl.a(bG(), ((EntityLiving) var1).bF());
