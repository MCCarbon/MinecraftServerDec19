...
public class EntityShulkerBullet extends Entity {
	...
	public EntityShulkerBullet(class_ago var1) {
		super(var1);
		this.a(0.3125F, 0.3125F);
		T = true;
	}

	public EntityShulkerBullet(class_ago var1, EntityLiving var2, Entity var3, class_cq.class_a_in_class_cq var4) {
		this(var1);
		a = var2;
	...
	public void r_() {
		...
		if (!o.D) {
			...
			EntityLiving var3;
			if ((b == null) && (as != null)) {
				var1 = o.a(EntityLiving.class, new class_ayk(at.a(-2, -2, -2), at.a(2, 2, 2)));
				var2 = var1.iterator();
			...
			if ((a == null) && (h != null)) {
				var1 = o.a(EntityLiving.class, new class_ayk(i.a(-2, -2, -2), i.a(2, 2, 2)));
				var2 = var1.iterator();
		...
		if (var1.d == null) {
			...
			if (var2) {
				...
				if (var1.d instanceof EntityLiving) {
					((EntityLiving) var1.d).c(new class_qr(class_qs.y, 200));
				}
			}
		}
