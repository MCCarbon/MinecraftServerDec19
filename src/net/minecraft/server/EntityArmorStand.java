...
public class EntityArmorStand extends EntityLiving {
	...
	public EntityArmorStand(class_ago var1) {
		super(var1);
		bt = new class_aco[2];
		bu = new class_aco[4];
		bz = h;
	...
	public EntityArmorStand(class_ago var1, double var2, double var4, double var6) {
		this(var1);
	...
	public class_aco a(class_rc var1) {
		class_aco var2 = null;
		switch (EntityArmorStand.SyntheticClass_1.a[var1.a().ordinal()]) {
			case 1:
				var2 = bt[var1.b()];
				break;
			case 2:
	...
	public boolean c(int var1, class_aco var2) {
		...
		if ((var2 != null) && !EntityInsentient.b(var3, var2) && (var3 != class_rc.f)) {
			return false;
		} else {
			this.a(var3, var2);
			return true;
	...
	private void B() {
		if (o instanceof class_ll) {
			((class_ll) o).a(class_cy.M, s, t + (K / 1.5D), u, 10, J / 4.0F, K / 4.0F, J / 4.0F, 0.05D, new int[] { Block.f(Blocks.PLANKS.getBlockData()) });
		}
	...
	static {
		a = DataWatcher.claimId(EntityArmorStand.class, class_kb.a);
		b = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		c = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		d = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		e = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		f = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		g = DataWatcher.claimId(EntityArmorStand.class, class_kb.h);
		bs = new Predicate() {
			public boolean a(Entity var1) {
				return (var1 instanceof EntityMinecartAbstract) && (((EntityMinecartAbstract) var1).s() == EntityMinecartAbstract.EnumMinecartType.RIDEABLE);
			}
