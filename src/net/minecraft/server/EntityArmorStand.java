...
public class EntityArmorStand extends EntityLiving {
   ...
   static {
      a = 1 << EnumWearable.MAINHAND.getAbsolute();
      b = 1 << EnumWearable.FEET.getAbsolute();
      c = 1 << EnumWearable.LEGS.getAbsolute();
      d = 1 << EnumWearable.TORSO.getAbsolute();
      e = 1 << EnumWearable.HEAD.getAbsolute();
      f = 1 << EnumWearable.OFFHAND.getAbsolute();
      g = Datawathcer.claimId(EntityArmorStand.class);
      h = Datawathcer.claimId(EntityArmorStand.class);
      i = Datawathcer.claimId(EntityArmorStand.class);
      bn = Datawathcer.claimId(EntityArmorStand.class);
      bo = Datawathcer.claimId(EntityArmorStand.class);
      bp = Datawathcer.claimId(EntityArmorStand.class);
      bq = Datawathcer.claimId(EntityArmorStand.class);
   }
