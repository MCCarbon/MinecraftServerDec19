				...
				for (var30 = 0; var30 < 16; ++var30) {
					for (var8 = 0; var8 < 8; ++var8) {
						if (var4[(((var6 * 16) + var30) * 8) + var8]) {
							var1.a(var3.a(var6, var8, var30), var8 >= 4 ? Blocks.AIR.getBlockData() : a.getBlockData(), 2);
						}
					}
				}
			}
						...
						if (var4[(((var6 * 16) + var30) * 8) + var8]) {
							...
							if ((var1.p(var32).c() == Blocks.DIRT) && (var1.b(class_agu.a, var3.a(var6, var8, var30)) > 0)) {
								...
								if (var33.ak.c() == Blocks.MYCELIUM) {
									var1.a(var32, Blocks.MYCELIUM.getBlockData(), 2);
								} else {
									var1.a(var32, Blocks.GRASS.getBlockData(), 2);
								}
							}
						}
					}
					...
					for (var30 = 0; var30 < 16; ++var30) {
						for (var8 = 0; var8 < 8; ++var8) {
							...
							if (var31 && ((var8 < 4) || (var2.nextInt(2) != 0)) && var1.p(var3.a(var6, var8, var30)).c().v().a()) {
								var1.a(var3.a(var6, var8, var30), Blocks.STONE.getBlockData(), 2);
							}
						}
					}
				}
				...
				for (var6 = 0; var6 < 16; ++var6) {
					for (var30 = 0; var30 < 16; ++var30) {
						...
						if (var1.v(var3.a(var6, var34, var30))) {
							var1.a(var3.a(var6, var34, var30), Blocks.ICE.getBlockData(), 2);
						}
					}
				}
			}
