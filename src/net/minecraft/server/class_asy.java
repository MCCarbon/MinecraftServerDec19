...
public class class_asy extends class_asp {
	...
	public class_asy(class_ail var1) {
		a = var1;
	}
				...
				for (var30 = 0; var30 < 16; ++var30) {
					for (var8 = 0; var8 < 8; ++var8) {
						if (var4[(((var6 * 16) + var30) * 8) + var8]) {
							var1.a(var3.a(var6, var8, var30), var8 >= 4 ? class_aim.a.S() : a.S(), 2);
						}
					}
				}
			}
				...
				for (var30 = 0; var30 < 16; ++var30) {
					for (var8 = 4; var8 < 8; ++var8) {
						if (var4[(((var6 * 16) + var30) * 8) + var8]) {
							...
							if ((var1.p(var32).c() == class_aim.d) && (var1.b(class_agu.a, var3.a(var6, var8, var30)) > 0)) {
								class_ahb var33 = var1.b(var32);
								if (var33.ak.c() == class_aim.bw) {
									var1.a(var32, class_aim.bw.S(), 2);
								} else {
									var1.a(var32, class_aim.c.S(), 2);
								}
							}
						}
					}
					...
					for (var30 = 0; var30 < 16; ++var30) {
						for (var8 = 0; var8 < 8; ++var8) {
							...
							if (var31 && ((var8 < 4) || (var2.nextInt(2) != 0)) && var1.p(var3.a(var6, var8, var30)).c().v().a()) {
								var1.a(var3.a(var6, var8, var30), class_aim.b.S(), 2);
							}
						}
					}
				}
				...
				for (var6 = 0; var6 < 16; ++var6) {
					for (var30 = 0; var30 < 16; ++var30) {
						...
						if (var1.v(var3.a(var6, var34, var30))) {
							var1.a(var3.a(var6, var34, var30), class_aim.aI.S(), 2);
						}
					}
				}
			}
