...
public class EntityWither extends EntityMonster implements class_wk {
   private static final int a = Datawathcer.claimId(EntityWither.class);
   private static final int b = Datawathcer.claimId(EntityWither.class);
   private static final int c = Datawathcer.claimId(EntityWither.class);
   private static final int bs = Datawathcer.claimId(EntityWither.class);
