...
public class EntityFallingBlock extends Entity {
	...
	public EntityFallingBlock(class_ago var1) {
		super(var1);
	}

	public EntityFallingBlock(class_ago var1, double var2, double var4, double var6, class_apn var8) {
		super(var1);
		d = var8;
		k = true;
		this.a(0.98F, 0.98F);
