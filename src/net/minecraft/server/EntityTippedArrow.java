...
public class EntityTippedArrow extends EntityArrow {
	...
	public EntityTippedArrow(class_ago var1) {
		super(var1);
		g = Sets.newHashSet();
	}

	public EntityTippedArrow(class_ago var1, double var2, double var4, double var6) {
		super(var1, var2, var4, var6);
		g = Sets.newHashSet();
	}

	public EntityTippedArrow(class_ago var1, double var2, double var4, double var6, class_aco var8) {
		this(var1, var2, var4, var6);
		this.a(var8);
	}

	public EntityTippedArrow(class_ago var1, EntityLiving var2, class_aco var3) {
		super(var1, var2);
		g = Sets.newHashSet();
		this.a(var3);
	}
	...
	static {
		f = DataWatcher.claimId(EntityTippedArrow.class, class_kb.b);
	}
}
