...
public class class_acr {
   ...
   public void a(RecipeManager var1) {
      ...
      var1.a(new ItemStack(Items.GOLD_INGOT), new Object[]{"###", "###", "###", Character.valueOf('#'), Items.GOLD_NUGGEST});
      var1.a(new ItemStack(Items.GOLD_NUGGEST, 9), new Object[]{"#", Character.valueOf('#'), Items.GOLD_INGOT});
   }
}
