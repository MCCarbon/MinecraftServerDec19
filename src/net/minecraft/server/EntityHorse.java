...
public class EntityHorse extends EntityAnimal implements class_pq {
	private static final Predicate bz = new Predicate() {
		public boolean a(Entity var1) {
			return (var1 instanceof EntityHorse) && ((EntityHorse) var1).cT();
		}
	...
	public EntityHorse(class_ago var1) {
		super(var1);
		this.a(1.4F, 1.6F);
		ab = false;
		this.p(false);
	...
	public void g(float var1, float var2) {
		if ((l != null) && (l instanceof EntityLiving) && cZ()) {
			A = y = l.y;
			z = l.z * 0.5F;
			this.b(y, z);
			aO = aM = y;
			var1 = ((EntityLiving) l).bd * 0.5F;
			var2 = ((EntityLiving) l).be;
			if (var2 <= 0.0F) {
				var2 *= 0.25F;
				bZ = 0;
			}
	...
	public EntityAgeable a(EntityAgeable var1) {
		EntityHorse var2 = (EntityHorse) var1;
		EntityHorse var3 = new EntityHorse(o);
		int var4 = cE();
		int var5 = var2.cE();
		int var6 = 0;
		if (var4 == var5) {
	...
	public class_rj a(class_pt var1, class_rj var2) {
		...
		int var4 = 0;
		int var8;
		if (var7 instanceof EntityHorse.class_a_in_class_vf) {
			var8 = ((EntityHorse.class_a_in_class_vf) var7).a;
			var4 = (((EntityHorse.class_a_in_class_vf) var7).b & 255) | (V.nextInt(5) << 8);
		} else {
			if (V.nextInt(10) == 0) {
				var8 = 1;
			} else {
			...
			var7 = new EntityHorse.class_a_in_class_vf(var8, var4);
		}
	...
	static {
		bB = DataWatcher.claimId(EntityHorse.class, class_kb.a);
		bC = DataWatcher.claimId(EntityHorse.class, class_kb.b);
		bD = DataWatcher.claimId(EntityHorse.class, class_kb.b);
		bE = DataWatcher.claimId(EntityHorse.class, class_kb.l);
		bF = DataWatcher.claimId(EntityHorse.class, class_kb.b);
