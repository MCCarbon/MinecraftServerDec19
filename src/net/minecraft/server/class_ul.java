...
public class class_ul extends class_qj {
   ...
   public boolean a(EntityHuman var1, EnumUsedHand var2, ItemStack var3) {
      if(this.cA()) {
         if(var3 != null) {
            if(var3.getItem() instanceof ItemBeetroot) {
               ItemBeetroot var4 = (ItemBeetroot)var3.getItem();
   ...
   public boolean d(ItemStack var1) {
      return var1 == null?false:(!(var1.getItem() instanceof ItemBeetroot)?false:((ItemBeetroot)var1.getItem()).g());
   }
