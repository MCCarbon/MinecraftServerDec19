...
public class WorldServer extends World implements class_of {
   ...
   public boolean d(class_pr var1) {
      if(super.d(var1)) {
         this.I.getPlayerList().a(var1.s, var1.t, var1.u, 512.0D, this.t.p().a(), new PacketPlayOutSpawnEntityWeather(var1));
         return true;
      } else {
         return false;
      }
   ...
   public class_aej a(class_pr var1, double var2, double var4, double var6, float var8, boolean var9, boolean var10) {
      ...
      while(var12.hasNext()) {
         ...
         if(var13.e(var2, var4, var6) < 4096.0D) {
            ((class_lh)var13).a.a((Packet)(new PacketPlayOutExplosion(var2, var4, var6, var8, var11.e(), (Vec3D)var11.b().get(var13))));
         }
      }
   ...
   private void ak() {
      while(!this.S[this.T].isEmpty()) {
         ...
         while(var2.hasNext()) {
            ...
            if(this.a(var3)) {
               this.I.getPlayerList().a((double)var3.a().getX(), (double)var3.a().getY(), (double)var3.a().getZ(), 64.0D, this.t.p().a(), new PacketPlayOutBlockAction(var3.a(), var3.d(), var3.b(), var3.c()));
            }
         }
   ...
   protected void q() {
      ...
      super.q();
      if(this.o != this.p) {
         this.I.getPlayerList().a((Packet)(new PacketPlayOutGameStateChange(7, this.p)), this.t.p().a());
      }

      if(this.q != this.r) {
         this.I.getPlayerList().a((Packet)(new PacketPlayOutGameStateChange(8, this.r)), this.t.p().a());
      }
   ...
   public class_pr getEntityByUUID(UUID var1) {
