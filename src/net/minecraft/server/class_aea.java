...
public class class_aea {
   ...
   public class_aea(NBTTagCompound var1) {
      this.a(var1);
   }

   public class_aea(ItemStack var1, ItemStack var2, ItemStack var3) {
      this(var1, var2, var3, 0, 7);
   }

   public class_aea(ItemStack var1, ItemStack var2, ItemStack var3, int var4, int var5) {
      this.a = var1;
      this.b = var2;
      this.c = var3;
      this.d = var4;
   ...
   public class_aea(ItemStack var1, ItemStack var2) {
      this(var1, (ItemStack)null, var2);
   }

   public class_aea(ItemStack var1, Item var2) {
