...
public final class class_dy {
	public static GameProfile a(class_dn var0) {
		...
		if (class_of.b(var1) && class_of.b(var2)) {
			return null;
		} else {
			UUID var3;
			try {
			...
			if (var0.b("Properties", 10)) {
				class_dn var5 = var0.o("Properties");
				...
				while (var6.hasNext()) {
					...
					for (int var9 = 0; var9 < var8.c(); ++var9) {
						...
						String var11 = var10.l("Value");
						if (var10.b("Signature", 8)) {
							var4.getProperties().put(var7, new Property(var7, var11, var10.l("Signature")));
						} else {
	...
	public static class_dn a(class_dn var0, GameProfile var1) {
		...
		if (!var1.getProperties().isEmpty()) {
			...
			while (var3.hasNext()) {
				...
				class_dn var8;
				for (Iterator var6 = var1.getProperties().get(var4).iterator(); var6.hasNext(); var5.a(var8)) {
	...
	public static boolean a(class_eb var0, class_eb var1, boolean var2) {
		if (var0 == var1) {
			...
			do {
				...
				var13 = var9.c(var12);
			} while (a(var13, var10.c(var12), var2));
	...
	public static UUID b(class_dn var0) {
		return new UUID(var0.i("M"), var0.i("L"));
	}

	public static class_cj c(class_dn var0) {
		return new class_cj(var0.h("X"), var0.h("Y"), var0.h("Z"));
	}
