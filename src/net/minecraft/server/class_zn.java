   ...
   public class_or a(ItemStack var1, World var2, class_xa var3, EnumUsedHand var4) {
      ...
      if(var6 == null) {
         ...
         if(var6.a == class_awg.class_a_in_class_awg.b) {
            ...
            if(var9 == Material.WATER && ((Integer)var8.get(class_ajd.b)).intValue() == 0) {
               var2.g(var7);
               var3.b(class_nc.ad[Item.getId((Item)this)]);
               return new class_or(class_oq.a, this.a(var1, var3, Items.az));
            }

            if(var9 == Material.LAVA && ((Integer)var8.get(class_ajd.b)).intValue() == 0) {
               var2.g(var7);
               var3.b(class_nc.ad[Item.getId((Item)this)]);
      ...
      if(this.a == Blocks.AIR) {
         ...
         if(!var1.d(var2) && !var4) {
            ...
            if(var1.t.l() && this.a == Blocks.FLOWING_WATER) {
               ...
               var1.a((BlockPosition)var2, (IBlockData)this.a.getBlockData(), 3);
            }
