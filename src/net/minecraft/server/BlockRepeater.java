...
public class BlockRepeater extends class_ahh {
   ...
   protected IBlockData e(IBlockData var1) {
      ...
      return BlockStainedGlassPane.POWERED_REPEATER.getBlockData().set(FACING, var4).set(b, var2).set(a, var3);
   }
   ...
   protected IBlockData k(IBlockData var1) {
      ...
      Boolean var3 = (Boolean)var1.get(a);
      EnumDirection var4 = (EnumDirection)var1.get(FACING);
      return BlockStainedGlassPane.UNPOWERED_REPEATER.getBlockData().set(FACING, var4).set(b, var2).set(a, var3);
   }
