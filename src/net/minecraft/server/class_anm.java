...
public abstract class class_anm extends BlockStepAbstract {
	...
	public Item a(class_apn var1, Random var2, int var3) {
		return Item.a(Blocks.STONE_SLAB);
	}

	@Override
	public class_aco b(class_ago var1, class_cj var2, class_apn var3) {
		return new class_aco(Blocks.STONE_SLAB, 1, ((class_anm.class_a_in_class_anm) var3.b(N)).a());
	}
	...
	public class_apn a(int var1) {
		class_apn var2 = getBlockData().a(N, class_anm.class_a_in_class_anm.a(var1 & 7));
		if (l()) {
