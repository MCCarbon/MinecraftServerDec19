...
public abstract class class_aqy extends class_apw {
   ...
   protected final class_anl b;
   protected final class_anl c;
   protected int d;

   public class_aqy(boolean var1, int var2, int var3, class_anl var4, class_anl var5) {
      super(var1);
      this.a = var2;
      this.d = var3;
      this.b = var4;
      ...
      for(int var5 = -var3; var5 <= var3 + 1; ++var5) {
         for(int var6 = -var3; var6 <= var3 + 1; ++var6) {
            ...
            if(var5 * var5 + var6 * var6 <= var4 || var7 * var7 + var8 * var8 <= var4 || var5 * var5 + var8 * var8 <= var4 || var7 * var7 + var6 * var6 <= var4) {
               ...
               class_atk var10 = var1.p(var9).c().v();
      ...
      for(int var5 = -var3; var5 <= var3; ++var5) {
         for(int var6 = -var3; var6 <= var3; ++var6) {
            if(var5 * var5 + var6 * var6 <= var4) {
               ...
               class_atk var8 = var1.p(var7).c().v();
