...
public class class_wq extends class_yc implements class_ye {
	...
	public class_wq(class_ago var1) {
		super(var1);
		...
		bo.a(2, new class_uf(this, class_rh.class, 0, false, false, bD));
		b_ = 50;
	}
			...
			for (var1 = 1; var1 < 3; ++var1) {
				if (W >= bz[var1 - 1]) {
					...
					if (var13 > 0) {
						...
						List var14 = o.a(class_rg.class, aX().b(20.0D, 8.0D, 20.0D), Predicates.and(bD, class_rb.d));

						for (int var17 = 0; (var17 < 10) && !var14.isEmpty(); ++var17) {
							class_rg var5 = (class_rg) var14.get(V.nextInt(var14.size()));
	...
	private void a(int var1, class_rg var2) {
	...
	private void a(int var1, double var2, double var4, double var6, boolean var8) {
		...
		class_zp var21 = new class_zp(o, this, var15, var17, var19);
		if (var8) {
			var21.a(true);
		}
	...
	public boolean a(class_qi var1, float var2) {
		if (this.b(var1)) {
			return false;
		} else if ((var1 != class_qi.f) && !(var1.j() instanceof class_wq)) {
			if ((cE() > 0) && (var1 != class_qi.j)) {
				...
				var3 = var1.j();
				if ((var3 != null) && !(var3 instanceof class_yu) && (var3 instanceof class_rg) && (((class_rg) var3).bF() == bF())) {
					return false;
				} else {
					if (bB <= 0) {
						bB = 20;
	...
	static {
		a = class_kc.a(class_wq.class, class_kb.b);
		b = class_kc.a(class_wq.class, class_kb.b);
		c = class_kc.a(class_wq.class, class_kb.b);
