...
public class BlockCobbleWall extends Block {
   ...
   public static final BlockStateEnum Q = BlockStateEnum.of("variant", BlockCobbleWall.class_a_in_class_alv.class);

   public BlockCobbleWall(Block var1) {
      super(var1.material);
      this.setBlockData(this.blockStateList.getFirst().set(a, Boolean.valueOf(false)).set(b, Boolean.valueOf(false)).set(N, Boolean.valueOf(false)).set(O, Boolean.valueOf(false)).set(P, Boolean.valueOf(false)).set(Q, BlockCobbleWall.class_a_in_class_alv.a));
   ...
   public String getName() {
      return LocaleI18n.get(this.getInternalName() + "." + BlockCobbleWall.class_a_in_class_alv.a.c() + ".name");
   }
   ...
   public boolean e(IBlockAccess var1, BlockPosition var2) {
      ...
      return var3 == Blocks.BARRIER?false:(var3 != this && !(var3 instanceof BlockFenceGate)?(var3.material.isOpaque() && var3.isFullCube()?var3.material != Material.PUMPKIN:false):true);
   }

   public int getDropData(IBlockData var1) {
      return ((BlockCobbleWall.class_a_in_class_alv)var1.get(Q)).a();
   }

   public IBlockData fromLegacyData(int var1) {
      return this.getBlockData().set(Q, BlockCobbleWall.class_a_in_class_alv.a(var1));
   }
   ...
   public static enum class_a_in_class_alv implements INamable {
      ...
      private static final BlockCobbleWall.class_a_in_class_alv[] c;
      private final int d;
      ...
      public static BlockCobbleWall.class_a_in_class_alv a(int var0) {
      ...
      static {
         c = new BlockCobbleWall.class_a_in_class_alv[values().length];
         BlockCobbleWall.class_a_in_class_alv[] var0 = values();
         int var1 = var0.length;

         for(int var2 = 0; var2 < var1; ++var2) {
            BlockCobbleWall.class_a_in_class_alv var3 = var0[var2];
            c[var3.a()] = var3;
         }
