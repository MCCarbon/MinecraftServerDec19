	...
	public void c() {
		...
		if (var1 != null) {
			if (b > 25) {
				...
				class_aym var3 = (new class_aym(MathHelper.a((a.y * 3.1415927F) / 180.0F), 0.0D, (-MathHelper.b((a.y * 3.1415927F) / 180.0F)))).a();
				...
				if ((var5 < 0.0F) || (var5 > 10.0F)) {
					...
					double var10 = MathHelper.a(MathHelper.g(180.0D - ((MathHelper.b(var6, var8) * 180.0D) / 3.1415927410125732D) - a.y), -50.0D, 50.0D);
					a.bf *= 0.8F;
					float var12 = (MathHelper.a((var6 * var6) + (var8 * var8)) * 1.0F) + 1.0F;
					float var13 = var12;
					if (var12 > 40.0F) {
						var12 = 40.0F;
					}
