...
public class class_ajo extends class_aje {
   ...
   public class_ajo() {
      this.j(this.M.b().set(b, class_ajw.class_a_in_class_ajw.e).set(a, class_aje.class_a_in_class_aje.b));
   }
   ...
   protected class_aas i(IBlockData var1) {
      return new class_aas(class_aar.a((Block)this), 1, ((class_ajw.class_a_in_class_ajw)var1.get(b)).a() - 4);
   }
