...
public class class_ajo extends class_aje {
   ...
   public class_ajo() {
      this.j(this.M.b().a(b, class_ajw.class_a_in_class_ajw.e).a(a, class_aje.class_a_in_class_aje.b));
   }

   public class_atl g(class_anl var1) {
      class_ajw.class_a_in_class_ajw var2 = (class_ajw.class_a_in_class_ajw)var1.b(b);
      switch(class_ajo.SyntheticClass_1.b[((class_aje.class_a_in_class_aje)var1.b(a)).ordinal()]) {
      case 1:
      case 2:
      case 3:
      default:
   ...
   public int c(class_anl var1) {
      byte var2 = 0;
      int var3 = var2 | ((class_ajw.class_a_in_class_ajw)var1.b(b)).a() - 4;
      switch(class_ajo.SyntheticClass_1.b[((class_aje.class_a_in_class_aje)var1.b(a)).ordinal()]) {
      case 1:
         var3 |= 4;
         break;
   ...
   protected class_aas i(class_anl var1) {
      return new class_aas(class_aar.a((class_agj)this), 1, ((class_ajw.class_a_in_class_ajw)var1.b(b)).a() - 4);
   }

   public int a(class_anl var1) {
      return ((class_ajw.class_a_in_class_ajw)var1.b(b)).a() - 4;
   }
