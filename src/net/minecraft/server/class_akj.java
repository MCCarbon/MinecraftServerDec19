...
public class class_akj extends class_aif {
	...
	public class_acm a(class_apn var1, Random var2, int var3) {
		return class_acm.a(class_aim.al);
	}
	...
	private void f(class_ago var1, class_cj var2, class_apn var3) {
		if (!var1.D) {
			class_ail var4 = var1.p(var2.c()).c();
			class_ail var5 = var1.p(var2.d()).c();
			class_ail var6 = var1.p(var2.e()).c();
			class_ail var7 = var1.p(var2.f()).c();
	...
	public static void a(boolean var0, class_ago var1, class_cj var2) {
		...
		N = true;
		if (var0) {
			var1.a(var2, class_aim.am.S().a(a, var3.b(a)), 3);
			var1.a(var2, class_aim.am.S().a(a, var3.b(a)), 3);
		} else {
			var1.a(var2, class_aim.al.S().a(a, var3.b(a)), 3);
			var1.a(var2, class_aim.al.S().a(a, var3.b(a)), 3);
		}
	...
	public class_aco b(class_ago var1, class_cj var2, class_apn var3) {
		return new class_aco(class_aim.al);
	}
