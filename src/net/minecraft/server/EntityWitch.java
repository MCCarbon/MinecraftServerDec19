...
public class EntityWitch extends EntityMonster implements class_ye {
	...
	public EntityWitch(class_ago var1) {
		super(var1);
		this.a(0.6F, 1.95F);
	...
	public void a(EntityLiving var1, float var2) {
		if (!this.n()) {
			...
			EntityPotion var13 = new EntityPotion(o, this, class_adb.a(new class_aco(Items.bC), var12), false);
			var13.z -= -20.0F;
	...
	static {
		...
		c = DataWatcher.claimId(EntityWitch.class, class_kb.g);
