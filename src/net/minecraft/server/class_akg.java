...
public class class_akg extends class_agf {
   ...
   protected class_akg() {
      super(false);
      this.j(this.M.b().a(b, class_agf.class_b_in_class_agf.a));
   }
   ...
   public class_anl a(int var1) {
      return this.S().a(b, class_agf.class_b_in_class_agf.a(var1));
   }

   public int c(class_anl var1) {
      return ((class_agf.class_b_in_class_agf)var1.b(b)).a();
   }
   ...
   public class_anl a(class_anl var1, class_agj.class_c_in_class_agj var2) {
      if(var1.c() != this) {
         ...
         case 1:
            switch(class_akg.SyntheticClass_1.a[((class_agf.class_b_in_class_agf)var1.b(b)).ordinal()]) {
            case 1:
