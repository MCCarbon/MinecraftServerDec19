...
public class class_xu extends class_yc {
	...
	public class_xu(class_ago var1) {
		super(var1);
		i.a(1, new class_so(this));
		i.a(2, new class_tu(this));
		i.a(3, new class_sg(this, class_vi.class, 6.0F, 1.0D, 1.2D));
	...
	static {
		a = class_kc.a(class_xu.class, class_kb.b);
		b = class_kc.a(class_xu.class, class_kb.g);
		c = class_kc.a(class_xu.class, class_kb.g);
	}
}
