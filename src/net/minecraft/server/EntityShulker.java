...
public class EntityShulker extends class_vg implements class_xx {
	...
	public EntityShulker(class_ago var1) {
		super(var1);
		this.a(1.0F, 1.0F);
		aN = 180.0F;
		aM = 180.0F;
		...
		i.a(4, new EntityShulker.class_a_in_class_vm());
		i.a(7, new EntityShulker.class_e_in_class_vm((EntityShulker.SyntheticClass_1) null));
		i.a(8, new class_tm(this));
		bo.a(1, new class_uc(this, true, new Class[0]));
		bo.a(2, new EntityShulker.class_d_in_class_vm(this));
		bo.a(3, new EntityShulker.class_c_in_class_vm(this));
	}
	...
	protected class_sa p() {
		return new EntityShulker.class_b_in_class_vm(this);
	}
	...
	static {
		a = DataWatcher.claimId(EntityShulker.class, class_kb.k);
		b = DataWatcher.claimId(EntityShulker.class, class_kb.j);
		c = DataWatcher.claimId(EntityShulker.class, class_kb.a);
	}
	...
	static class class_c_in_class_vm extends class_uf {
		public class_c_in_class_vm(EntityShulker var1) {
		...
		protected class_ayk a(double var1) {
			class_cq var3 = ((EntityShulker) e).cE();
	...
	static class class_d_in_class_vm extends class_uf {
		public class_d_in_class_vm(EntityShulker var1) {
	...
	class class_a_in_class_vm extends class_sr {
		...
		public void e() {
			...
			if (var2 < 400.0D) {
				if (b <= 0) {
					b = 20 + ((EntityShulker.this.V.nextInt(10) * 20) / 2);
					EntityShulkerBullet var4 = new EntityShulkerBullet(EntityShulker.this.o, EntityShulker.this, var1, cE().k());
					EntityShulker.this.o.a(var4);
					EntityShulker.this.a("mob.ghast.fireball", 2.0F, ((EntityShulker.this.V.nextFloat() - EntityShulker.this.V.nextFloat()) * 0.2F) + 1.0F);
				}
			} else {
				EntityShulker.this.c((EntityLiving) null);
			}
	...
	class class_e_in_class_vm extends class_sr {
		...
		@Override
		public boolean a() {
			return (w() == null) && (EntityShulker.this.V.nextInt(40) == 0);
		}
		...
		@Override
		public void c() {
			b = 20 * (1 + EntityShulker.this.V.nextInt(3));
		...
		// $FF: synthetic method
		class_e_in_class_vm(EntityShulker.SyntheticClass_1 var2) {
			this();
		}
	}

	class class_b_in_class_vm extends class_sa {
		public class_b_in_class_vm(EntityLiving var2) {
			super(var2);
		}
