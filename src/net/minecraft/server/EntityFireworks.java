...
public class EntityFireworks extends Entity {
	...
	public EntityFireworks(class_ago var1) {
		super(var1);
		this.a(0.25F, 0.25F);
	}
	...
	public EntityFireworks(class_ago var1, double var2, double var4, double var6, class_aco var8) {
		super(var1);
		b = 0;
		this.a(0.25F, 0.25F);
	...
	static {
		a = DataWatcher.claimId(EntityFireworks.class, class_kb.f);
	}
}
