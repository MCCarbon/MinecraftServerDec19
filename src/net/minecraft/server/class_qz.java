...
public class class_qz {
	...
	private static void a(Class var0, String var1, int var2, int var3, int var4) {
		a(var0, var1, var2);
		a.put(var1, new class_qz.class_a_in_class_qz(var1, var3, var4));
	}

	public static class_qx a(String var0, class_ago var1) {
		class_qx var2 = null;

		try {
			Class var3 = (Class) c.get(var0);
			if (var3 != null) {
				var2 = (class_qx) var3.getConstructor(new Class[] { class_ago.class }).newInstance(new Object[] { var1 });
			}
	...
	public static class_qx a(class_dn var0, class_ago var1) {
		class_qx var2 = null;
	...
	public static class_qx a(int var0, class_ago var1) {
		class_qx var2 = null;
	...
	public static class_qx b(String var0, class_ago var1) {
		return a(a(var0), var1);
	}

	public static int a(class_qx var0) {
	...
	public static String b(class_qx var0) {
	...
	public static boolean a(class_qx var0, String var1) {
		String var2 = b(var0);
	...
	static {
		...
		a(class_yl.class, "Zombie", 54, '꾯', 7969893);
