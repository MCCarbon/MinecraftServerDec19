...
public class class_aaq extends class_aar {
         ...
         if(var6 != class_cq.a && var3.p(var4.a()).getBlock().v() == class_atk.a) {
            ...
            if(var11 == class_agk.d) {
               ...
               case 1:
                  return this.a(var1, var2, var3, var4, class_agk.ak.S());
               case 2:
                  return this.a(var1, var2, var3, var4, class_agk.d.S().set(class_ahj.a, class_ahj.class_a_in_class_ahj.a));
               }
            }
         }
   ...
   protected class_oq a(class_aas var1, class_xa var2, class_aen var3, class_cj var4, IBlockData var5) {
      var3.a((double)((float)var4.n() + 0.5F), (double)((float)var4.o() + 0.5F), (double)((float)var4.p() + 0.5F), var5.getBlock().H.c(), (var5.getBlock().H.d() + 1.0F) / 2.0F, var5.getBlock().H.e() * 0.8F);
      if(var3.D) {
         return class_oq.a;
      } else {
         var3.a(var4, var5);
