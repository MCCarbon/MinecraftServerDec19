...
public abstract class class_rh extends class_rg {
	...
	public void m() {
		...
		if (!o.D && cq() && !aT && o.S().b("mobGriefing")) {
			List var1 = o.a(class_xg.class, aX().b(1.0D, 0.0D, 1.0D));
			Iterator var2 = var1.iterator();

			while (var2.hasNext()) {
				class_xg var3 = (class_xg) var2.next();
	...
	protected void a(class_xg var1) {
		...
		if (var4 && this.a(var2)) {
			double var10;
			switch (class_rh.SyntheticClass_1.a[var3.a().ordinal()]) {
				case 1:
					var10 = bp[var3.b()];
					break;
				case 2:
	...
	public class_aco a(class_rc var1) {
		class_aco var2 = null;
		switch (class_rh.SyntheticClass_1.a[var1.a().ordinal()]) {
			case 1:
				var2 = bt[var1.b()];
				break;
			case 2:
	...
	protected void a(boolean var1, int var2) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			...
			double var8;
			switch (class_rh.SyntheticClass_1.a[var6.a().ordinal()]) {
				case 1:
					var8 = bp[var6.b()];
					break;
				case 2:
	...
	public final boolean a(class_yu var1, class_aco var2, class_pu var3) {
		if (cu() && (cv() == var1)) {
			...
			if ((var2 != null) && (var2.b() == Items.cs) && ct()) {
				...
				if (((class_ro) this).d((class_rg) var1)) {
					this.a(var1, true);
					--var2.b;
					return true;
				}
	...
	private void n() {
		if (bx && (bz != null)) {
			if (bz.b("UUID")) {
				UUID var1 = bz.a("UUID");
				List var2 = o.a(class_rg.class, aX().b(10.0D, 10.0D, 10.0D));
				Iterator var3 = var2.iterator();

				while (var3.hasNext()) {
					class_rg var4 = (class_rg) var3.next();
				...
				class_wv var6 = class_wv.b(o, var5);
				if (var6 == null) {
					var6 = class_wv.a(o, var5);
				}
	...
	static {
		a = class_kc.a(class_rh.class, class_kb.a);
	}
