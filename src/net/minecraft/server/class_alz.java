...
public class class_alz extends class_aks {
	...
	public boolean d(class_ago var1, class_cj var2) {
		class_alz.class_a_in_class_alz var3 = new class_alz.class_a_in_class_alz(var1, var2, class_cq.class_a_in_class_cq.a);
		if (var3.d() && (var3.e == 0)) {
			var3.e();
			return true;
		} else {
			class_alz.class_a_in_class_alz var4 = new class_alz.class_a_in_class_alz(var1, var2, class_cq.class_a_in_class_cq.c);
			if (var4.d() && (var4.e == 0)) {
				var4.e();
				return true;
			} else {
	...
	public class_apn a(class_apn var1, Block.class_c_in_class_ail var2) {
		if (var1.c() != this) {
			...
			switch (class_alz.SyntheticClass_1.b[var2.ordinal()]) {
				case 1:
				case 2:
					switch (class_alz.SyntheticClass_1.a[((class_cq.class_a_in_class_cq) var1.b(a)).ordinal()]) {
						case 1:
	...
	public class_apr.class_b_in_class_apr e(class_ago var1, class_cj var2) {
		...
		class_alz.class_a_in_class_alz var4 = new class_alz.class_a_in_class_alz(var1, var2, class_cq.class_a_in_class_cq.a);
		LoadingCache var5 = class_apr.a(var1, true);
		if (!var4.d()) {
			var3 = class_cq.class_a_in_class_cq.a;
			var4 = new class_alz.class_a_in_class_alz(var1, var2, class_cq.class_a_in_class_cq.c);
		}
