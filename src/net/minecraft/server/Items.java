...
public class Items {
	...
	public static final class_za LEATHER_HELMET;
	public static final class_za LEATHER_CHESTPLATE;
	public static final class_za LEATHER_LEGGINGS;
	public static final class_za LEATHER_BOOTS;
	public static final class_za CHAINMAIL_HELMET;
	public static final class_za CHAINMAIL_CHESTPLATE;
	public static final class_za CHAINMAIL_LEGGINGS;
	public static final class_za CHAINMAIL_BOOTS;
	public static final class_za IRON_HELMET;
	public static final class_za IRON_CHESTPLATE;
	public static final class_za IRON_LEGGINGS;
	public static final class_za IRON_BOOTS;
	public static final class_za DIAMOND_HELMET;
	public static final class_za DIAMOND_CHESTPLATE;
	public static final class_za DIAMOND_LEGGINGS;
	public static final class_za DIAMOND_BOOTS;
	public static final class_za GOLDEN_HELMET;
	public static final class_za GOLDEN_CHESTPLATE;
	public static final class_za GOLDEN_LEGGINGS;
	public static final class_za GOLDEN_BOOTS;
	...
	public static final Item GOLD_NUGGEST;
	...
	static {
		if (!Bootstrap.isInitDone()) {
			...
			LEATHER_HELMET = (class_za) getByName("leather_helmet");
			LEATHER_CHESTPLATE = (class_za) getByName("leather_chestplate");
			LEATHER_LEGGINGS = (class_za) getByName("leather_leggings");
			LEATHER_BOOTS = (class_za) getByName("leather_boots");
			CHAINMAIL_HELMET = (class_za) getByName("chainmail_helmet");
			CHAINMAIL_CHESTPLATE = (class_za) getByName("chainmail_chestplate");
			CHAINMAIL_LEGGINGS = (class_za) getByName("chainmail_leggings");
			CHAINMAIL_BOOTS = (class_za) getByName("chainmail_boots");
			IRON_HELMET = (class_za) getByName("iron_helmet");
			IRON_CHESTPLATE = (class_za) getByName("iron_chestplate");
			IRON_LEGGINGS = (class_za) getByName("iron_leggings");
			IRON_BOOTS = (class_za) getByName("iron_boots");
			DIAMOND_HELMET = (class_za) getByName("diamond_helmet");
			DIAMOND_CHESTPLATE = (class_za) getByName("diamond_chestplate");
			DIAMOND_LEGGINGS = (class_za) getByName("diamond_leggings");
			DIAMOND_BOOTS = (class_za) getByName("diamond_boots");
			GOLDEN_HELMET = (class_za) getByName("golden_helmet");
			GOLDEN_CHESTPLATE = (class_za) getByName("golden_chestplate");
			GOLDEN_LEGGINGS = (class_za) getByName("golden_leggings");
			GOLDEN_BOOTS = (class_za) getByName("golden_boots");
			...
			GOLD_NUGGEST = getByName("gold_nugget");
			...
			MAP = (ItemMapEmpty) getByName("map");
