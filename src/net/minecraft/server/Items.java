...
public class Items {
	...
	static {
		if (!Bootstrap.isInitDone()) {
			...
			FISHING_ROD = (ItemFishingRod) getByName("fishing_rod");
			...
			FILLED_MAP = (ItemWorldMap) getByName("filled_map");
			SHEARS = (ItemShears) getByName("shears");
			...
			ENCHANTED_BOOK = (ItemEnchantedBook) getByName("enchanted_book");
