...
public abstract class class_aio extends class_agj {
   ...
   public void a(class_aer var1, class_cj var2) {
      if(this.l()) {
         ...
         if(var3.c() == this) {
            if(var3.b(a) == class_aio.class_a_in_class_aio.a) {
   ...
   public class_anl a(class_aen var1, class_cj var2, class_cq var3, float var4, float var5, float var6, int var7, class_qa var8) {
      class_anl var9 = super.a(var1, var2, var3, var4, var5, var6, var7, var8).a(a, class_aio.class_a_in_class_aio.b);
      return this.l()?var9:(var3 != class_cq.a && (var3 == class_cq.b || (double)var5 <= 0.5D)?var9:var9.a(a, class_aio.class_a_in_class_aio.a));
   }
