...
public abstract class StructureGenerator extends WorldGenBase {
	...
	protected final synchronized void a(World var1, final int var2, final int var3, int var4, int var5, ChunkSnapshot var6) {
		this.a(var1);
		if (!this.e.containsKey(Long.valueOf(ChunkCoordIntPair.a(var2, var3)))) {
			...
			try {
				...
				var9.a("Is feature chunk", new Callable<Object>() {
				...
				var9.a("Chunk pos hash", new Callable<Object>() {
					public String a() throws Exception {
				...
				var9.a("Structure type", new Callable<Object>() {
					public String a() throws Exception {
	...
	public synchronized boolean a(World var1, Random var2, ChunkCoordIntPair var3) {
		this.a(var1);
		int var4 = (var3.a << 4) + 8;
		int var5 = (var3.b << 4) + 8;
		boolean var6 = false;
		Iterator<StructureStart> var7 = this.e.values().iterator();
	...
	protected StructureStart c(BlockPosition var1) {
		Iterator<StructureStart> var2 = this.e.values().iterator();
	...
	public boolean a(World var1, BlockPosition var2) {
		this.a(var1);
		Iterator<StructureStart> var3 = this.e.values().iterator();
	...
	public BlockPosition getNearestGeneratedFeature(World var1, BlockPosition var2) {
		...
		Iterator<StructureStart> var14 = this.e.values().iterator();
	...
	protected List<BlockPosition> A_() {
		return null;
	}
