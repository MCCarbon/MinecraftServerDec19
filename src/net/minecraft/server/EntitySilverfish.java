...
public class EntitySilverfish extends EntityMonster {
	private EntitySilverfish.class_b_in_class_yg a;

	public EntitySilverfish(class_ago var1) {
		super(var1);
		this.a(0.4F, 0.3F);
		i.a(1, new class_so(this));
		i.a(3, a = new EntitySilverfish.class_b_in_class_yg(this));
		i.a(4, new class_sz(this, class_yu.class, 1.0D, false));
		i.a(5, new EntitySilverfish.class_a_in_class_yg(this));
	...
	static class class_a_in_class_yg extends class_tn {
		...
		public class_a_in_class_yg(EntitySilverfish var1) {
			super(var1, 1.0D, 10);
			a = var1;
			this.a(1);
		}
		...
		public void c() {
			if (!c) {
				...
				if (class_alj.d(var3)) {
					var1.a(var2, Blocks.MONSTER_EGG.getBlockData().a(class_alj.a, class_alj.class_a_in_class_alj.a(var3)), 3);
					a.A();
					a.L();
				}
	...
	static class class_b_in_class_yg extends class_sr {
		...
		public class_b_in_class_yg(EntitySilverfish var1) {
			a = var1;
		}
