   ...
   public boolean b(class_aen var1, Random var2, class_cj var3) {
      for(int var4 = 0; var4 < 20; ++var4) {
         ...
         if(var1.d(var5)) {
            ...
            if(var1.p(var6.e()).getBlock().v() == class_atk.h || var1.p(var6.f()).getBlock().v() == class_atk.h || var1.p(var6.c()).getBlock().v() == class_atk.h || var1.p(var6.d()).getBlock().v() == class_atk.h) {
               int var7 = 2 + var2.nextInt(var2.nextInt(3) + 1);

               for(int var8 = 0; var8 < var7; ++var8) {
                  if(class_agk.aM.e(var1, var5)) {
                     var1.a((class_cj)var5.b(var8), (IBlockData)class_agk.aM.S(), 2);
                  }
               }
            }
         }
