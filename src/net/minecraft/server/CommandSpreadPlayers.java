...
public class CommandSpreadPlayers extends CommandAbstract {
	...
	private void a(ICommandListener var1, List var2, CommandSpreadPlayers.class_a_in_class_bj var3, double var4, double var6, class_ago var8, boolean var9) throws class_bz {
		Random var10 = new Random();
		double var11 = var3.a - var6;
		double var13 = var3.b - var6;
		double var15 = var3.a + var6;
		double var17 = var3.b + var6;
		CommandSpreadPlayers.class_a_in_class_bj[] var19 = this.a(var10, var9 ? this.b(var2) : var2.size(), var11, var13, var15, var17);
	...
	private int a(CommandSpreadPlayers.class_a_in_class_bj var1, double var2, class_ago var4, Random var5, double var6, double var8, double var10, double var12, CommandSpreadPlayers.class_a_in_class_bj[] var14, boolean var15) throws class_bz {
		boolean var16 = true;
		...
		for (var17 = 0; (var17 < 10000) && var16; ++var17) {
			...
			int var22;
			CommandSpreadPlayers.class_a_in_class_bj var23;
			for (int var20 = 0; var20 < var14.length; ++var20) {
				CommandSpreadPlayers.class_a_in_class_bj var21 = var14[var20];
				var22 = 0;
				var23 = new CommandSpreadPlayers.class_a_in_class_bj();

				for (int var24 = 0; var24 < var14.length; ++var24) {
					if (var20 != var24) {
						CommandSpreadPlayers.class_a_in_class_bj var25 = var14[var24];
			...
			if (!var16) {
				CommandSpreadPlayers.class_a_in_class_bj[] var28 = var14;
	...
	private double a(List var1, class_ago var2, CommandSpreadPlayers.class_a_in_class_bj[] var3, boolean var4) {
		double var5 = 0.0D;
		int var7 = 0;
		...
		for (int var9 = 0; var9 < var1.size(); ++var9) {
			...
			CommandSpreadPlayers.class_a_in_class_bj var11;
			if (var4) {
				...
				var11 = (CommandSpreadPlayers.class_a_in_class_bj) var8.get(var12);
			} else {
				var11 = var3[var7++];
			}
	...
	private CommandSpreadPlayers.class_a_in_class_bj[] a(Random var1, int var2, double var3, double var5, double var7, double var9) {
		CommandSpreadPlayers.class_a_in_class_bj[] var11 = new CommandSpreadPlayers.class_a_in_class_bj[var2];

		for (int var12 = 0; var12 < var11.length; ++var12) {
			CommandSpreadPlayers.class_a_in_class_bj var13 = new CommandSpreadPlayers.class_a_in_class_bj();
	...
	static class class_a_in_class_bj {
		...
		double a(CommandSpreadPlayers.class_a_in_class_bj var1) {
