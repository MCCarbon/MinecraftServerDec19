...
public abstract class class_xa extends class_qa {
				...
				if (var2 > 0.0F || var4 > 0.0F) {
					...
					if (var14) {
						...
						if (var1 instanceof class_lh && var1.G) {
							((class_lh) var1).a.a((Packet) (new PacketPlayOutEntityVelocity(var1)));
							var1.G = false;
							var1.v = var8;
							var1.w = var10;
							var1.x = var12;
	...
	public class_xa.class_a_in_class_xa a(BlockPosition var1) {
		if (!this.o.D) {
			if (this.bK() || !this.ai()) {
				return class_xa.class_a_in_class_xa.OTHER_PROBLEM;
			}

			if (!this.o.t.d()) {
				return class_xa.class_a_in_class_xa.NOT_POSSIBLE_HERE;
			}

			if (this.o.x()) {
				return class_xa.class_a_in_class_xa.NOT_POSSIBLE_NOW;
			}

			if (Math.abs(this.s - (double) var1.getX()) > 3.0D || Math.abs(this.t - (double) var1.getY()) > 2.0D || Math.abs(this.u - (double) var1.getZ()) > 3.0D) {
				return class_xa.class_a_in_class_xa.TOO_FAR_AWAY;
			}
			...
			if (!var6.isEmpty()) {
				return class_xa.class_a_in_class_xa.NOT_SAFE;
			}
		}
		...
		return class_xa.class_a_in_class_xa.OK;
	}
