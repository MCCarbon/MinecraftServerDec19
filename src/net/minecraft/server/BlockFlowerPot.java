...
public class BlockFlowerPot extends BlockContainer {
   ...
   public static final BlockStateEnum b = BlockStateEnum.of("contents", BlockFlowerPot.class_a_in_class_aid.class);

   public BlockFlowerPot() {
      super(Material.ORIENTABLE);
      this.setBlockData(this.blockStateList.getFirst().set(b, BlockFlowerPot.class_a_in_class_aid.a).set(a, Integer.valueOf(0)));
      this.j();
   }
   ...
   public IBlockData updateState(IBlockData var1, IBlockAccess var2, BlockPosition var3) {
      BlockFlowerPot.class_a_in_class_aid var4 = BlockFlowerPot.class_a_in_class_aid.a;
      ...
      if(var5 instanceof TileEntityFlowerPot) {
         ...
         if(var7 instanceof ItemBlock) {
            ...
            if(var9 == Blocks.SAPLING) {
               switch(BlockFlowerPot.SyntheticClass_1.a[BlockWood.EnumLogVariant.getById(var8).ordinal()]) {
               case 1:
                  var4 = BlockFlowerPot.class_a_in_class_aid.l;
                  break;
               case 2:
                  var4 = BlockFlowerPot.class_a_in_class_aid.m;
                  break;
               case 3:
                  var4 = BlockFlowerPot.class_a_in_class_aid.n;
                  break;
               case 4:
                  var4 = BlockFlowerPot.class_a_in_class_aid.o;
                  break;
               case 5:
                  var4 = BlockFlowerPot.class_a_in_class_aid.p;
                  break;
               case 6:
                  var4 = BlockFlowerPot.class_a_in_class_aid.q;
                  break;
               default:
                  var4 = BlockFlowerPot.class_a_in_class_aid.a;
               }
            } else if(var9 == Blocks.TALLGRASS) {
               switch(var8) {
               case 0:
                  var4 = BlockFlowerPot.class_a_in_class_aid.t;
                  break;
               case 2:
                  var4 = BlockFlowerPot.class_a_in_class_aid.u;
                  break;
               default:
                  var4 = BlockFlowerPot.class_a_in_class_aid.a;
               }
            } else if(var9 == Blocks.YELLOW_FLOWER) {
               var4 = BlockFlowerPot.class_a_in_class_aid.k;
            } else if(var9 == Blocks.RED_FLOWER) {
               switch(BlockFlowerPot.SyntheticClass_1.b[BlockFlowers.EnumFlowerVarient.getById(BlockFlowers.EnumFlowerType.RED, var8).ordinal()]) {
               case 1:
                  var4 = BlockFlowerPot.class_a_in_class_aid.b;
                  break;
               case 2:
                  var4 = BlockFlowerPot.class_a_in_class_aid.c;
                  break;
               case 3:
                  var4 = BlockFlowerPot.class_a_in_class_aid.d;
                  break;
               case 4:
                  var4 = BlockFlowerPot.class_a_in_class_aid.e;
                  break;
               case 5:
                  var4 = BlockFlowerPot.class_a_in_class_aid.f;
                  break;
               case 6:
                  var4 = BlockFlowerPot.class_a_in_class_aid.g;
                  break;
               case 7:
                  var4 = BlockFlowerPot.class_a_in_class_aid.h;
                  break;
               case 8:
                  var4 = BlockFlowerPot.class_a_in_class_aid.i;
                  break;
               case 9:
                  var4 = BlockFlowerPot.class_a_in_class_aid.j;
                  break;
               default:
                  var4 = BlockFlowerPot.class_a_in_class_aid.a;
               }
            } else if(var9 == Blocks.RED_MUSHROOM) {
               var4 = BlockFlowerPot.class_a_in_class_aid.r;
            } else if(var9 == Blocks.BROWN_MUSHROOM) {
               var4 = BlockFlowerPot.class_a_in_class_aid.s;
            } else if(var9 == Blocks.DEADBUSH) {
               var4 = BlockFlowerPot.class_a_in_class_aid.t;
            } else if(var9 == Blocks.CACTUS) {
               var4 = BlockFlowerPot.class_a_in_class_aid.v;
            }
         }
      }
