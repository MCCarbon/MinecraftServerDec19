...
public class BlockTallPlant extends BlockPlant implements IBlockFragilePlantElement {
   ...
   public Item getDropType(IBlockData var1, Random var2, int var3) {
      if(var1.get(b) == BlockTallPlant.class_a_in_class_ahm.a) {
         ...
         return var4 == BlockTallPlant.class_b_in_class_ahm.d?null:(var4 == BlockTallPlant.class_b_in_class_ahm.c?(var2.nextInt(8) == 0?Items.WHEAT_SEEDS :null):Item.getItemOf((Block)this));
      }
   }
   ...
   public void breakBlockNaturally(World var1, EntityHuman var2, BlockPosition var3, IBlockData var4, TileEntity var5, ItemStack var6) {
      if(var1.isClientSide || var6 == null || var6.getItem() != Items.SHEARS || var4.get(b) != BlockTallPlant.class_a_in_class_ahm.b || !this.b(var1, var3, var4, var2)) {
