...
public class BlockTallPlant extends BlockPlant implements class_ain {
	public static final class_aqa a = class_aqa.a("variant", BlockTallPlant.class_b_in_class_ajo.class);
	public static final class_aqa b = class_aqa.a("half", BlockTallPlant.class_a_in_class_ajo.class);
	public static final class_aqa N;

	public BlockTallPlant() {
		super(class_avq.l);
		this.j(M.b().a(a, BlockTallPlant.class_b_in_class_ajo.a).a(b, BlockTallPlant.class_a_in_class_ajo.b).a(N, class_cq.c));
		this.c(0.0F);
		this.a(h);
		this.c("doublePlant");
	}
	...
	private BlockTallPlant.class_b_in_class_ajo a(class_ags var1, class_cj var2, class_apn var3) {
		if (var3.c() == this) {
			var3 = this.a(var3, var1, var2);
			return (BlockTallPlant.class_b_in_class_ajo) var3.b(a);
		} else {
			return BlockTallPlant.class_b_in_class_ajo.d;
		}
	}
	...
	public boolean a(class_ago var1, class_cj var2) {
		...
		if (var3.c() != this) {
			...
			BlockTallPlant.class_b_in_class_ajo var4 = (BlockTallPlant.class_b_in_class_ajo) this.a(var3, var1, var2).b(a);
			return (var4 == BlockTallPlant.class_b_in_class_ajo.d) || (var4 == BlockTallPlant.class_b_in_class_ajo.c);
		}
	}
	...
	protected void f(class_ago var1, class_cj var2, class_apn var3) {
		if (!this.g(var1, var2, var3)) {
			boolean var4 = var3.b(b) == BlockTallPlant.class_a_in_class_ajo.a;
	...
	public boolean g(class_ago var1, class_cj var2, class_apn var3) {
		if (var3.b(b) == BlockTallPlant.class_a_in_class_ajo.a) {
	...
	public Item a(class_apn var1, Random var2, int var3) {
		if (var1.b(b) == BlockTallPlant.class_a_in_class_ajo.a) {
			return null;
		} else {
			BlockTallPlant.class_b_in_class_ajo var4 = (BlockTallPlant.class_b_in_class_ajo) var1.b(a);
			return var4 == BlockTallPlant.class_b_in_class_ajo.d ? null : (var4 == BlockTallPlant.class_b_in_class_ajo.c ? (var2.nextInt(8) == 0 ? Items.P : null) : Item.a(this));
		}
	}

	@Override
	public int a(class_apn var1) {
		return (var1.b(b) != BlockTallPlant.class_a_in_class_ajo.a) && (var1.b(a) != BlockTallPlant.class_b_in_class_ajo.c) ? ((BlockTallPlant.class_b_in_class_ajo) var1.b(a)).a() : 0;
	}
	...
	public void a(class_ago var1, class_yu var2, class_cj var3, class_apn var4, TileEntity var5, class_aco var6) {
		if (var1.D || (var6 == null) || (var6.b() != Items.bg) || (var4.b(b) != BlockTallPlant.class_a_in_class_ajo.b) || !this.b(var1, var3, var4, var2)) {
		...
		if (var3.b(b) == BlockTallPlant.class_a_in_class_ajo.a) {
			if (var1.p(var2.b()).c() == this) {
				if (!var4.bI.d) {
					...
					BlockTallPlant.class_b_in_class_ajo var6 = (BlockTallPlant.class_b_in_class_ajo) var5.b(a);
					if ((var6 != BlockTallPlant.class_b_in_class_ajo.d) && (var6 != BlockTallPlant.class_b_in_class_ajo.c)) {
						var1.b(var2.b(), true);
					} else if (!var1.D) {
	...
	private boolean b(class_ago var1, class_cj var2, class_apn var3, class_yu var4) {
		BlockTallPlant.class_b_in_class_ajo var5 = (BlockTallPlant.class_b_in_class_ajo) var3.b(a);
	...
	public boolean a(class_ago var1, class_cj var2, class_apn var3, boolean var4) {
		BlockTallPlant.class_b_in_class_ajo var5 = this.a((class_ags) var1, var2, var3);
		return (var5 != BlockTallPlant.class_b_in_class_ajo.c) && (var5 != BlockTallPlant.class_b_in_class_ajo.d);
	}
	...
	public int c(class_apn var1) {
		return var1.b(b) == BlockTallPlant.class_a_in_class_ajo.a ? 8 | ((class_cq) var1.b(N)).b() : ((BlockTallPlant.class_b_in_class_ajo) var1.b(a)).a();
	}
	...
	public static enum class_b_in_class_ajo implements class_oe {
		...
		private static final BlockTallPlant.class_b_in_class_ajo[] g;
		private final int h;
		...
		public static BlockTallPlant.class_b_in_class_ajo a(int var0) {
		...
		static {
			g = new BlockTallPlant.class_b_in_class_ajo[values().length];
			BlockTallPlant.class_b_in_class_ajo[] var0 = values();
			int var1 = var0.length;

			for (int var2 = 0; var2 < var1; ++var2) {
				BlockTallPlant.class_b_in_class_ajo var3 = var0[var2];
				g[var3.a()] = var3;
			}
