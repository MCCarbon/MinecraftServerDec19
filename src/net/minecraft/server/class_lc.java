...
public class class_lc implements class_aep {
   ...
   public void a(String var1, double var2, double var4, double var6, float var8, float var9) {
      this.a.getPlayerList().a(var2, var4, var6, var8 > 1.0F?(double)(16.0F * var8):16.0D, this.b.t.p().a(), new PacketPlayOutNamedSoundEffect(var1, var2, var4, var6, var8, var9));
   }

   public void a(class_xa var1, String var2, double var3, double var5, double var7, float var9, float var10) {
      this.a.getPlayerList().a(var1, var3, var5, var7, var9 > 1.0F?(double)(16.0F * var9):16.0D, this.b.t.p().a(), new PacketPlayOutNamedSoundEffect(var2, var3, var5, var7, var9, var10));
   }
   ...
   public void a(class_xa var1, int var2, BlockPosition var3, int var4) {
      this.a.getPlayerList().a(var1, (double)var3.getX(), (double)var3.getY(), (double)var3.getZ(), 64.0D, this.b.t.p().a(), new PacketPlayOutWorldEvent(var2, var3, var4, false));
   }
