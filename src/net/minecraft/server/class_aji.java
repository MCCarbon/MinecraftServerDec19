...
public class class_aji extends class_ago implements class_agl {
   ...
   public void b(class_aen var1, class_cj var2, IBlockData var3, Random var4) {
      if(var4.nextInt(25) == 0) {
         ...
         if(var1.d(var9) && this.f(var1, var9, this.S())) {
            var1.a((class_cj)var9, (IBlockData)this.S(), 2);
         }
      }
   ...
   public boolean f(class_aen var1, class_cj var2, IBlockData var3) {
      if(var2.o() >= 0 && var2.o() < 256) {
         ...
         return var4.getBlock() == class_agk.bw?true:(var4.getBlock() == class_agk.d && var4.get(class_ahj.a) == class_ahj.class_a_in_class_ahj.c?true:var1.k(var2) < 13 && this.c(var4.getBlock()));
      } else {
         return false;
      }
   }

   public boolean d(class_aen var1, class_cj var2, IBlockData var3, Random var4) {
      var1.g(var2);
      class_aqr var5 = null;
      if(this == class_agk.P) {
