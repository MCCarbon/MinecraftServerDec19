...
public class class_alq extends class_alg {
	...
	public class_alq() {
		this.j(M.b().a(b, class_aly.class_a_in_class_aly.e).a(a, class_alg.class_a_in_class_alg.b));
	}

	@Override
	public class_avr g(class_apn var1) {
		class_aly.class_a_in_class_aly var2 = (class_aly.class_a_in_class_aly) var1.b(b);
		switch (class_alq.SyntheticClass_1.b[((class_alg.class_a_in_class_alg) var1.b(a)).ordinal()]) {
			case 1:
			case 2:
			case 3:
			default:
				switch (class_alq.SyntheticClass_1.a[var2.ordinal()]) {
					case 1:
					default:
						return class_avr.m;
					case 2:
	...
	public int c(class_apn var1) {
		byte var2 = 0;
		int var3 = var2 | (((class_aly.class_a_in_class_aly) var1.b(b)).a() - 4);
		switch (class_alq.SyntheticClass_1.b[((class_alg.class_a_in_class_alg) var1.b(a)).ordinal()]) {
			case 1:
				var3 |= 4;
				break;
	...
	protected class_aco i(class_apn var1) {
		return new class_aco(class_acm.a(this), 1, ((class_aly.class_a_in_class_aly) var1.b(b)).a() - 4);
	}

	@Override
	public int a(class_apn var1) {
		return ((class_aly.class_a_in_class_aly) var1.b(b)).a() - 4;
	}
	...
	static class SyntheticClass_1 {
		...
		static {
			...
			try {
				a[class_aly.class_a_in_class_aly.e.ordinal()] = 1;
			} catch (NoSuchFieldError var2) {
				;
			}

			try {
				a[class_aly.class_a_in_class_aly.f.ordinal()] = 2;
