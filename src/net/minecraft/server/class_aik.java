         ...
         if(var1.l(var2.a()) < 4 && var1.p(var2.a()).getBlock().getLightOpacity() > 2) {
            ...
            if(var1.l(var2.a()) >= 9) {
               for(int var5 = 0; var5 < 4; ++var5) {
                  ...
                  if(var8.getBlock() == Blocks.DIRT && var8.get(class_ahj.a) == class_ahj.class_a_in_class_ahj.a && var1.l(var6.a()) >= 4 && var7.getLightOpacity() <= 2) {
   ...
   public void b(World var1, Random var2, class_cj var3, IBlockData var4) {
      ...
      for(int var6 = 0; var6 < 128; ++var6) {
         ...
         for(int var8 = 0; var8 < var6 / 16; ++var8) {
            ...
            if(var1.p(var7.b()).getBlock() != Blocks.GRASS || var1.p(var7).getBlock().isOccluding()) {
               continue label38;
            }
         }

         if(var1.p(var7).getBlock().material == Material.a) {
            if(var2.nextInt(8) == 0) {
