...
public class class_akl extends Block {
   ...
   public void onPlace(World var1, BlockPosition var2, IBlockData var3) {
      if(!var1.isClientSide) {
         if(this.a && !var1.isBlockIndirectlyPowered(var2)) {
            var1.setTypeAndData((BlockPosition)var2, (IBlockData)BlockStainedGlassPane.REDSTONE_LAMP.getBlockData(), 2);
         } else if(!this.a && var1.isBlockIndirectlyPowered(var2)) {
            var1.setTypeAndData((BlockPosition)var2, (IBlockData)BlockStainedGlassPane.LIT_REDSTONE_LAMP.getBlockData(), 2);
         }
   ...
   public Item getDropType(IBlockData var1, Random var2, int var3) {
      return Item.getItemOf(BlockStainedGlassPane.REDSTONE_LAMP);
   }

   protected ItemStack createItemStack(IBlockData var1) {
      return new ItemStack(BlockStainedGlassPane.REDSTONE_LAMP);
   }
}
