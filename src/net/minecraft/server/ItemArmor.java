...
public class ItemArmor extends Item {
   ...
   public final int c;
   public final int d;
   private final ItemArmor.class_a_in_class_za m;

   public ItemArmor(ItemArmor.class_a_in_class_za var1, int var2, class_pw var3) {
      this.m = var1;
      this.b = var3;
      this.d = var2;
      this.c = var1.b(var3);
   ...
   public ItemArmor.class_a_in_class_za d() {
      return this.m;
   }

   public boolean d_(ItemStack var1) {
      return this.m != ItemArmor.class_a_in_class_za.a?false:(!var1.hasTag()?false:(!var1.getTag().hasOfType("display", 10)?false:var1.getTag().getCompound("display").hasOfType("color", 3)));
   }

   public int b(ItemStack var1) {
      if(this.m != ItemArmor.class_a_in_class_za.a) {
         return -1;
      } else {
   ...
   public static enum class_a_in_class_za {
      ...
      public int a(class_pw var1) {
         return ItemArmor.k[var1.b()] * this.g;
      }
      ...
      public Item b() {
         return this == a?Items.aH:(this == b?Items.IRON_INGOT:(this == d?Items.GOLD_INGOT:(this == c?Items.IRON_INGOT:(this == e?Items.DIAMOND:null))));
      }
   }
}
