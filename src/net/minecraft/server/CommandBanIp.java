...
public class CommandBanIp extends CommandAbstract {
   ...
   public boolean canUse(ICommandListener var1) {
      return MinecraftServer.getServer().getPlayerList().i().b() && super.canUse(var1);
   }
   ...
   public void execute(ICommandListener var1, String[] var2) throws class_bz {
      if(var2.length >= 1 && var2[0].length() > 1) {
         ...
         if(var4.matches()) {
            ...
            EntityPlayer var5 = MinecraftServer.getServer().getPlayerList().a(var2[0]);
            if(var5 == null) {
   ...
   protected void a(ICommandListener var1, String var2, String var3) {
      ...
      MinecraftServer.getServer().getPlayerList().i().a((JsonListEntry)var4);
