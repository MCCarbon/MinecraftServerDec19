   ...
   private void e(World var1, class_cj var2) {
      if(class_ahx.e(var1, var2.b()) && var2.o() >= 0) {
         ...
         if(!class_ahx.N && var1.a(var2.a(-var3, -var3, -var3), var2.a(var3, var3, var3))) {
            var1.a((class_pr)(new class_vl(var1, (double)((float)var2.n() + 0.5F), (double)var2.o(), (double)((float)var2.p() + 0.5F), this.getBlockData())));
         } else {
            var1.g(var2);
            ...
            if(var4.o() > 0) {
               var1.a((class_cj)var4, (IBlockData)this.getBlockData(), 2);
            }
         }
   ...
   private void f(World var1, class_cj var2) {
      ...
      if(var3.getBlock() == this) {
         for(int var4 = 0; var4 < 1000; ++var4) {
            ...
            if(var1.p(var5).getBlock().material == Material.a) {
               if(var1.D) {
