...
public class class_ade extends class_acm {
	public class_ade() {
		this.a(class_abp.d);
	}
	...
	public class_pw a(class_aco var1, class_yu var2, class_ago var3, class_cj var4, class_pu var5, class_cq var6, float var7, float var8, float var9) {
		...
		if (var2.a(var11, var6, var1) && var3.a(var3.p(var11).c(), var11, false, var6, (class_qx) null, var1) && class_aim.af.c(var3, var11)) {
			--var1.b;
			var3.a(var11, class_aim.af.S());
			return class_pw.a;
		} else {
			return class_pw.c;
		}
