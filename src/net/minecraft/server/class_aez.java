...
import net.minecraft.server.class_afh;
...
import net.minecraft.server.class_afo;
...
import net.minecraft.server.class_aqh;
import net.minecraft.server.class_aql;
import net.minecraft.server.class_arl;
...
public abstract class class_aez {
   private static final Logger aD = LogManager.getLogger();
   protected static final class_aez.class_a_in_class_aez a = new class_aez.class_a_in_class_aez(0.1F, 0.2F);
   protected static final class_aez.class_a_in_class_aez b = new class_aez.class_a_in_class_aez(-0.5F, 0.0F);
   protected static final class_aez.class_a_in_class_aez c = new class_aez.class_a_in_class_aez(-1.0F, 0.1F);
   protected static final class_aez.class_a_in_class_aez d = new class_aez.class_a_in_class_aez(-1.8F, 0.1F);
   protected static final class_aez.class_a_in_class_aez e = new class_aez.class_a_in_class_aez(0.125F, 0.05F);
   protected static final class_aez.class_a_in_class_aez f = new class_aez.class_a_in_class_aez(0.2F, 0.2F);
   protected static final class_aez.class_a_in_class_aez g = new class_aez.class_a_in_class_aez(0.45F, 0.3F);
   protected static final class_aez.class_a_in_class_aez h = new class_aez.class_a_in_class_aez(1.5F, 0.025F);
   protected static final class_aez.class_a_in_class_aez i = new class_aez.class_a_in_class_aez(1.0F, 0.5F);
   protected static final class_aez.class_a_in_class_aez j = new class_aez.class_a_in_class_aez(0.0F, 0.025F);
   protected static final class_aez.class_a_in_class_aez k = new class_aez.class_a_in_class_aez(0.1F, 0.8F);
   protected static final class_aez.class_a_in_class_aez l = new class_aez.class_a_in_class_aez(0.2F, 0.3F);
   protected static final class_aez.class_a_in_class_aez m = new class_aez.class_a_in_class_aez(-0.2F, 0.1F);
   private static final class_aez[] aE = new class_aez[256];
   public static final Set n = Sets.newHashSet();
   public static final Map o = Maps.newHashMap();
   public static final class_aez p;
   public static final class_aez q;
   public static final class_aez r;
   public static final class_aez s;
   public static final class_aez t;
   public static final class_aez u;
   public static final class_aez v;
   public static final class_aez w;
   public static final class_aez x;
   public static final class_aez y;
   public static final class_aez z;
   public static final class_aez A;
   public static final class_aez B;
   public static final class_aez C;
   public static final class_aez D;
   public static final class_aez E;
   public static final class_aez F;
   public static final class_aez G;
   public static final class_aez H;
   public static final class_aez I;
   public static final class_aez J;
   public static final class_aez K;
   public static final class_aez L;
   public static final class_aez M;
   public static final class_aez N;
   public static final class_aez O;
   public static final class_aez P;
   public static final class_aez Q;
   public static final class_aez R;
   public static final class_aez S;
   ...
   public static final class_aez Y;
   public static final class_aez Z;
   public static final class_aez aa;
   public static final class_aez ab;
   public static final class_aez ac;
   public static final class_aez ad;
   ...
   protected class_aez(int var1) {
      ...
      aE[var1] = this;
      this.as = this.a();
      this.au.add(new class_aez.class_c_in_class_aez(class_uf.class, 12, 4, 4));
      this.au.add(new class_aez.class_c_in_class_aez(class_ue.class, 10, 3, 3));
      this.au.add(new class_aez.class_c_in_class_aez(class_ud.class, 10, 4, 4));
      this.au.add(new class_aez.class_c_in_class_aez(class_tx.class, 10, 4, 4));
      this.au.add(new class_aez.class_c_in_class_aez(class_ty.class, 8, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wp.class, 100, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wr.class, 100, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wn.class, 100, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wa.class, 100, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wo.class, 100, 4, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wb.class, 10, 1, 4));
      this.at.add(new class_aez.class_c_in_class_aez(class_wq.class, 5, 1, 1));
      this.av.add(new class_aez.class_c_in_class_aez(class_ui.class, 10, 4, 4));
      this.aw.add(new class_aez.class_c_in_class_aez(class_tu.class, 10, 8, 8));
   }
   ...
   protected class_aez a(float var1, float var2) {
   ...
   protected final class_aez a(class_aez.class_a_in_class_aez var1) {
      this.an = var1.a;
      this.ao = var1.b;
      return this;
   }

   protected class_aez b() {
      this.ay = false;
      return this;
   }
   ...
   protected class_aez c() {
      this.ax = true;
      return this;
   }

   protected class_aez a(String var1) {
      this.ah = var1;
      return this;
   }

   protected class_aez a(int var1) {
      this.am = var1;
      return this;
   }

   protected class_aez b(int var1) {
      this.a(var1, false);
      return this;
   }

   protected class_aez c(int var1) {
      this.aj = var1;
      return this;
   }
   ...
   public List a(class_qc var1) {
      switch(class_aez.SyntheticClass_1.a[var1.ordinal()]) {
      case 1:
         return this.at;
      case 2:
         return this.au;
   ...
   public class_aez.class_b_in_class_aez m() {
      return (double)this.ap < 0.2D?class_aez.class_b_in_class_aez.b:((double)this.ap < 1.0D?class_aez.class_b_in_class_aez.c:class_aez.class_b_in_class_aez.d);
   }

   public static class_aez[] n() {
      return aE;
   }

   public static class_aez e(int var0) {
      return a(var0, (class_aez)null);
   }

   public static class_aez a(int var0, class_aez var1) {
      if(var0 >= 0 && var0 <= aE.length) {
         class_aez var2 = aE[var0];
   ...
   static {
      ...
      for(int var2 = 0; var2 < var1; ++var2) {
         class_aez var3 = var0[var2];
         if(var3 != null) {
            if(o.containsKey(var3.ah)) {
               throw new Error("Biome \"" + var3.ah + "\" is defined as both ID " + ((class_aez)o.get(var3.ah)).az + " and " + var3.az);
            }
   ...
   public static class class_a_in_class_aez {
      ...
      public class_aez.class_a_in_class_aez a() {
         return new class_aez.class_a_in_class_aez(this.a * 0.8F, this.b * 0.6F);
      }
   }
