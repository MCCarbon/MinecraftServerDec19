...
public class BlockNote extends BlockContainer {
	...
	public boolean a(World var1, BlockPosition var2, IBlockData var3, int var4, int var5) {
		...
		var1.a(var2.getX() + 0.5D, var2.getY() + 0.5D, var2.getZ() + 0.5D, "note." + getNoteByName(var4), 3.0F, var6);
		var1.a(class_cy.x, var2.getX() + 0.5D, var2.getY() + 1.2D, var2.getZ() + 0.5D, var5 / 24.0D, 0.0D, 0.0D, new int[0]);
		return true;
	}
