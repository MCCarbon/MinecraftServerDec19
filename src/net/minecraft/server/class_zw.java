...
public class class_zw extends class_aar {
   ...
   public static void a(class_aen var0, class_cj var1, class_cq var2, Block var3) {
      class_cj var4 = var1.a(var2.e());
      class_cj var5 = var1.a(var2.f());
      int var6 = (var0.p(var5).getBlock().x()?1:0) + (var0.p(var5.a()).getBlock().x()?1:0);
      int var7 = (var0.p(var4).getBlock().x()?1:0) + (var0.p(var4.a()).getBlock().x()?1:0);
      ...
      IBlockData var12 = var3.S().set(class_ahl.a, var2).set(class_ahl.N, var10?class_ahl.class_b_in_class_ahl.b:class_ahl.class_b_in_class_ahl.a);
