...
public class EntityPainting extends class_wt {
	public EntityPainting.class_a_in_class_ww c;

	public EntityPainting(class_ago var1) {
		super(var1);
	}

	public EntityPainting(class_ago var1, class_cj var2, class_cq var3) {
		super(var1, var2);
		ArrayList var4 = Lists.newArrayList();
		EntityPainting.class_a_in_class_ww[] var5 = EntityPainting.class_a_in_class_ww.values();
		int var6 = var5.length;

		for (int var7 = 0; var7 < var6; ++var7) {
			EntityPainting.class_a_in_class_ww var8 = var5[var7];
			c = var8;
			this.a(var3);
			if (this.i()) {
				var4.add(var8);
		...
		if (!var4.isEmpty()) {
			c = (EntityPainting.class_a_in_class_ww) var4.get(V.nextInt(var4.size()));
		}
	...
	public void a(class_dn var1) {
		...
		EntityPainting.class_a_in_class_ww[] var3 = EntityPainting.class_a_in_class_ww.values();
		int var4 = var3.length;

		for (int var5 = 0; var5 < var4; ++var5) {
			EntityPainting.class_a_in_class_ww var6 = var3[var5];
		...
		if (c == null) {
			c = EntityPainting.class_a_in_class_ww.a;
		}
