...
public class class_yl extends class_yc {
	...
	public class_yl(class_ago var1) {
		super(var1);
	...
	protected void n() {
		i.a(4, new class_tz(this, class_yp.class, 1.0D, true));
		i.a(4, new class_tz(this, class_vp.class, 1.0D, true));
		i.a(6, new class_tb(this, 1.0D, false));
		bo.a(1, new class_uc(this, true, new Class[] { class_yd.class }));
		bo.a(2, new class_uf(this, class_yu.class, true));
		bo.a(2, new class_uf(this, class_yp.class, false));
		bo.a(2, new class_uf(this, class_vp.class, true));
	}
	...
	public void m() {
		...
		if (az() && (w() != null) && (m instanceof class_vd)) {
			((class_rh) m).u().a(u().j(), 1.5D);
		}
	...
	public boolean a(class_qi var1, float var2) {
		if (super.a(var1, var2)) {
			class_rg var3 = w();
			if ((var3 == null) && (var1.j() instanceof class_rg)) {
				var3 = (class_rg) var1.j();
			}
	...
	public void b(class_rg var1) {
		super.b(var1);
		if (((o.ac() == class_ps.c) || (o.ac() == class_ps.d)) && (var1 instanceof class_yp)) {
			if ((o.ac() != class_ps.d) && V.nextBoolean()) {
				return;
			}

			class_rh var2 = (class_rh) var1;
			class_yl var3 = new class_yl(o);
			var3.n(var1);
			o.e(var1);
	...
	public class_rj a(class_pt var1, class_rj var2) {
		...
		if (var7 == null) {
			var7 = new class_yl.class_a_in_class_yl(o.s.nextFloat() < 0.05F, o.s.nextFloat() < 0.05F);
		}

		if (var7 instanceof class_yl.class_a_in_class_yl) {
			class_yl.class_a_in_class_yl var4 = (class_yl.class_a_in_class_yl) var7;
			if (var4.b) {
				this.o(true);
			}
			...
			if (var4.a) {
				...
				if (o.s.nextFloat() < 0.05D) {
					List var5 = o.a(class_vd.class, aX().b(5.0D, 3.0D, 5.0D), class_rb.b);
					if (!var5.isEmpty()) {
	...
	static {
		...
		bt = class_kc.a(class_yl.class, class_kb.g);
		bu = class_kc.a(class_yl.class, class_kb.g);
		bv = class_kc.a(class_yl.class, class_kb.g);
		bw = class_kc.a(class_yl.class, class_kb.g);
	}
