...
public abstract class BiomeBase {
	...
	protected BiomeBase(int var1) {
		...
		aE[var1] = this;
		this.as = this.a();
		this.au.add(new BiomeBase.class_c_in_class_aez(class_uf.class, 12, 4, 4));
		this.au.add(new BiomeBase.class_c_in_class_aez(class_ue.class, 10, 3, 3));
		this.au.add(new BiomeBase.class_c_in_class_aez(class_ud.class, 10, 4, 4));
		this.au.add(new BiomeBase.class_c_in_class_aez(class_tx.class, 10, 4, 4));
		this.au.add(new BiomeBase.class_c_in_class_aez(class_ty.class, 8, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wp.class, 100, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wr.class, 100, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wn.class, 100, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wa.class, 100, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wo.class, 100, 4, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wb.class, 10, 1, 4));
		this.at.add(new BiomeBase.class_c_in_class_aez(class_wq.class, 5, 1, 1));
		this.av.add(new BiomeBase.class_c_in_class_aez(class_ui.class, 10, 4, 4));
		this.aw.add(new BiomeBase.class_c_in_class_aez(class_tu.class, 10, 8, 8));
	}
