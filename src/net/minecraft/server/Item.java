...
public class Item {
    ...
    public static void init() {
        ...
        register(Blocks.STONE_SLAB, (new ItemStep(Blocks.STONE_SLAB, Blocks.STONE_SLAB, Blocks.DOUBLE_SANDSTONE_SLAB)).b("stoneSlab"));
        ...
        register(Blocks.PURPUR_SLAB, (new ItemStep(Blocks.PURPUR_SLAB, Blocks.PURPUR_SLAB, Blocks.PURPUR_DOUBLE_SLAB)).b("purpurSlab"));
        ...
        register(Blocks.WOODEN_SLAB, (new ItemStep(Blocks.WOODEN_SLAB, Blocks.WOODEN_SLAB, Blocks.DOUBLE_WOODEN_SLAB)).b("woodSlab"));
        ...
        register(Blocks.STONE_SLAB2, (new ItemStep(Blocks.STONE_SLAB2, Blocks.STONE_SLAB2, Blocks.DOUBLE_STONE_SLAB2)).b("stoneSlab2"));
        register(256, "iron_shovel", (new ItemSpade(EnumToolMaterial.IRON)).c("shovelIron"));
        register(257, "iron_pickaxe", (new ItemPickaxe(EnumToolMaterial.IRON)).c("pickaxeIron"));
        register(258, "iron_axe", (new ItemAxe(EnumToolMaterial.IRON)).c("hatchetIron"));
        register(259, "flint_and_steel", (new ItemFlintAndSteel()).c("flintAndSteel"));
        register(260, "apple", (new ItemApple(4, 0.3F, false)).c("apple"));
        register(261, "bow", (new ItemBow()).c("bow"));
        register(262, "arrow", (new Item()).c("arrow"));
        register(263, "coal", (new ItemCoal()).c("coal"));
        ...
        register(267, "iron_sword", (new class_abw(EnumToolMaterial.IRON)).c("swordIron"));
        register(268, "wooden_sword", (new class_abw(EnumToolMaterial.WOOD)).c("swordWood"));
        register(269, "wooden_shovel", (new ItemSpade(EnumToolMaterial.WOOD)).c("shovelWood"));
        register(270, "wooden_pickaxe", (new ItemPickaxe(EnumToolMaterial.WOOD)).c("pickaxeWood"));
        register(271, "wooden_axe", (new ItemAxe(EnumToolMaterial.WOOD)).c("hatchetWood"));
        register(272, "stone_sword", (new class_abw(EnumToolMaterial.STONE)).c("swordStone"));
        register(273, "stone_shovel", (new ItemSpade(EnumToolMaterial.STONE)).c("shovelStone"));
        register(274, "stone_pickaxe", (new ItemPickaxe(EnumToolMaterial.STONE)).c("pickaxeStone"));
        register(275, "stone_axe", (new ItemAxe(EnumToolMaterial.STONE)).c("hatchetStone"));
        register(276, "diamond_sword", (new class_abw(EnumToolMaterial.EMERALD)).c("swordDiamond"));
        register(277, "diamond_shovel", (new ItemSpade(EnumToolMaterial.EMERALD)).c("shovelDiamond"));
        register(278, "diamond_pickaxe", (new ItemPickaxe(EnumToolMaterial.EMERALD)).c("pickaxeDiamond"));
        register(279, "diamond_axe", (new ItemAxe(EnumToolMaterial.EMERALD)).c("hatchetDiamond"));
        register(280, "stick", (new Item()).n().c("stick").a(CreativeTab.MATERIALS));
        register(281, "bowl", (new Item()).c("bowl").a(CreativeTab.MATERIALS));
        register(282, "mushroom_stew", (new class_zm(6)).c("mushroomStew"));
        register(283, "golden_sword", (new class_abw(EnumToolMaterial.GOLD)).c("swordGold"));
        register(284, "golden_shovel", (new ItemSpade(EnumToolMaterial.GOLD)).c("shovelGold"));
        register(285, "golden_pickaxe", (new ItemPickaxe(EnumToolMaterial.GOLD)).c("pickaxeGold"));
        register(286, "golden_axe", (new ItemAxe(EnumToolMaterial.GOLD)).c("hatchetGold"));
        ...
        register(290, "wooden_hoe", (new class_aaq(EnumToolMaterial.WOOD)).c("hoeWood"));
        register(291, "stone_hoe", (new class_aaq(EnumToolMaterial.STONE)).c("hoeStone"));
        register(292, "iron_hoe", (new class_aaq(EnumToolMaterial.IRON)).c("hoeIron"));
        register(293, "diamond_hoe", (new class_aaq(EnumToolMaterial.EMERALD)).c("hoeDiamond"));
        register(294, "golden_hoe", (new class_aaq(EnumToolMaterial.GOLD)).c("hoeGold"));
        register(295, "wheat_seeds", (new class_abk(Blocks.WHEAT, Blocks.FARMLAND)).c("seeds"));
        register(296, "wheat", (new Item()).c("wheat").a(CreativeTab.MATERIALS));
        register(297, "bread", (new ItemApple(5, 0.6F, false)).c("bread"));
        register(298, "leather_helmet", (new ItemArmor(ItemArmor.class_a_in_class_za.a, 0, class_pw.f)).c("helmetCloth"));
        register(299, "leather_chestplate", (new ItemArmor(ItemArmor.class_a_in_class_za.a, 0, class_pw.e)).c("chestplateCloth"));
        register(300, "leather_leggings", (new ItemArmor(ItemArmor.class_a_in_class_za.a, 0, class_pw.d)).c("leggingsCloth"));
        register(301, "leather_boots", (new ItemArmor(ItemArmor.class_a_in_class_za.a, 0, class_pw.c)).c("bootsCloth"));
        register(302, "chainmail_helmet", (new ItemArmor(ItemArmor.class_a_in_class_za.b, 1, class_pw.f)).c("helmetChain"));
        register(303, "chainmail_chestplate", (new ItemArmor(ItemArmor.class_a_in_class_za.b, 1, class_pw.e)).c("chestplateChain"));
        register(304, "chainmail_leggings", (new ItemArmor(ItemArmor.class_a_in_class_za.b, 1, class_pw.d)).c("leggingsChain"));
        register(305, "chainmail_boots", (new ItemArmor(ItemArmor.class_a_in_class_za.b, 1, class_pw.c)).c("bootsChain"));
        register(306, "iron_helmet", (new ItemArmor(ItemArmor.class_a_in_class_za.c, 2, class_pw.f)).c("helmetIron"));
        register(307, "iron_chestplate", (new ItemArmor(ItemArmor.class_a_in_class_za.c, 2, class_pw.e)).c("chestplateIron"));
        register(308, "iron_leggings", (new ItemArmor(ItemArmor.class_a_in_class_za.c, 2, class_pw.d)).c("leggingsIron"));
        register(309, "iron_boots", (new ItemArmor(ItemArmor.class_a_in_class_za.c, 2, class_pw.c)).c("bootsIron"));
        register(310, "diamond_helmet", (new ItemArmor(ItemArmor.class_a_in_class_za.e, 3, class_pw.f)).c("helmetDiamond"));
        register(311, "diamond_chestplate", (new ItemArmor(ItemArmor.class_a_in_class_za.e, 3, class_pw.e)).c("chestplateDiamond"));
        register(312, "diamond_leggings", (new ItemArmor(ItemArmor.class_a_in_class_za.e, 3, class_pw.d)).c("leggingsDiamond"));
        register(313, "diamond_boots", (new ItemArmor(ItemArmor.class_a_in_class_za.e, 3, class_pw.c)).c("bootsDiamond"));
        register(314, "golden_helmet", (new ItemArmor(ItemArmor.class_a_in_class_za.d, 4, class_pw.f)).c("helmetGold"));
        register(315, "golden_chestplate", (new ItemArmor(ItemArmor.class_a_in_class_za.d, 4, class_pw.e)).c("chestplateGold"));
        register(316, "golden_leggings", (new ItemArmor(ItemArmor.class_a_in_class_za.d, 4, class_pw.d)).c("leggingsGold"));
        register(317, "golden_boots", (new ItemArmor(ItemArmor.class_a_in_class_za.d, 4, class_pw.c)).c("bootsGold"));
        register(318, "flint", (new Item()).c("flint").a(CreativeTab.MATERIALS));
        register(319, "porkchop", (new ItemApple(3, 0.3F, true)).c("porkchopRaw"));
        register(320, "cooked_porkchop", (new ItemApple(8, 0.8F, true)).c("porkchopCooked"));
        ...
        register(357, "cookie", (new ItemApple(2, 0.1F, false)).c("cookie"));
        register(358, "filled_map", (new class_aax()).c("map"));
        register(359, "shears", (new class_abl()).c("shears"));
        register(360, "melon", (new ItemApple(2, 0.3F, false)).c("melon"));
        register(361, "pumpkin_seeds", (new class_abk(Blocks.PUMPKIN_STEM, Blocks.FARMLAND)).c("seeds_pumpkin"));
        register(362, "melon_seeds", (new class_abk(Blocks.MELON_STEM, Blocks.FARMLAND)).c("seeds_melon"));
        register(363, "beef", (new ItemApple(3, 0.3F, true)).c("beefRaw"));
        register(364, "cooked_beef", (new ItemApple(8, 0.8F, true)).c("beefCooked"));
        register(365, "chicken", (new ItemApple(2, 0.3F, true)).a(new class_pl(class_pm.q, 600, 0), 0.3F).c("chickenRaw"));
        register(366, "cooked_chicken", (new ItemApple(6, 0.6F, true)).c("chickenCooked"));
        register(367, "rotten_flesh", (new ItemApple(4, 0.1F, true)).a(new class_pl(class_pm.q, 600, 0), 0.8F).c("rottenFlesh"));
        ...
        register(372, "nether_wart", (new class_abk(Blocks.NETHER_WART, Blocks.SOUL_SAND)).c("netherStalkSeeds"));
        register(373, "potion", (new class_abe()).c("potion"));
        register(374, "glass_bottle", (new class_zk()).c("glassBottle"));
        register(375, "spider_eye", (new ItemApple(2, 0.8F, false)).a(new class_pl(class_pm.s, 100, 0), 1.0F).c("spiderEye"));
        ...
        register(393, "baked_potato", (new ItemApple(5, 0.6F, false)).c("potatoBaked"));
        register(394, "poisonous_potato", (new ItemApple(2, 0.3F, false)).a(new class_pl(class_pm.s, 100, 0), 0.6F).c("potatoPoisonous"));
        register(395, "map", (new class_aac()).c("emptyMap"));
        register(396, "golden_carrot", (new ItemApple(6, 1.2F, false)).c("carrotGolden").a(CreativeTab.BREWING));
        ...
        register(400, "pumpkin_pie", (new ItemApple(8, 0.3F, false)).c("pumpkinPie").a(CreativeTab.FOOD));
        ...
        register(411, "rabbit", (new ItemApple(3, 0.3F, true)).c("rabbitRaw"));
        register(412, "cooked_rabbit", (new ItemApple(5, 0.6F, true)).c("rabbitCooked"));
        register(413, "rabbit_stew", (new class_zm(10)).c("rabbitStew"));
        ...
        register(423, "mutton", (new ItemApple(2, 0.3F, true)).c("muttonRaw"));
        register(424, "cooked_mutton", (new ItemApple(6, 0.8F, true)).c("muttonCooked"));
        ...
        //New items
        register(432, "chorus_fruit", (new class_zp(4, 0.3F)).h().c("chorusFruit").a(CreativeTab.MATERIALS));
        register(433, "chorus_fruit_popped", (new Item()).c("chorusFruitPopped").a(CreativeTab.MATERIALS));
        register(434, "beetroot", (new ItemApple(1, 0.6F, false)).c("beetroot"));
        register(435, "beetroot_seeds", (new class_abk(Blocks.BEETROOTS, Blocks.FARMLAND)).c("beetroot_seeds"));
        register(436, "beetroot_soup", (new class_zm(6)).c("beetroot_soup"));
        register(438, "splash_potion", (new class_abv()).c("splash_potion"));
        register(439, "spectral_arrow", (new class_abu()).c("spectral_arrow"));
        register(440, "tipped_arrow", (new class_aby()).c("tipped_arrow"));
        //End new items
