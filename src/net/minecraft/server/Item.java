...
public class Item {
	...
	public static void init() {
		...
		registerItemBlock(Blocks.STONE_SLAB, (new BlockStep(Blocks.STONE_SLAB, Blocks.STONE_SLAB, Blocks.DOUBLE_SANDSTONE_SLAB)).b("stoneSlab"));
		...
		registerItemBlock(Blocks.PURPUR_SLAB, (new BlockStep(Blocks.PURPUR_SLAB, Blocks.PURPUR_SLAB, Blocks.PURPUR_DOUBLE_SLAB)).b("purpurSlab"));
        //New stuff
		...
		registerItemBlock(Blocks.WOODEN_SLAB, (new BlockStep(Blocks.WOODEN_SLAB, Blocks.WOODEN_SLAB, Blocks.DOUBLE_WOODEN_SLAB)).b("woodSlab"));
		...
		registerItemBlock(Blocks.STONE_SLAB2, (new BlockStep(Blocks.STONE_SLAB2, Blocks.STONE_SLAB2, Blocks.DOUBLE_STONE_SLAB2)).b("stoneSlab2"));
		...
		registerItem(263, "coal", (new class_zr()).c("coal"));
		...
		registerItem(267, "iron_sword", (new class_abw(EnumToolMaterial.IRON)).c("swordIron"));
		registerItem(268, "wooden_sword", (new class_abw(EnumToolMaterial.WOOD)).c("swordWood"));
		registerItem(269, "wooden_shovel", (new class_abm(EnumToolMaterial.WOOD)).c("shovelWood"));
		registerItem(270, "wooden_pickaxe", (new class_abc(EnumToolMaterial.WOOD)).c("pickaxeWood"));
		registerItem(271, "wooden_axe", (new class_zd(EnumToolMaterial.WOOD)).c("hatchetWood"));
		registerItem(272, "stone_sword", (new class_abw(EnumToolMaterial.STONE)).c("swordStone"));
		registerItem(273, "stone_shovel", (new class_abm(EnumToolMaterial.STONE)).c("shovelStone"));
		registerItem(274, "stone_pickaxe", (new class_abc(EnumToolMaterial.STONE)).c("pickaxeStone"));
		registerItem(275, "stone_axe", (new class_zd(EnumToolMaterial.STONE)).c("hatchetStone"));
		registerItem(276, "diamond_sword", (new class_abw(EnumToolMaterial.EMERALD)).c("swordDiamond"));
		registerItem(277, "diamond_shovel", (new class_abm(EnumToolMaterial.EMERALD)).c("shovelDiamond"));
		registerItem(278, "diamond_pickaxe", (new class_abc(EnumToolMaterial.EMERALD)).c("pickaxeDiamond"));
		registerItem(279, "diamond_axe", (new class_zd(EnumToolMaterial.EMERALD)).c("hatchetDiamond"));
		...
		registerItem(283, "golden_sword", (new class_abw(EnumToolMaterial.GOLD)).c("swordGold"));
		registerItem(284, "golden_shovel", (new class_abm(EnumToolMaterial.GOLD)).c("shovelGold"));
		registerItem(285, "golden_pickaxe", (new class_abc(EnumToolMaterial.GOLD)).c("pickaxeGold"));
		registerItem(286, "golden_axe", (new class_zd(EnumToolMaterial.GOLD)).c("hatchetGold"));
		registerItem(287, "string", (new class_zh(Blocks.TRIPWIRE)).c("string").registerItemKey(CreativeTab.MATERIALS));
		...
		registerItem(290, "wooden_hoe", (new class_aaq(EnumToolMaterial.WOOD)).c("hoeWood"));
		registerItem(291, "stone_hoe", (new class_aaq(EnumToolMaterial.STONE)).c("hoeStone"));
		registerItem(292, "iron_hoe", (new class_aaq(EnumToolMaterial.IRON)).c("hoeIron"));
		registerItem(293, "diamond_hoe", (new class_aaq(EnumToolMaterial.EMERALD)).c("hoeDiamond"));
		registerItem(294, "golden_hoe", (new class_aaq(EnumToolMaterial.GOLD)).c("hoeGold"));
		...
		registerItem(298, "leather_helmet", (new class_za(class_za.class_a_in_class_za.a, 0, class_pw.f)).c("helmetCloth"));
		registerItem(299, "leather_chestplate", (new class_za(class_za.class_a_in_class_za.a, 0, class_pw.e)).c("chestplateCloth"));
		registerItem(300, "leather_leggings", (new class_za(class_za.class_a_in_class_za.a, 0, class_pw.d)).c("leggingsCloth"));
		registerItem(301, "leather_boots", (new class_za(class_za.class_a_in_class_za.a, 0, class_pw.c)).c("bootsCloth"));
		registerItem(302, "chainmail_helmet", (new class_za(class_za.class_a_in_class_za.b, 1, class_pw.f)).c("helmetChain"));
		registerItem(303, "chainmail_chestplate", (new class_za(class_za.class_a_in_class_za.b, 1, class_pw.e)).c("chestplateChain"));
		registerItem(304, "chainmail_leggings", (new class_za(class_za.class_a_in_class_za.b, 1, class_pw.d)).c("leggingsChain"));
		registerItem(305, "chainmail_boots", (new class_za(class_za.class_a_in_class_za.b, 1, class_pw.c)).c("bootsChain"));
		registerItem(306, "iron_helmet", (new class_za(class_za.class_a_in_class_za.c, 2, class_pw.f)).c("helmetIron"));
		registerItem(307, "iron_chestplate", (new class_za(class_za.class_a_in_class_za.c, 2, class_pw.e)).c("chestplateIron"));
		registerItem(308, "iron_leggings", (new class_za(class_za.class_a_in_class_za.c, 2, class_pw.d)).c("leggingsIron"));
		registerItem(309, "iron_boots", (new class_za(class_za.class_a_in_class_za.c, 2, class_pw.c)).c("bootsIron"));
		registerItem(310, "diamond_helmet", (new class_za(class_za.class_a_in_class_za.e, 3, class_pw.f)).c("helmetDiamond"));
		registerItem(311, "diamond_chestplate", (new class_za(class_za.class_a_in_class_za.e, 3, class_pw.e)).c("chestplateDiamond"));
		registerItem(312, "diamond_leggings", (new class_za(class_za.class_a_in_class_za.e, 3, class_pw.d)).c("leggingsDiamond"));
		registerItem(313, "diamond_boots", (new class_za(class_za.class_a_in_class_za.e, 3, class_pw.c)).c("bootsDiamond"));
		registerItem(314, "golden_helmet", (new class_za(class_za.class_a_in_class_za.d, 4, class_pw.f)).c("helmetGold"));
		registerItem(315, "golden_chestplate", (new class_za(class_za.class_a_in_class_za.d, 4, class_pw.e)).c("chestplateGold"));
		registerItem(316, "golden_leggings", (new class_za(class_za.class_a_in_class_za.d, 4, class_pw.d)).c("leggingsGold"));
		registerItem(317, "golden_boots", (new class_za(class_za.class_a_in_class_za.d, 4, class_pw.c)).c("bootsGold"));
		...
		registerItem(326, "water_bucket", (new class_zn(Blocks.FLOWING_WATER)).c("bucketWater").c(var0));
		registerItem(327, "lava_bucket", (new class_zn(Blocks.FLOWING_LAVA)).c("bucketLava").c(var0));
		registerItem(328, "minecart", (new class_aaz(class_vn.class_a_in_class_vn.a)).c("minecart"));
		registerItem(329, "saddle", (new class_abi()).c("saddle"));
		registerItem(330, "iron_door", (new class_zw(Blocks.IRON_DOOR)).c("doorIron"));
		registerItem(331, "redstone", (new class_abh()).c("redstone"));
		registerItem(332, "snowball", (new class_abs()).c("snowball"));
		registerItem(333, "boat", (new class_zi()).c("boat"));
		registerItem(334, "leather", (new Item()).c("leather").registerItemKey(CreativeTab.MATERIALS));
		registerItem(335, "milk_bucket", (new class_aay()).c("milk").c(var0));
		...
		registerItem(338, "reeds", (new class_zh(Blocks.REEDS)).c("reeds").registerItemKey(CreativeTab.MATERIALS));
		registerItem(339, "paper", (new Item()).c("paper").registerItemKey(CreativeTab.MISC));
		registerItem(340, "book", (new class_zj()).c("book").registerItemKey(CreativeTab.MISC));
		registerItem(341, "slime_ball", (new Item()).c("slimeball").registerItemKey(CreativeTab.MISC));
		registerItem(342, "chest_minecart", (new class_aaz(class_vn.class_a_in_class_vn.b)).c("minecartChest"));
		registerItem(343, "furnace_minecart", (new class_aaz(class_vn.class_a_in_class_vn.c)).c("minecartFurnace"));
		registerItem(344, "egg", (new class_aab()).c("egg"));
		registerItem(345, "compass", (new class_zs()).c("compass").registerItemKey(CreativeTab.TOOLS));
		registerItem(346, "fishing_rod", (new class_aal()).c("fishingRod"));
		registerItem(347, "clock", (new class_zq()).c("clock").registerItemKey(CreativeTab.TOOLS));
		registerItem(348, "glowstone_dust", (new Item()).c("yellowDust").registerItemKey(CreativeTab.MATERIALS));
		registerItem(349, "fish", (new class_aak(false)).c("fish").registerItemKey(true));
		registerItem(350, "cooked_fish", (new class_aak(true)).c("fish").registerItemKey(true));
		registerItem(351, "dye", (new class_zz()).c("dyePowder"));
		...
		registerItem(354, "cake", (new class_zh(Blocks.CAKE)).d(1).c("cake").registerItemKey(CreativeTab.FOOD));
		registerItem(355, "bed", (new class_zf()).d(1).c("bed"));
		registerItem(356, "repeater", (new class_zh(Blocks.UNPOWERED_REPEATER)).c("diode").registerItemKey(CreativeTab.REDSTONE));
		registerItem(357, "cookie", (new ItemFood(2, 0.1F, false)).c("cookie"));
		registerItem(358, "filled_map", (new class_aax()).c("map"));
		registerItem(359, "shears", (new class_abl()).c("shears"));
		...
		registerItem(379, "brewing_stand", (new class_zh(Blocks.BREWING_STAND)).c("brewingStand").registerItemKey(CreativeTab.BREWING));
		registerItem(380, "cauldron", (new class_zh(Blocks.CAULDRON)).c("cauldron").registerItemKey(CreativeTab.BREWING));
		registerItem(381, "ender_eye", (new class_aae()).c("eyeOfEnder"));
		registerItem(382, "speckled_melon", (new Item()).c("speckledMelon").registerItemKey(CreativeTab.BREWING));
		registerItem(383, "spawn_egg", (new class_abt()).c("monsterPlacer"));
		registerItem(384, "experience_bottle", (new class_aag()).c("expBottle"));
		registerItem(385, "fire_charge", (new class_aah()).c("fireball"));
		registerItem(386, "writable_book", (new class_acb()).c("writingBook").registerItemKey(CreativeTab.MISC));
		registerItem(387, "written_book", (new class_acc()).c("writtenBook").d(16));
		registerItem(388, "emerald", (new Item()).c("emerald").registerItemKey(CreativeTab.MATERIALS));
		registerItem(389, "item_frame", (new class_aap(class_va.class)).c("frame"));
		registerItem(390, "flower_pot", (new class_zh(Blocks.FLOWER_POT)).c("flowerPot").registerItemKey(CreativeTab.DECORATIONS));
		...
		registerItem(398, "carrot_on_a_stick", (new class_zo()).c("carrotOnAStick"));
		registerItem(399, "nether_star", (new class_abo()).c("netherStar").registerItemKey(CreativeTab.MATERIALS));
		registerItem(400, "pumpkin_pie", (new ItemFood(8, 0.3F, false)).c("pumpkinPie").registerItemKey(CreativeTab.FOOD));
		registerItem(401, "fireworks", (new class_aaj()).c("fireworks"));
		registerItem(402, "firework_charge", (new class_aai()).c("fireworksCharge").registerItemKey(CreativeTab.MISC));
		registerItem(403, "enchanted_book", (new class_aad()).d(1).c("enchantedBook"));
		registerItem(404, "comparator", (new class_zh(Blocks.UNPOWERED_COMPARATOR)).c("comparator").registerItemKey(CreativeTab.REDSTONE));
		...
		registerItem(407, "tnt_minecart", (new class_aaz(class_vn.class_a_in_class_vn.d)).c("minecartTnt"));
		registerItem(408, "hopper_minecart", (new class_aaz(class_vn.class_a_in_class_vn.f)).c("minecartHopper"));
		...
		registerItem(420, "lead", (new class_aav()).c("leash"));
		registerItem(421, "name_tag", (new class_abb()).c("nameTag"));
		registerItem(422, "command_block_minecart", (new class_aaz(class_vn.class_a_in_class_vn.g)).c("minecartCommandBlock").registerItemKey((CreativeTab) null));
		...
		registerItem(425, "banner", (new class_ze()).b("banner"));
		registerItem(427, "spruce_door", (new class_zw(Blocks.SPRUCE_DOOR)).c("doorSpruce"));
		registerItem(428, "birch_door", (new class_zw(Blocks.BIRCH_DOOR)).c("doorBirch"));
		registerItem(429, "jungle_door", (new class_zw(Blocks.JUNGLE_DOOR)).c("doorJungle"));
		registerItem(430, "acacia_door", (new class_zw(Blocks.ACACIA_DOOR)).c("doorAcacia"));
		registerItem(431, "dark_oak_door", (new class_zw(Blocks.DARK_OAK_DOOR)).c("doorDarkOak"));
		//New items
		...
		//End new items
		registerItem(2256, "record_13", (new class_abg("13")).c("record"));
		registerItem(2257, "record_cat", (new class_abg("cat")).c("record"));
		registerItem(2258, "record_blocks", (new class_abg("blocks")).c("record"));
		registerItem(2259, "record_chirp", (new class_abg("chirp")).c("record"));
		registerItem(2260, "record_far", (new class_abg("far")).c("record"));
		registerItem(2261, "record_mall", (new class_abg("mall")).c("record"));
		registerItem(2262, "record_mellohi", (new class_abg("mellohi")).c("record"));
		registerItem(2263, "record_stal", (new class_abg("stal")).c("record"));
		registerItem(2264, "record_strad", (new class_abg("strad")).c("record"));
		registerItem(2265, "record_ward", (new class_abg("ward")).c("record"));
		registerItem(2266, "record_11", (new class_abg("11")).c("record"));
		registerItem(2267, "record_wait", (new class_abg("wait")).c("record"));
	}
