...
public class Item {
    ...
    public static void init() {
        ...
        register(282, "mushroom_stew", (new ItemSoup(6)).c("mushroomStew"));
        ...
        register(297, "bread", (new ItemFood(5, 0.6F, false)).c("bread"));
        ...
        register(319, "porkchop", (new ItemFood(3, 0.3F, true)).c("porkchopRaw"));
        register(320, "cooked_porkchop", (new ItemFood(8, 0.8F, true)).c("porkchopCooked"));
        ...
        register(357, "cookie", (new ItemFood(2, 0.1F, false)).c("cookie"));
        register(358, "filled_map", (new class_aax()).c("map"));
        register(359, "shears", (new class_abl()).c("shears"));
        register(360, "melon", (new ItemFood(2, 0.3F, false)).c("melon"));
        ...
        register(363, "beef", (new ItemFood(3, 0.3F, true)).c("beefRaw"));
        register(364, "cooked_beef", (new ItemFood(8, 0.8F, true)).c("beefCooked"));
        register(365, "chicken", (new ItemFood(2, 0.3F, true)).a(new class_pl(class_pm.q, 600, 0), 0.3F).c("chickenRaw"));
        register(366, "cooked_chicken", (new ItemFood(6, 0.6F, true)).c("chickenCooked"));
        register(367, "rotten_flesh", (new ItemFood(4, 0.1F, true)).a(new class_pl(class_pm.q, 600, 0), 0.8F).c("rottenFlesh"));
        ...
        register(374, "glass_bottle", (new ItemGlassBottle()).c("glassBottle"));
        register(375, "spider_eye", (new ItemFood(2, 0.8F, false)).a(new class_pl(class_pm.s, 100, 0), 1.0F).c("spiderEye"));
        ...
        register(393, "baked_potato", (new ItemFood(5, 0.6F, false)).c("potatoBaked"));
        register(394, "poisonous_potato", (new ItemFood(2, 0.3F, false)).a(new class_pl(class_pm.s, 100, 0), 0.6F).c("potatoPoisonous"));
        register(395, "map", (new class_aac()).c("emptyMap"));
        register(396, "golden_carrot", (new ItemFood(6, 1.2F, false)).c("carrotGolden").a(CreativeTab.BREWING));
        ...
        register(400, "pumpkin_pie", (new ItemFood(8, 0.3F, false)).c("pumpkinPie").a(CreativeTab.FOOD));
        ...
        register(411, "rabbit", (new ItemFood(3, 0.3F, true)).c("rabbitRaw"));
        register(412, "cooked_rabbit", (new ItemFood(5, 0.6F, true)).c("rabbitCooked"));
        register(413, "rabbit_stew", (new ItemSoup(10)).c("rabbitStew"));
        ...
        register(423, "mutton", (new ItemFood(2, 0.3F, true)).c("muttonRaw"));
        register(424, "cooked_mutton", (new ItemFood(6, 0.8F, true)).c("muttonCooked"));
        ...
        register(434, "beetroot", (new ItemFood(1, 0.6F, false)).c("beetroot"));
        register(435, "beetroot_seeds", (new ItemSeeds(Blocks.BEETROOTS, Blocks.FARMLAND)).c("beetroot_seeds"));
        register(436, "beetroot_soup", (new ItemSoup(6)).c("beetroot_soup"));
