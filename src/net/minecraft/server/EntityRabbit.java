...
public class EntityRabbit extends EntityAnimal {
	...
	private EntityRabbit.class_c_in_class_vk bu;
	private int bv = 0;
	private int bx = 0;
	private boolean by = false;
	private boolean bz = false;
	private int bA = 0;
	private EntityRabbit.class_b_in_class_vk bB;
	private int bC;
	private class_yu bD;

	public EntityRabbit(class_ago var1) {
		super(var1);
		bB = EntityRabbit.class_b_in_class_vk.b;
		bC = 0;
		bD = null;
		this.a(0.6F, 0.7F);
		g = new EntityRabbit.class_e_in_class_vk(this);
		f = new EntityRabbit.class_f_in_class_vk(this);
		((class_ul) u()).a(true);
		h.a(2.5F);
		i.a(1, new class_so(this));
		i.a(1, new EntityRabbit.class_g_in_class_vk(this, 1.33D));
		...
		i.a(5, new EntityRabbit.class_h_in_class_vk(this));
		i.a(5, new class_tn(this, 0.6D));
		i.a(11, new class_sw(this, class_yu.class, 10.0F));
		bu = new EntityRabbit.class_c_in_class_vk(this, EntityWolf.class, 16.0F, 1.33D, 1.33D);
		i.a(4, bu);
		this.b(0.0D);
	}
	...
	public void a(EntityRabbit.class_b_in_class_vk var1) {
		bB = var1;
	}
	...
	public void a(boolean var1, EntityRabbit.class_b_in_class_vk var2) {
		super.i(var1);
		if (!var1) {
			if (bB == EntityRabbit.class_b_in_class_vk.e) {
				bB = EntityRabbit.class_b_in_class_vk.b;
			}
		} else {
			this.b(1.5D * var2.a());
	...
	public void b(EntityRabbit.class_b_in_class_vk var1) {
		this.a(true, var1);
		bx = var1.d();
		bv = 0;
	}
	...
	public void cg() {
		if (f.b() > 0.8D) {
			this.a(EntityRabbit.class_b_in_class_vk.d);
		} else if (bB != EntityRabbit.class_b_in_class_vk.e) {
			this.a(EntityRabbit.class_b_in_class_vk.b);
		}
		...
		if (C) {
			if (!bz) {
				this.a(false, EntityRabbit.class_b_in_class_vk.a);
				cP();
			}
			...
			if ((cG() == 99) && (bA == 0)) {
				...
				if ((var1 != null) && (this.h(var1) < 16.0D)) {
					...
					this.b(EntityRabbit.class_b_in_class_vk.e);
					bz = true;
				}
			}

			EntityRabbit.class_e_in_class_vk var4 = (EntityRabbit.class_e_in_class_vk) g;
			if (!var4.c()) {
				if (f.a() && (bA == 0)) {
					class_axc var2 = h.j();
	...
	private void cM() {
		((EntityRabbit.class_e_in_class_vk) g).a(true);
	}

	private void cN() {
		((EntityRabbit.class_e_in_class_vk) g).a(false);
	}
	...
	public EntityRabbit b(EntityAgeable var1) {
		EntityRabbit var2 = new EntityRabbit(o);
		if (var1 instanceof EntityRabbit) {
			var2.k(V.nextBoolean() ? cG() : ((EntityRabbit) var1).cG());
		}
	...
	public void k(int var1) {
		if (var1 == 99) {
			i.a(bu);
			i.a(4, new EntityRabbit.class_a_in_class_vk(this));
			bo.a(1, new class_uc(this, false, new Class[0]));
			bo.a(2, new class_uf(this, class_yu.class, true));
			bo.a(2, new class_uf(this, EntityWolf.class, true));
			if (!k_()) {
	...
	public class_rj a(class_pt var1, class_rj var2) {
		...
		boolean var4 = false;
		if (var5 instanceof EntityRabbit.class_d_in_class_vk) {
			var3 = ((EntityRabbit.class_d_in_class_vk) var5).a;
			var4 = true;
		} else {
			var5 = new EntityRabbit.class_d_in_class_vk(var3);
		}
	...
	static {
		bt = DataWatcher.claimId(EntityRabbit.class, class_kb.b);
	}
	...
	static class class_a_in_class_vk extends class_sz {
		public class_a_in_class_vk(EntityRabbit var1) {
	...
	static class class_g_in_class_vk extends class_tj {
		...
		public class_g_in_class_vk(EntityRabbit var1, double var2) {
			super(var1, var2);
			b = var1;
		}
	...
	static class class_h_in_class_vk extends class_tc {
		...
		public class_h_in_class_vk(EntityRabbit var1) {
		...
		public void e() {
			...
			if (this.f()) {
				...
				if (e && (var4 instanceof class_aiu) && ((class_aiu) var4).e(var3)) {
					var1.a(var2, Blocks.AIR.getBlockData(), 2);
					var1.b(var2, true);
					c.cI();
				}
	...
	static class class_c_in_class_vk extends class_sg {
		...
		public class_c_in_class_vk(EntityRabbit var1, Class var2, float var3, double var4, double var6) {
	...
	static class class_f_in_class_vk extends class_se {
		...
		public class_f_in_class_vk(EntityRabbit var1) {
			super(var1);
			g = var1;
		}
	...
	public class class_e_in_class_vk extends class_sc {
		...
		public class_e_in_class_vk(EntityRabbit var2) {
			super(var2);
			c = var2;
		}
		...
		public void b() {
			if (a) {
				c.b(EntityRabbit.class_b_in_class_vk.c);
				a = false;
			}
