...
public class ItemFish extends ItemFood {
   ...
   protected void a(ItemStack var1, World var2, EntityHuman var3) {
      ...
      if(var4 == ItemFish.class_a_in_class_aak.d) {
         var3.addEffect(new MobEffect(MobEffectList.POISON, 1200, 3));
         var3.addEffect(new MobEffect(MobEffectList.HUNGER, 300, 2));
         var3.addEffect(new MobEffect(MobEffectList.CONFUSION, 300, 1));
      }
