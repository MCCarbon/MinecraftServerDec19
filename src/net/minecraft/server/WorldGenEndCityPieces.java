...
public class WorldGenEndCityPieces {
   ...
   private static final WorldGenEndCityPieces.class_b_in_class_ary f;
   private static final List g;
   private static final WorldGenEndCityPieces.class_b_in_class_ary h;
   private static final WorldGenEndCityPieces.class_b_in_class_ary i;
   private static final List j;
   private static final WorldGenEndCityPieces.class_b_in_class_ary k;

   public static void a() {
      WorldGenFactory.a(WorldGenEndCityPieces.class_a_in_class_ary.class, "ECP");
   }

   private static WorldGenEndCityPieces.class_a_in_class_ary b(WorldGenEndCityPieces.class_a_in_class_ary var0, BlockPosition var1, String var2, Block.EnumRotation var3, boolean var4) {
      WorldGenEndCityPieces.class_a_in_class_ary var5 = new WorldGenEndCityPieces.class_a_in_class_ary(var2, var0.c, var3, var4);
   ...
   public static void a(BlockPosition var0, Block.EnumRotation var1, List var2, Random var3) {
      ...
      i.a();
      h.a();
      WorldGenEndCityPieces.class_a_in_class_ary var4 = new WorldGenEndCityPieces.class_a_in_class_ary("base_floor", var0, var1, true);
      var2.add(var4);
      byte var5 = 0;
      WorldGenEndCityPieces.class_a_in_class_ary var6;
   ...
   private static boolean b(WorldGenEndCityPieces.class_b_in_class_ary var0, int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5) {
      if(var1 > 8) {
         return false;
      } else {
   ...
   static {
      ...
      f = new WorldGenEndCityPieces.class_b_in_class_ary() {
         public void a() {
         }

         public boolean a(int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5) {
            if(var1 > 8) {
               return false;
            } else {
               Block.EnumRotation var6 = var2.b.c();
               WorldGenEndCityPieces.class_a_in_class_ary var7;
               ...
               if(var8 == 0) {
                  ...
                  WorldGenEndCityPieces.b(WorldGenEndCityPieces.h, var1 + 1, var7, (BlockPosition)null, var4, var5);
               } else if(var8 == 2) {
                  var4.add(var7 = WorldGenEndCityPieces.b(var7, new BlockPosition(-1, 0, -1), "second_floor_2", var6, false));
      ...
      h = new WorldGenEndCityPieces.class_b_in_class_ary() {
         public void a() {
         }
         ...
         public boolean a(int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5) {
            ...
            WorldGenEndCityPieces.class_a_in_class_ary var8 = var5.nextInt(3) == 0?var7:null;
            ...
            if(var8 != null) {
               Iterator var13 = WorldGenEndCityPieces.g.iterator();

               while(var13.hasNext()) {
                  Tuple var11 = (Tuple)var13.next();
                  if(var5.nextBoolean()) {
                     WorldGenEndCityPieces.class_a_in_class_ary var12;
                     var4.add(var12 = WorldGenEndCityPieces.b(var8, (BlockPosition)var11.getObject2(), "bridge_end", var6.a((Block.EnumRotation)var11.getObject1()), true));
                     WorldGenEndCityPieces.b(WorldGenEndCityPieces.i, var1 + 1, var12, (BlockPosition)null, var4, var5);
                  }
               }
               ...
               if(var1 != 7) {
                  return WorldGenEndCityPieces.b(WorldGenEndCityPieces.k, var1 + 1, var7, (BlockPosition)null, var4, var5);
               }
      ...
      i = new WorldGenEndCityPieces.class_b_in_class_ary() {
         public boolean a;
         ...
         public boolean a(int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5) {
            ...
            if(!this.a && var5.nextInt(10 - var1) == 0) {
               ...
               this.a = true;
            } else if(!WorldGenEndCityPieces.b(WorldGenEndCityPieces.f, var1 + 1, var6, new BlockPosition(-3, var9 + 1, -11), var4, var5)) {
               return false;
            }

            var4.add(var6 = WorldGenEndCityPieces.b(var6, new BlockPosition(4, var9, 0), "bridge_end", var7.a(Block.EnumRotation.CLOCKWISE_180), true));
            var6.m = -1;
            return true;
         }
      };
      ...
      k = new WorldGenEndCityPieces.class_b_in_class_ary() {
         public void a() {
         }
         ...
         public boolean a(int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5) {
            ...
            for(int var8 = 0; var8 < 2 && var5.nextInt(3) != 0; ++var8) {
               ...
               Iterator var9 = WorldGenEndCityPieces.j.iterator();

               while(var9.hasNext()) {
                  Tuple var10 = (Tuple)var9.next();
                  if(var5.nextBoolean()) {
                     WorldGenEndCityPieces.class_a_in_class_ary var11;
                     var4.add(var11 = WorldGenEndCityPieces.b(var6, (BlockPosition)var10.getObject2(), "bridge_end", var7.a((Block.EnumRotation)var10.getObject1()), true));
                     WorldGenEndCityPieces.b(WorldGenEndCityPieces.i, var1 + 1, var11, (BlockPosition)null, var4, var5);
                  }
               }
            }
   ...
   interface class_b_in_class_ary {
      ...
      boolean a(int var1, WorldGenEndCityPieces.class_a_in_class_ary var2, BlockPosition var3, List var4, Random var5);
   }
   ...
   public static class class_a_in_class_ary extends class_asp {
      ...
      private void a(BlockPosition var1) {
         class_asv var2 = WorldGenEndCityPieces.a.a(new MinecraftKey("endcity/" + this.d));
         class_asu var3 = null;
         if(this.f) {
            var3 = WorldGenEndCityPieces.b.a().a(this.e);
         } else {
            var3 = WorldGenEndCityPieces.c.a().a(this.e);
         }
         ...
         if(var1.startsWith("Chest")) {
            ...
            if(var5.b((BaseBlockPosition)var6)) {
               ...
               if(var7 instanceof TileEntityChest) {
                  ArrayList var8 = Lists.newArrayList((Iterable)WorldGenEndCityPieces.d);
