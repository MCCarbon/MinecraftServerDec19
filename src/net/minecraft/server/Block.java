...
public class Block {
	...
	private class_abp b;
	public static final Block.class_d_in_class_ail e;
	public static final Block.class_d_in_class_ail f;
	public static final Block.class_d_in_class_ail g;
	public static final Block.class_d_in_class_ail h;
	public static final Block.class_d_in_class_ail i;
	public static final Block.class_d_in_class_ail j;
	public static final Block.class_d_in_class_ail k;
	public static final Block.class_d_in_class_ail l;
	public static final Block.class_d_in_class_ail m;
	public static final Block.class_d_in_class_ail n;
	public static final Block.class_d_in_class_ail o;
	public static final Block.class_d_in_class_ail p;
	public static final Block.class_d_in_class_ail q;
	protected boolean r;
	protected int s;
	protected boolean t;
	protected int u;
	...
	protected double F;
	protected double G;
	public Block.class_d_in_class_ail H;
	public float I;
	...
	public Block(class_avq var1, class_avr var2) {
		y = true;
		H = e;
		I = 1.0F;
		L = 0.6F;
	...
	protected Block(class_avq var1) {
		this(var1, var1.r());
	}

	protected Block a(Block.class_d_in_class_ail var1) {
		H = var1;
		return this;
	}
	...
	public class_aco b(class_ago var1, class_cj var2, class_apn var3) {
		return new class_aco(Item.a(this), 1, this.a(var3));
	}

	public Block a(class_abp var1) {
		b = var1;
		return this;
	}
	...
	public static void U() {
		...
		Block var0 = (new Block(class_avq.e)).c(2.0F).b(10.0F).a(i).c("stonebrick").a(class_abp.b);
		a(4, "cobblestone", var0);
		Block var1 = (new class_aly()).c(2.0F).b(5.0F).a(f).c("wood");
		a(5, "planks", var1);
		a(6, "sapling", (new class_amu()).c(0.0F).a(h).c("sapling"));
		a(7, "bedrock", (new Block(class_avq.e)).z().b(6000000.0F).a(i).c("bedrock").M().a(class_abp.b));
		a(8, "flowing_water", (new BlockFlowing(class_avq.h)).c(100.0F).e(3).c("water").M());
		a(9, "water", (new BlockStationary(class_avq.h)).c(100.0F).e(3).c("water").M());
		a(10, "flowing_lava", (new BlockFlowing(class_avq.i)).c(100.0F).a(1.0F).c("lava").M());
		a(11, "lava", (new BlockStationary(class_avq.i)).c(100.0F).a(1.0F).c("lava").M());
		...
		a(22, "lapis_block", (new Block(class_avq.f, class_avr.H)).c(3.0F).b(5.0F).a(i).c("blockLapis").a(class_abp.b));
		a(23, "dispenser", (new class_ajm()).c(3.5F).a(i).c("dispenser"));
		Block var2 = (new class_amt()).a(i).c(0.8F).c("sandStone");
		a(24, "sandstone", var2);
		...
		Block var3 = (new class_alk()).c(0.0F).a(h).a(0.125F).c("mushroom");
		a(39, "brown_mushroom", var3);
		Block var4 = (new class_alk()).c(0.0F).a(h).c("mushroom");
		a(40, "red_mushroom", var4);
		a(41, "gold_block", (new Block(class_avq.f, class_avr.F)).c(3.0F).b(10.0F).a(j).c("blockGold").a(class_abp.b));
		a(42, "iron_block", (new Block(class_avq.f, class_avr.h)).c(5.0F).b(10.0F).a(j).c("blockIron").a(class_abp.b));
		...
		Block var5 = (new Block(class_avq.e, class_avr.D)).c(2.0F).b(10.0F).a(i).c("brick").a(class_abp.b);
		a(45, "brick_block", var5);
		a(46, "tnt", (new class_anq()).c(0.0F).a(h).c("tnt"));
		a(47, "bookshelf", (new class_aio()).c(1.5F).a(f).c("bookshelf"));
		a(48, "mossy_cobblestone", (new Block(class_avq.e)).c(2.0F).b(10.0F).a(i).c("stoneMoss").a(class_abp.b));
		...
		a(57, "diamond_block", (new Block(class_avq.f, class_avr.G)).c(5.0F).b(10.0F).a(j).c("blockDiamond").a(class_abp.b));
		a(58, "crafting_table", (new class_aje()).c(2.5F).a(f).c("workbench"));
		a(59, "wheat", (new class_ajf()).c("crops"));
		Block var6 = (new class_aka()).c(0.6F).a(g).c("farmland");
		a(60, "farmland", var6);
		...
		a(83, "reeds", (new BlockReed()).c(0.0F).a(h).c("reeds").M());
		...
		Block var7 = (new class_amf()).c(1.0F).a(f).c("pumpkin");
		a(86, "pumpkin", var7);
		...
		a(93, "unpowered_repeater", (new BlockRedstoneRepeater(false)).c(0.0F).a(f).c("diode").M());
		a(94, "powered_repeater", (new BlockRedstoneRepeater(true)).c(0.0F).a(f).c("diode").M());
		a(95, "stained_glass", (new BlockStainedGlass(class_avq.s)).c(0.3F).a(k).c("stainedGlass"));
		a(96, "trapdoor", (new class_ant(class_avq.d)).c(3.0F).a(f).c("trapdoor").M());
		a(97, "monster_egg", (new class_alj()).c(0.75F).c("monsterStoneEgg"));
		Block var8 = (new class_ank()).c(1.5F).b(10.0F).a(i).c("stonebricksmooth");
		...
		Block var9 = (new class_alh()).c(1.0F).a(f).c("melon");
		...
		a(121, "end_stone", (new Block(class_avq.e, class_avr.d)).c(3.0F).b(15.0F).a(i).c("whiteStone").a(class_abp.b));
		...
		a(149, "unpowered_comparator", (new BlockRedstoneComparator(false)).c(0.0F).a(f).c("comparator").M());
		a(150, "powered_comparator", (new BlockRedstoneComparator(true)).c(0.0F).a(0.625F).a(f).c("comparator").M());
		a(151, "daylight_detector", new BlockRedstoneDetector(false));
		...
		a(173, "coal_block", (new Block(class_avq.e, class_avr.E)).c(5.0F).b(10.0F).a(i).c("blockCoal").a(class_abp.b));
		...
		Block var14 = (new class_akn()).c(0.65F).a(h).c("grassPath").M();
		...
		while (true) {
			...
			while (var15.hasNext()) {
				...
				if (var16.J == class_avq.a) {
					...
					boolean var19 = var16 instanceof BlockStepAbstract;
	...
	private static void a(int var0, class_ke var1, Block var2) {
		c.a(var0, var1, var2);
	}
	...
	static {
		c = new class_co(a);
		d = new class_ct();
		e = new Block.class_d_in_class_ail("stone", 1.0F, 1.0F);
		f = new Block.class_d_in_class_ail("wood", 1.0F, 1.0F);
		g = new Block.class_d_in_class_ail("gravel", 1.0F, 1.0F);
		h = new Block.class_d_in_class_ail("grass", 1.0F, 1.0F);
		i = new Block.class_d_in_class_ail("stone", 1.0F, 1.0F);
		j = new Block.class_d_in_class_ail("stone", 1.0F, 1.5F);
		k = new Block.class_d_in_class_ail("stone", 1.0F, 1.0F) {
			@Override
			public String a() {
				return "dig.glass";
			}
		...
		l = new Block.class_d_in_class_ail("cloth", 1.0F, 1.0F);
		m = new Block.class_d_in_class_ail("sand", 1.0F, 1.0F);
		n = new Block.class_d_in_class_ail("snow", 1.0F, 1.0F);
		o = new Block.class_d_in_class_ail("ladder", 1.0F, 1.0F) {
			@Override
			public String a() {
				return "dig.wood";
			}
		};
		p = new Block.class_d_in_class_ail("anvil", 0.3F, 1.0F) {
			@Override
			public String a() {
				return "dig.stone";
			}
		...
		q = new Block.class_d_in_class_ail("slime", 1.0F, 1.0F) {
			@Override
			public String a() {
	...
	static class SyntheticClass_1 {
		...
		static {
			...
			try {
				a[Block.class_c_in_class_ail.d.ordinal()] = 4;
	...
	public static enum class_a_in_class_ail {
		...
		public Block.class_c_in_class_ail a(class_cq var1) {
			class_cq.class_a_in_class_cq var2 = var1.k();
			return ((this != b) || (var2 != class_cq.class_a_in_class_cq.c)) && ((this != c) || (var2 != class_cq.class_a_in_class_cq.a)) ? Block.class_c_in_class_ail.a : Block.class_c_in_class_ail.c;
		}
		...
		static {
			...
			int var0 = 0;
			Block.class_a_in_class_ail[] var1 = values();
			int var2 = var1.length;

			for (int var3 = 0; var3 < var2; ++var3) {
				Block.class_a_in_class_ail var4 = var1[var3];
				e[var0++] = var4.d;
			}
	...
	public static enum class_c_in_class_ail {
		...
		public Block.class_c_in_class_ail a(Block.class_c_in_class_ail var1) {
		...
		static {
			...
			int var0 = 0;
			Block.class_c_in_class_ail[] var1 = values();
			int var2 = var1.length;

			for (int var3 = 0; var3 < var2; ++var3) {
				Block.class_c_in_class_ail var4 = var1[var3];
				f[var0++] = var4.e;
			}
