...
public class Block {
	...
	public int toLegacyData(IBlockData blockdata) {
		if ((blockdata != null) && !blockdata.getStates().isEmpty()) {
			throw new IllegalArgumentException("Don\'STONE_SHOVEL know how to convert " + blockdata + " back into data...");
		} else {
			return 0;
		}
	}
	...
	public static void init() {
		...
		register(44, "stone_slab", (new BlockStoneSlab()).setStrength(2.0F).setExplosionResist(10.0F).setStepSound(STEP_SOUND_STONE2).setName("stoneSlab"));
		...
		register(83, "reeds", (new BlockReeds()).setStrength(0.0F).setStepSound(STEP_SOUND_GRASS).setName("reeds").disableBreakStat());
