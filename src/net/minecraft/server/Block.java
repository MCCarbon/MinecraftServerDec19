...
public class Block {
	...
	public static void init() {
		...
		register(61, "furnace", (new class_aih(false)).setStrength(3.5F).setStepSound(STEP_SOUND_STONE2).setName("furnace").setCreativeTab(CreativeTab.DECORATIONS));
		...
		register(73, "redstone_ore", (new class_akj(false)).setStrength(3.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_STONE2).setName("oreRedstone").setCreativeTab(CreativeTab.BUILDING_BLOCKS));
		...
		register(76, "redstone_torch", (new class_akm(true)).setStrength(0.0F).setLightLevel(0.5F).setStepSound(STEP_SOUND_WOOD).setName("notGate").setCreativeTab(CreativeTab.REDSTONE));
		...
		register(85, "fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.OAK.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("fence"));
		...
		register(93, "unpowered_repeater", (new BlockRepeater(false)).setStrength(0.0F).setStepSound(STEP_SOUND_WOOD).setName("diode").disableBreakStat());
		register(94, "powered_repeater", (new BlockRepeater(true)).setStrength(0.0F).setStepSound(STEP_SOUND_WOOD).setName("diode").disableBreakStat());
		...
		register(114, "nether_brick_stairs", (new BlockStairs(var10.getBlockData())).setName("stairsNetherBrick"));
		...
		register(120, "end_portal_frame", (new class_aht()).setStepSound(STEP_SOUND_STONE4).setLightLevel(0.125F).setStrength(-1.0F).setName("endPortalFrame").setExplosionResist(6000000.0F).setCreativeTab(CreativeTab.DECORATIONS));
		...
		register(123, "redstone_lamp", (new class_akl(false)).setStrength(0.3F).setStepSound(STEP_SOUND_STONE4).setName("redstoneLight").setCreativeTab(CreativeTab.REDSTONE));
		...
		register(139, "cobblestone_wall", (new class_alv(cobble)).setName("cobbleWall"));
		...
		register(152, "redstone_block", (new class_ajz(Material.ORE, MaterialMapColor.COLOR5)).setStrength(5.0F).setExplosionResist(10.0F).setStepSound(STEP_SOUND_STONE3).setName("blockRedstone").setCreativeTab(CreativeTab.REDSTONE));
		...
		register(156, "quartz_stairs", (new BlockStairs(var11.getBlockData().set(class_akf.a, class_akf.class_a_in_class_akf.a))).setName("stairsQuartz"));
		...
		register(170, "hay_block", (new class_ait()).setStrength(0.5F).setStepSound(STEP_SOUND_GRASS).setName("hayBlock").setCreativeTab(CreativeTab.BUILDING_BLOCKS));
		...
		register(180, "red_sandstone_stairs", (new BlockStairs(var12.getBlockData().set(class_aki.a, class_aki.class_a_in_class_aki.c))).setName("stairsRedSandStone"));
		...
		register(183, "spruce_fence_gate", (new class_aia(BlockWood.EnumLogVariant.SPRUCE)).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("spruceFenceGate"));
		register(184, "birch_fence_gate", (new class_aia(BlockWood.EnumLogVariant.BIRCH)).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("birchFenceGate"));
		register(185, "jungle_fence_gate", (new class_aia(BlockWood.EnumLogVariant.JUNGLE)).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("jungleFenceGate"));
		register(186, "dark_oak_fence_gate", (new class_aia(BlockWood.EnumLogVariant.DARK_OAK)).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("darkOakFenceGate"));
		register(187, "acacia_fence_gate", (new class_aia(BlockWood.EnumLogVariant.ACACIA)).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("acaciaFenceGate"));
		register(188, "spruce_fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.SPRUCE.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("spruceFence"));
		register(189, "birch_fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.BIRCH.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("birchFence"));
		register(190, "jungle_fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.JUNGLE.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("jungleFence"));
		register(191, "dark_oak_fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.DARK_OAK.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("darkOakFence"));
		register(192, "acacia_fence", (new class_ahz(Material.WOOD, BlockWood.EnumLogVariant.ACACIA.getMapColor())).setStrength(2.0F).setExplosionResist(5.0F).setStepSound(STEP_SOUND_WOOD).setName("acaciaFence"));
