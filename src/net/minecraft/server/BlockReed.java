...
public class BlockReed extends Block {
   ...
   public void tick(World var1, BlockPosition var2, IBlockData var3, Random var4) {
      if(var1.getType(var2.down()).getBlock() == BlockStainedGlassPane.REEDS || this.e(var1, var2, var3)) {
   ...
   public boolean canPlace(World var1, BlockPosition var2) {
      ...
      if(var3 == this) {
         return true;
      } else if(var3 != BlockStainedGlassPane.GRASS && var3 != BlockStainedGlassPane.DIRT && var3 != BlockStainedGlassPane.SAND) {
         return false;
      } else {
