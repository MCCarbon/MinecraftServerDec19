...
public class class_aae extends Item {
   ...
   public class_oq a(class_aas var1, class_xa var2, World var3, class_cj var4, class_oo var5, class_cq var6, float var7, float var8, float var9) {
      ...
      if(var2.a(var4.a(var6), var6, var1) && var10.getBlock() == Blocks.END_PORTAL_FRAME && !((Boolean)var10.get(class_aht.b)).booleanValue()) {
         if(var3.D) {
            return class_oq.a;
         } else {
            ...
            for(int var11 = 0; var11 < 16; ++var11) {
               double var12 = (double)((float)var4.n() + (5.0F + random.nextFloat() * 6.0F) / 16.0F);
               double var14 = (double)((float)var4.o() + 0.8125F);
               double var16 = (double)((float)var4.p() + (5.0F + random.nextFloat() * 6.0F) / 16.0F);
               double var18 = 0.0D;
               double var20 = 0.0D;
               double var22 = 0.0D;
            ...
            if(var15 && var13 == var25 + 2) {
               ...
               if(var15) {
                  for(var30 = var25; var30 <= var13; ++var30) {
                     ...
                     for(var32 = 1; var32 <= 3; ++var32) {
                        var34 = var28.a(var24, var32);
                        var3.a((class_cj)var34, (IBlockData)Blocks.END_PORTAL.getBlockData(), 2);
                     }
                  }
               }
            }
