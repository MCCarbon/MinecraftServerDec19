...
public class class_aae extends class_aar {
   ...
   public class_oq a(class_aas var1, class_xa var2, class_aen var3, class_cj var4, class_oo var5, class_cq var6, float var7, float var8, float var9) {
      ...
      if(var2.a(var4.a(var6), var6, var1) && var10.getBlock() == class_agk.bG && !((Boolean)var10.get(class_aht.b)).booleanValue()) {
         if(var3.D) {
            return class_oq.a;
         } else {
            var3.a((class_cj)var4, (IBlockData)var10.set(class_aht.b, Boolean.valueOf(true)), 2);
            ...
            class_cq var24 = (class_cq)var10.get(class_aht.a);
            int var25 = 0;
            int var13 = 0;
            boolean var26 = false;
            boolean var15 = true;
            ...
            for(int var17 = -2; var17 <= 2; ++var17) {
               ...
               if(var19.getBlock() == class_agk.bG) {
            ...
            if(var15 && var13 == var25 + 2) {
               ...
               for(var30 = var25; var30 <= var13; ++var30) {
                  ...
                  if(var33.getBlock() != class_agk.bG || !((Boolean)var33.get(class_aht.b)).booleanValue()) {
                     var15 = false;
                     break;
                  }
               }
               ...
               for(var30 = var25 - 1; var30 <= var13 + 1; var30 += 4) {
                  ...
                  for(var32 = 1; var32 <= 3; ++var32) {
                     ...
                     if(var21.getBlock() != class_agk.bG || !((Boolean)var21.get(class_aht.b)).booleanValue()) {
                        var15 = false;
                        break;
                     }
                  }
               ...
               if(var15) {
                  for(var30 = var25; var30 <= var13; ++var30) {
                     ...
                     for(var32 = 1; var32 <= 3; ++var32) {
                        var34 = var28.a(var24, var32);
                        var3.a((class_cj)var34, (IBlockData)class_agk.bF.S(), 2);
                     }
                  }
               }
            }
   ...
   public class_or a(class_aas var1, class_aen var2, class_xa var3, class_oo var4) {
      ...
      if(var5 != null && var5.a == class_awg.class_a_in_class_awg.b && var2.p(var5.a()).getBlock() == class_agk.bG) {
