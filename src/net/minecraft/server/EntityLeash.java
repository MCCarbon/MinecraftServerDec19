...
public class EntityLeash extends class_wt {
	public EntityLeash(class_ago var1) {
		super(var1);
	}

	public EntityLeash(class_ago var1, class_cj var2) {
		super(var1, var2);
	...
	public boolean a(class_yu var1, class_aco var2, class_pu var3) {
		if (o.D) {
			...
			if ((var2 != null) && (var2.b() == Items.cs)) {
				var5 = 7.0D;
				var7 = o.a(EntityInsentient.class, new class_ayk(s - var5, t - var5, u - var5, s + var5, t + var5, u + var5));
				var8 = var7.iterator();
	...
	public static EntityLeash a(class_ago var0, class_cj var1) {
	...
	public static EntityLeash b(class_ago var0, class_cj var1) {
		int var2 = var1.n();
		int var3 = var1.o();
		int var4 = var1.p();
		List var5 = var0.a(EntityLeash.class, new class_ayk(var2 - 1.0D, var3 - 1.0D, var4 - 1.0D, var2 + 1.0D, var3 + 1.0D, var4 + 1.0D));
