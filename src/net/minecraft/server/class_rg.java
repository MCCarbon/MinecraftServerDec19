...
public abstract class class_rg extends class_qx {
	...
	public class_rg(class_ago var1) {
		super(var1);
		be();
		this.c(bB());
		k = true;
	...
	public void M() {
		...
		if (al()) {
			if (am()) {
				...
				if (var2 < 0.0D) {
					this.a(class_qi.e, Math.max(1, class_oa.c(-var2 * o.ah().n())));
				}
			}
		}
	...
	public void c(float var1) {
		ac.b(c, Float.valueOf(class_oa.a(var1, 0.0F, bB())));
	}
			...
			if (bu() <= 0.0F) {
				...
				if ((var2 > 0.0F) && this.c(var1)) {
					...
					if (var1.a()) {
						...
						var2 *= 0.33F;
						if (var1.i() instanceof class_rg) {
							((class_rg) var1.i()).a(this, 0.5F, s - var1.i().s, u - var1.i().u);
						}
					}
				...
				if (var5 != null) {
					...
					if (var5 instanceof class_yu) {
						aS = 100;
						aR = (class_yu) var5;
					} else if (var5 instanceof class_vr) {
						class_vr var6 = (class_vr) var5;
						if (var6.cE()) {
							aS = 100;
							aR = null;
						}
				...
				if (var4) {
					...
					if (var5 != null) {
						...
						az = (float) (((class_oa.b(var8, var10) * 180.0D) / 3.1415927410125732D) - y);
	...
	public void a(class_qi var1) {
		...
		if (!o.D) {
			...
			if (var2 instanceof class_yu) {
				var4 = class_afl.h((class_rg) var2);
			}
	...
	public void e(float var1, float var2) {
		...
		int var5 = class_oa.f((var1 - 3.0F - var4) * var2);
		if (var5 > 0) {
	...
	public int by() {
		...
		while (var2.hasNext()) {
			...
			if ((var3 != null) && (var3.b() instanceof class_aav)) {
				...
				int var6 = var3.h();
				if (var6 > (var5 / 2)) {
					var4 = class_oa.f((float) (var5 - var6) / (float) (var5 / 2));
				}
	...
	public void a(class_pu var1) {
		if (!at || (av >= (this.n() / 2)) || (av < 0)) {
			...
			if (o instanceof class_ll) {
				((class_ll) o).u().a(this, (new class_fq(this, var1 == class_pu.a ? 0 : 3)));
			}
		}
	...
	protected void bM() {
		...
		if (aB()) {
			...
			v -= class_oa.a(var1) * 0.2F;
			x += class_oa.b(var1) * 0.2F;
		}
	...
	public void g(float var1, float var2) {
		...
		if (bT()) {
			...
			if (Y() && (!(this instanceof class_yu) || !((class_yu) this).bI.b)) {
				...
				float var8 = 0.91F;
				if (C) {
					var8 = o.p(new class_cj(class_oa.c(s), class_oa.c(aX().b) - 1, class_oa.c(u))).c().L * 0.91F;
				}
				...
				if (j_()) {
					var6 = 0.15F;
					v = class_oa.a(v, (-var6), var6);
					x = class_oa.a(x, (-var6), var6);
					O = 0.0F;
					if (w < -0.15D) {
						w = -0.15D;
					}
		...
		var3 = s - p;
		double var9 = u - r;
		var10 = class_oa.a((var3 * var3) + (var9 * var9)) * 4.0F;
		if (var10 > 1.0F) {
			var10 = 1.0F;
		}
	...
	public void r_() {
		...
		if (!o.D) {
			...
			for (int var4 = 0; var4 < var3; ++var4) {
				...
				class_aco var6;
				switch (class_rg.SyntheticClass_1.a[var5.a().ordinal()]) {
					case 1:
						var6 = bq[var5.b()];
						break;
					case 2:
		...
		if (var12 > 0.0025000002F) {
			...
			var13 = (((float) class_oa.b(var11, var9) * 180.0F) / 3.1415927F) - 90.0F;
		}
	...
	protected float h(float var1, float var2) {
		float var3 = class_oa.g(var1 - aM);
		aM += var3 * 0.3F;
		float var4 = class_oa.g(y - aM);
	...
	public void a(class_qx var1, int var2) {
		if (!var1.I && !o.D) {
			...
			if (var1 instanceof class_yx) {
				var3.a(var1, (new class_hz(var1.G(), G())));
			}

			if (var1 instanceof class_rd) {
				var3.a(var1, (new class_hz(var1.G(), G())));
			}
		}
	...
	static {
		...
		as = class_kc.a(class_rg.class, class_kb.a);
		c = class_kc.a(class_rg.class, class_kb.c);
		f = class_kc.a(class_rg.class, class_kb.b);
		g = class_kc.a(class_rg.class, class_kb.g);
		h = class_kc.a(class_rg.class, class_kb.b);
	}
