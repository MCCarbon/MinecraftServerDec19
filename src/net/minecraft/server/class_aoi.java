...
public abstract class class_aoi {
	...
	public static class_aoi c(class_dn var0) {
		class_aoi var1 = null;

		try {
			Class var2 = (Class) f.get(var0.l("id"));
			if (var2 != null) {
				var1 = (class_aoi) var2.newInstance();
			}
	...
	public void a(class_c var1) {
		var1.a("Name", new Callable() {
			public String a() throws Exception {
				return (String) class_aoi.g.get(class_aoi.this.getClass()) + " // " + class_aoi.this.getClass().getCanonicalName();
			}
		...
		if (b != null) {
			...
			var1.a("Actual block type", new Callable() {
				public String a() throws Exception {
					int var1 = class_ail.a(b.p(c).c());

					try {
						return String.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(var1), class_ail.c(var1).a(), class_ail.c(var1).getClass().getCanonicalName() });
