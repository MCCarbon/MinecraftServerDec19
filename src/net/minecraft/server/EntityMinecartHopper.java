...
public class EntityMinecartHopper extends class_xk implements class_aou {
	private boolean a = true;
	private int b = -1;
	private class_cj c;

	public EntityMinecartHopper(class_ago var1) {
		super(var1);
		c = class_cj.a;
	}

	public EntityMinecartHopper(class_ago var1, double var2, double var4, double var6) {
	...
	public boolean D() {
		if (class_aov.a(this)) {
			...
			List var1 = o.a(EntityItem.class, aX().b(0.25D, 0.0D, 0.25D), class_rb.a);
			if (!var1.isEmpty()) {
				class_aov.a(this, ((EntityItem) var1.get(0)));
			}
	...
	public void a(class_qi var1) {
		...
		if (o.S().b("doEntityDrops")) {
			this.a(Item.a(Blocks.HOPPER), 1, 0.0F);
		}
