...
public interface class_eu extends Iterable {
	...
	public static class class_a_in_class_eu implements JsonDeserializer, JsonSerializer {
			...
			if (var1.isJsonPrimitive()) {
				...
				if (var1.isJsonArray()) {
					...
					while (var14.hasNext()) {
						...
						class_eu var18 = this.a(var17, var17.getClass(), var3);
						if (var15 == null) {
							var15 = var18;
						} else {
							var15.a(var18);
				...
				if ((var11.j() != null) && (var11.j().length > 0)) {
					...
					for (int var9 = 0; var9 < var8; ++var9) {
						...
						if (var10 instanceof class_eu) {
							var14.add(this.a(((class_eu) var10), var10.getClass(), var3));
						} else {
		...
		public static class_eu a(String var0) {
			return (class_eu) class_nq.a(a, var0, class_eu.class, false);
		}

		public static class_eu b(String var0) {
			return (class_eu) class_nq.a(a, var0, class_eu.class, true);
		}
