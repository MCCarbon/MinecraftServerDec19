...
public class RecipeBanners {
   void a(CraftingManager var1) {
      ...
      var1.a(new RecipeBanners.class_b_in_class_acj());
      var1.a(new RecipeBanners.class_a_in_class_acj());
   }
   ...
   static class class_a_in_class_acj implements IRecipe {
      ...
      private TileEntityBanner.EnumBannerPattern c(InventoryCrafting var1) {
      ...
      // $FF: synthetic method
      class_a_in_class_acj(RecipeBanners.SyntheticClass_1 var1) {
         this();
      }
   }

   static class class_b_in_class_acj implements IRecipe {
      ...
      // $FF: synthetic method
      class_b_in_class_acj(RecipeBanners.SyntheticClass_1 var1) {
         this();
      }
   }
}
