...
public class class_lq extends ChannelInboundHandlerAdapter {
	private static final Logger a = LogManager.getLogger();
	private class_ls b;

	public class_lq(class_ls var1) {
		b = var1;
	}
	...
	public void channelRead(ChannelHandlerContext var1, Object var2) throws Exception {
		...
		try {
			if (var3.readUnsignedByte() == 254) {
				...
				MinecraftServer var6 = b.d();
				int var7 = var3.readableBytes();
				String var8;
				switch (var7) {
					case 0:
						a.debug("Ping: (<1.3.x) from {}:{}", new Object[] { var5.getAddress(), Integer.valueOf(var5.getPort()) });
						var8 = String.format("%s§%d§%d", new Object[] { var6.ao(), Integer.valueOf(var6.K()), Integer.valueOf(var6.L()) });
					...
					case 1:
						...
						var8 = String.format("§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", new Object[] { Integer.valueOf(127), var6.J(), var6.ao(), Integer.valueOf(var6.K()), Integer.valueOf(var6.L()) });
						this.a(var1, this.a(var8));
						break;
					default:
						...
						String var10 = String.format("§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", new Object[] { Integer.valueOf(127), var6.J(), var6.ao(), Integer.valueOf(var6.K()), Integer.valueOf(var6.L()) });
