...
public class EntityEnderpearl extends class_zj {
	private EntityLiving d;

	public EntityEnderpearl(class_ago var1) {
		super(var1);
	}

	public EntityEnderpearl(class_ago var1, EntityLiving var2) {
		super(var1, var2);
		d = var2;
	}
			...
			if (var2 instanceof class_lm) {
				...
				if (var7.a.a().g() && (var7.o == o) && !var7.bQ()) {
					if ((V.nextFloat() < 0.05F) && o.S().b("doMobSpawning")) {
						EntityEndermite var8 = new EntityEndermite(o);
						var8.a(true);
