...
public class class_ajd extends class_ajj implements class_ajy {
	public static final class_apy a = class_apy.a("powered");
	public static final class_aqa b = class_aqa.a("mode", class_ajd.class_a_in_class_ajd.class);

	public class_ajd(boolean var1) {
		super(var1);
		this.j(M.b().a(O, class_cq.c).a(a, Boolean.valueOf(false)).a(b, class_ajd.class_a_in_class_ajd.a));
		A = true;
	}
	...
	protected class_apn e(class_apn var1) {
		...
		class_ajd.class_a_in_class_ajd var3 = (class_ajd.class_a_in_class_ajd) var1.b(b);
		class_cq var4 = (class_cq) var1.b(O);
		return class_aim.ck.S().a(O, var4).a(a, var2).a(b, var3);
	}
	...
	protected class_apn k(class_apn var1) {
		...
		class_ajd.class_a_in_class_ajd var3 = (class_ajd.class_a_in_class_ajd) var1.b(b);
		class_cq var4 = (class_cq) var1.b(O);
		return class_aim.cj.S().a(O, var4).a(a, var2).a(b, var3);
	}
	...
	private int k(class_ago var1, class_cj var2, class_apn var3) {
		return var3.b(b) == class_ajd.class_a_in_class_ajd.b ? Math.max(this.g(var1, var2, var3) - this.c((class_ags) var1, var2, var3), 0) : this.g(var1, var2, var3);
	}
	...
	public boolean a(class_ago var1, class_cj var2, class_apn var3, class_yu var4, class_pu var5, class_aco var6, class_cq var7, float var8, float var9, float var10) {
		if (!var4.bI.e) {
			...
			var3 = var3.a(b);
			var1.a(var2.n() + 0.5D, var2.o() + 0.5D, var2.p() + 0.5D, "random.click", 0.3F, var3.b(b) == class_ajd.class_a_in_class_ajd.b ? 0.55F : 0.5F);
			var1.a(var2, var3, 2);
	...
	private void l(class_ago var1, class_cj var2, class_apn var3) {
		...
		if ((var6 != var4) || (var3.b(b) == class_ajd.class_a_in_class_ajd.a)) {
	...
	public class_apn a(int var1) {
		return S().a(O, class_cq.b(var1)).a(a, Boolean.valueOf((var1 & 8) > 0)).a(b, (var1 & 4) > 0 ? class_ajd.class_a_in_class_ajd.b : class_ajd.class_a_in_class_ajd.a);
	}
	...
	public int c(class_apn var1) {
		...
		if (var1.b(b) == class_ajd.class_a_in_class_ajd.b) {
			var3 |= 4;
		}
	...
	public class_apn a(class_ago var1, class_cj var2, class_cq var3, float var4, float var5, float var6, int var7, class_rg var8) {
		return S().a(O, var8.aV().d()).a(a, Boolean.valueOf(false)).a(b, class_ajd.class_a_in_class_ajd.a);
	}
