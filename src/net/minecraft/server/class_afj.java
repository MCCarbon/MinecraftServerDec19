...
public class class_afj extends BiomeBase {
   private boolean aD;
   ...
   protected BiomeBase d(int var1) {
      BiomeBase var2 = (new class_afj(var1, true)).a(13828095, true).a(this.ah + " Spikes").c().a(0.0F, 0.5F).a(new BiomeBase.class_a_in_class_aez(this.an + 0.1F, this.ao + 0.1F));
