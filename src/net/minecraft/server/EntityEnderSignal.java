...
public class EntityEnderSignal extends Entity {
	...
	public EntityEnderSignal(class_ago var1) {
		super(var1);
		this.a(0.25F, 0.25F);
	}
	...
	public EntityEnderSignal(class_ago var1, double var2, double var4, double var6) {
		super(var1);
		d = 0;
		this.a(0.25F, 0.25F);
	...
	public void r_() {
		...
		if (!o.D) {
			...
			if ((d > 80) && !o.D) {
				L();
				if (e) {
					o.a((new EntityItem(o, s, t, u, new class_aco(Items.bM))));
				} else {
