...
public class class_anq extends Block {
	...
	public void a(class_ago var1, class_cj var2, class_agk var3) {
		if (!var1.D) {
			EntityTNTPrimed var4 = new EntityTNTPrimed(var1, var2.n() + 0.5F, var2.o(), var2.p() + 0.5F, var3.c());
	...
	public void a(class_ago var1, class_cj var2, class_apn var3, EntityLiving var4) {
		if (!var1.D) {
			if (((Boolean) var3.b(a)).booleanValue()) {
				EntityTNTPrimed var5 = new EntityTNTPrimed(var1, var2.n() + 0.5F, var2.o(), var2.p() + 0.5F, var4);
				var1.a(var5);
	...
	public void a(class_ago var1, class_cj var2, class_apn var3, Entity var4) {
		if (!var1.D && (var4 instanceof EntityArrow)) {
			...
			if (var5.ay()) {
				this.a(var1, var2, var1.p(var2).a(a, Boolean.valueOf(true)), var5.e instanceof EntityLiving ? (EntityLiving) var5.e : null);
				var1.g(var2);
			}
		}
	...
	public class_apn a(int var1) {
		return getBlockData().a(a, Boolean.valueOf((var1 & 1) > 0));
	}
