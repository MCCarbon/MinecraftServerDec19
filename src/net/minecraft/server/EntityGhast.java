...
public class EntityGhast extends class_re implements class_xx {
	private static final class_jz a;
	private int b = 1;

	public EntityGhast(class_ago var1) {
		super(var1);
		this.a(4.0F, 4.0F);
		ab = true;
		b_ = 5;
		f = new EntityGhast.class_b_in_class_xy(this);
		i.a(5, new EntityGhast.class_d_in_class_xy(this));
		i.a(7, new EntityGhast.class_a_in_class_xy(this));
		i.a(7, new EntityGhast.class_c_in_class_xy(this));
	...
	static {
		a = DataWatcher.claimId(EntityGhast.class, class_kb.g);
	}
	...
	static class class_c_in_class_xy extends class_sr {
		...
		public class_c_in_class_xy(EntityGhast var1) {
			b = var1;
		}
		...
		public void e() {
			...
			if ((var1.h(b) < (var2 * var2)) && b.t(var1)) {
				...
				if (a == 20) {
					...
					EntityLargeFireball var14 = new EntityLargeFireball(var4, b, var8, var10, var12);
					var14.a = b.cy();
	...
	static class class_a_in_class_xy extends class_sr {
		...
		public class_a_in_class_xy(EntityGhast var1) {
			a = var1;
			this.a(2);
		}
	...
	static class class_d_in_class_xy extends class_sr {
		...
		public class_d_in_class_xy(EntityGhast var1) {
			a = var1;
			this.a(1);
		}
	...
	static class class_b_in_class_xy extends class_se {
		...
		public class_b_in_class_xy(EntityGhast var1) {
			super(var1);
			g = var1;
		}
