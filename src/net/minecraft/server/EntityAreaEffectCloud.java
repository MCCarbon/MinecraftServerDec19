...
public class EntityAreaEffectCloud extends Entity {
	...
	public EntityAreaEffectCloud(class_ago var1) {
		super(var1);
		T = true;
		this.a(3.0F);
	}

	public EntityAreaEffectCloud(class_ago var1, double var2, double var4, double var6) {
		super(var1);
		T = true;
		this.a(3.0F);
		...
		if (o.D) {
			...
			if ((W % 5) == 0) {
				...
				if (e.isEmpty()) {
					...
					List var19 = o.a(EntityLiving.class, aX());
					if (!var19.isEmpty()) {
	...
	static {
		a = DataWatcher.claimId(EntityAreaEffectCloud.class, class_kb.c);
		b = DataWatcher.claimId(EntityAreaEffectCloud.class, class_kb.b);
		c = DataWatcher.claimId(EntityAreaEffectCloud.class, class_kb.g);
		d = DataWatcher.claimId(EntityAreaEffectCloud.class, class_kb.b);
	}
}
