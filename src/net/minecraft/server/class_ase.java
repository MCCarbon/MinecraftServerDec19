		...
		if (var3.o() < 1) {
			...
			for (int var5 = 0; var5 < 4; ++var5) {
				...
				if (var1.d(var6) && class_ago.a(var1, var6.b())) {
					var1.a(var6, class_aim.ae.S(), 2);
					class_aoi var7 = var1.s(var6);
