...
public class class_vl extends class_vc {
	...
	public class_vl(class_ago var1) {
		super(var1);
		this.a(0.9F, 1.3F);
		((class_ul) u()).a(true);
	...
	public class_vl b(class_qu var1) {
		class_vl var2 = (class_vl) var1;
		class_vl var3 = new class_vl(o);
	...
	private class_abt a(class_vc var1, class_vc var2) {
		int var3 = ((class_vl) var1).cE().b();
		int var4 = ((class_vl) var2).cE().b();
		bu.a(0).b(var3);
		bu.a(1).b(var4);
	...
	static {
		bt = class_kc.a(class_vl.class, class_kb.a);
