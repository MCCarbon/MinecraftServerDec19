         ...
         if(var1.d(var3)) {
            ...
            for(int var6 = 0; var6 < var5; ++var6) {
               ...
               if(Blocks.VINE.b(var1, var3, var7)) {
                  IBlockData var8 = Blocks.VINE.getBlockData().set(class_alu.b, Boolean.valueOf(var7 == class_cq.c)).set(class_alu.N, Boolean.valueOf(var7 == class_cq.f)).set(class_alu.O, Boolean.valueOf(var7 == class_cq.d)).set(class_alu.P, Boolean.valueOf(var7 == class_cq.e));
