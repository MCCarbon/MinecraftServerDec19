...
public class EntityEnderman extends EntityMonster {
   ...
   public EntityEnderman(World var1) {
      ...
      this.bn.a(3, new class_sz(this, EntityEndermite.class, 10, true, false, new Predicate() {
   ...
   static {
      ...
      bt = Datawathcer.claimId(EntityEnderman.class);
      bu = Datawathcer.claimId(EntityEnderman.class);
      bv = Datawathcer.claimId(EntityEnderman.class);
   }
