...
public class EntityEnderman extends EntityMonster {
	...
	public EntityEnderman(class_ago var1) {
		super(var1);
		this.a(0.6F, 2.9F);
		S = 1.0F;
		((class_ul) u()).a(true);
		...
		i.a(10, new EntityEnderman.class_a_in_class_xv(this));
		i.a(11, new EntityEnderman.class_c_in_class_xv(this));
		bo.a(1, new class_uc(this, false, new Class[0]));
		bo.a(2, new EntityEnderman.class_b_in_class_xv(this));
		bo.a(3, new class_uf(this, EntityEndermite.class, 10, true, false, new Predicate() {
	...
	static {
		...
		bu = DataWatcher.claimId(EntityEnderman.class, class_kb.b);
		bv = DataWatcher.claimId(EntityEnderman.class, class_kb.b);
		bw = DataWatcher.claimId(EntityEnderman.class, class_kb.g);
	}

	static class class_c_in_class_xv extends class_sr {
		private EntityEnderman a;

		public class_c_in_class_xv(EntityEnderman var1) {
			a = var1;
		}
	...
	static class class_a_in_class_xv extends class_sr {
		...
		public class_a_in_class_xv(EntityEnderman var1) {
			a = var1;
		}
	...
	static class class_b_in_class_xv extends class_uf {
		...
		public class_b_in_class_xv(EntityEnderman var1) {
