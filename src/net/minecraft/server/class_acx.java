...
public class class_acx {
   public void a(class_act var1) {
      ...
      var1.a(new ItemStack(Blocks.ENDER_CHEST), new Object[]{"###", "#E#", "###", Character.valueOf('#'), Blocks.OBSIDIAN, Character.valueOf('E'), Items.bK});
      ...
      var1.a(new ItemStack(Blocks.SANDSTONE), new Object[]{"##", "##", Character.valueOf('#'), new ItemStack(Blocks.SAND, 1, class_akq.class_a_in_class_akq.a.a())});
      var1.a(new ItemStack(Blocks.RED_SANDSTONE), new Object[]{"##", "##", Character.valueOf('#'), new ItemStack(Blocks.SAND, 1, class_akq.class_a_in_class_akq.b.a())});
      var1.a(new ItemStack(Blocks.SANDSTONE, 4, class_akr.class_a_in_class_akr.c.a()), new Object[]{"##", "##", Character.valueOf('#'), new ItemStack(Blocks.SANDSTONE, 1, class_akr.class_a_in_class_akr.a.a())});
      ...
      var1.a(new ItemStack(Blocks.SANDSTONE, 1, class_akr.class_a_in_class_akr.b.a()), new Object[]{"#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, class_alk.class_a_in_class_alk.b.a())});
      ...
      var1.a(new ItemStack(Blocks.QUARTZ_BLOCK, 1, class_akf.class_a_in_class_akf.b.a()), new Object[]{"#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, class_alk.class_a_in_class_alk.h.a())});
      ...
      var1.a(new ItemStack(Blocks.STONEBRICK, 1, class_ali.P), new Object[]{"#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, class_alk.class_a_in_class_alk.f.a())});
      ...
      var1.a(new ItemStack(Blocks.IRON_BARS, 16), new Object[]{"###", "###", Character.valueOf('#'), Items.l});
      var1.a(new ItemStack(Blocks.GLASS_PANE, 16), new Object[]{"###", "###", Character.valueOf('#'), Blocks.GLASS});
      var1.a(new ItemStack(Blocks.REDSTONE_LAMP, 1), new Object[]{" R ", "RGR", " R ", Character.valueOf('R'), Items.aE, Character.valueOf('G'), Blocks.GLOWSTONE});
      var1.a(new ItemStack(Blocks.BEACON, 1), new Object[]{"GGG", "GSG", "OOO", Character.valueOf('G'), Blocks.GLASS, Character.valueOf('S'), Items.cc, Character.valueOf('O'), Blocks.OBSIDIAN});
      var1.a(new ItemStack(Blocks.NETHER_BRICK, 1), new Object[]{"NN", "NN", Character.valueOf('N'), Items.ci});
      var1.a(new ItemStack(Blocks.STONE, 2, BlockStone.EnumStoneVariant.DIORITE.getData()), new Object[]{"CQ", "QC", Character.valueOf('C'), Blocks.COBBLESTONE, Character.valueOf('Q'), Items.cj});
      var1.b(new ItemStack(Blocks.STONE, 1, BlockStone.EnumStoneVariant.GRANITE.getData()), new Object[]{new ItemStack(Blocks.STONE, 1, BlockStone.EnumStoneVariant.DIORITE.getData()), Items.cj});
      ...
      var1.a(new ItemStack(Blocks.DIRT, 4, class_ahj.class_a_in_class_ahj.b.a()), new Object[]{"DG", "GD", Character.valueOf('D'), new ItemStack(Blocks.DIRT, 1, class_ahj.class_a_in_class_ahj.a.a()), Character.valueOf('G'), Blocks.GRAVEL});
      ...
      var1.a(new ItemStack(Blocks.PRISMARINE, 1, class_akc.b), new Object[]{"SS", "SS", Character.valueOf('S'), Items.cF});
      var1.a(new ItemStack(Blocks.PRISMARINE, 1, class_akc.N), new Object[]{"SSS", "SSS", "SSS", Character.valueOf('S'), Items.cF});
      var1.a(new ItemStack(Blocks.PRISMARINE, 1, class_akc.O), new Object[]{"SSS", "SIS", "SSS", Character.valueOf('S'), Items.cF, Character.valueOf('I'), new ItemStack(Items.aY, 1, class_zy.p.b())});
      var1.a(new ItemStack(Blocks.SEA_LANTERN, 1, 0), new Object[]{"SCS", "CCC", "SCS", Character.valueOf('S'), Items.cF, Character.valueOf('C'), Items.cG});
      var1.a(new ItemStack(Blocks.PURPUR_BLOCK, 4, 0), new Object[]{"FF", "FF", Character.valueOf('F'), Items.cJ});
