...
public class class_acx {
   public void a(class_act var1) {
      ...
      var1.a(new ItemStack(Blocks.PRISMARINE, 1, class_akc.O), new Object[]{"SSS", "SIS", "SSS", Character.valueOf('S'), Items.cF, Character.valueOf('I'), new ItemStack(Items.aY, 1, EnumColor.p.b())});
