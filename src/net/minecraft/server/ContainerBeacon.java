...
public class ContainerBeacon extends Container {
   ...
   public ContainerBeacon(IInventory var1, IInventory var2) {
      this.a = var2;
      this.a((Slot)(this.f = new ContainerBeacon.SlotBeacon(var2, 0, 136, 110)));
      byte var3 = 36;
      short var4 = 137;
      ...
      for(var5 = 0; var5 < 3; ++var5) {
         for(int var6 = 0; var6 < 9; ++var6) {
            this.a((Slot)(new Slot(var1, var6 + var5 * 9 + 9, var3 + var6 * 18, var4 + var5 * 18)));
         }
      }

      for(var5 = 0; var5 < 9; ++var5) {
         this.a((Slot)(new Slot(var1, var5, var3 + var5 * 18, 58 + var4)));
      }
