...
public class class_apj extends class_aif {
	public static final class_apz a;
	public static final class_aqa b;

	public class_apj() {
		super(class_avq.H);
		this.j(M.b().a(a, class_cq.c).a(b, class_aph.class_a_in_class_aph.a));
		this.c(-1.0F);
	}
	...
	public void e(class_ago var1, class_cj var2, class_apn var3) {
		...
		if ((var5.c() instanceof class_apg) && ((Boolean) var5.b(class_apg.a)).booleanValue()) {
			var1.g(var4);
		}
	...
	public class_apn a(int var1) {
		return S().a(a, class_aph.b(var1)).a(b, (var1 & 8) > 0 ? class_aph.class_a_in_class_aph.b : class_aph.class_a_in_class_aph.a);
	}
	...
	public int c(class_apn var1) {
		...
		if (var1.b(b) == class_aph.class_a_in_class_aph.b) {
			var3 |= 8;
		}
