...
public class class_ly {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  ...
                  if(var2x == null) {
                     class_ly.e.warn("Could not convert user banlist entry for " + var1x.getName());
                     throw new class_ly.class_a_in_class_ly("Profile not in the conversionlist", null);
                  } else {
                     Date var3 = var2x.length > 1?class_ly.b(var2x[1], (Date)null):null;
                     String var4 = var2x.length > 2?var2x[2]:null;
                     Date var5 = var2x.length > 3?class_ly.b(var2x[3], (Date)null):null;
                     String var6 = var2x.length > 4?var2x[4]:null;
                     var1.a((class_mc)(new class_mf(var1x, var3, var4, var5, var6)));
                  }
               }

               public void onProfileLookupFailed(GameProfile var1x, Exception var2x) {
                  class_ly.e.warn((String)("Could not lookup user banlist entry for " + var1x.getName()), (Throwable)var2x);
                  if(!(var2x instanceof ProfileNotFoundException)) {
                     throw new class_ly.class_a_in_class_ly("Could not request user " + var1x.getName() + " from backend systems", var2x, null);
                  }
               }
            };
            ...
            return false;
         } catch (class_ly.class_a_in_class_ly var5) {
      ...
      if(a.exists() && a.isFile()) {
         ...
         try {
            ...
            while(var3.hasNext()) {
               ...
               var1.a((class_mc)(new class_lx(var4, var6, var7, var8, var9)));
            }
      ...
      if(c.exists() && c.isFile()) {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  var0.aF().a(var1x);
                  var1.a((class_mc)(new class_mb(var1x, var0.p(), false)));
               }

               public void onProfileLookupFailed(GameProfile var1x, Exception var2) {
                  class_ly.e.warn((String)("Could not lookup oplist entry for " + var1x.getName()), (Throwable)var2);
                  if(!(var2 instanceof ProfileNotFoundException)) {
                     throw new class_ly.class_a_in_class_ly("Could not request user " + var1x.getName() + " from backend systems", var2, null);
                  }
               }
            };
            a(var0, var2, var3);
      ...
      if(d.exists() && d.isFile()) {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  var0.aF().a(var1x);
                  var1.a((class_mc)(new class_mh(var1x)));
               }

               public void onProfileLookupFailed(GameProfile var1x, Exception var2) {
                  class_ly.e.warn((String)("Could not lookup user whitelist entry for " + var1x.getName()), (Throwable)var2);
                  if(!(var2 instanceof ProfileNotFoundException)) {
                     throw new class_ly.class_a_in_class_ly("Could not request user " + var1x.getName() + " from backend systems", var2, null);
                  }
               }
   ...
   public static boolean a(final class_kp var0, class_km var1) {
         ...
         try {
            ...
            ProfileLookupCallback var15 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1) {
                  ...
                  if(var2x == null) {
                     throw new class_ly.class_a_in_class_ly("Missing UUID for user profile " + var1.getName(), null);
                  } else {
               ...
               public void onProfileLookupFailed(GameProfile var1, Exception var2x) {
                  class_ly.e.warn((String)("Could not lookup user uuid for " + var1.getName()), (Throwable)var2x);
                  if(var2x instanceof ProfileNotFoundException) {
                     String var3x = this.a(var1);
                     this.a(var4, var3x, var3x);
                  } else {
                     throw new class_ly.class_a_in_class_ly("Could not request user " + var1.getName() + " from backend systems", var2x, null);
                  }
               }
               ...
               private void a(File var1, String var2x, String var3x) {
                  ...
                  if(!var4x.renameTo(var5)) {
                     throw new class_ly.class_a_in_class_ly("Could not convert file for " + var2x, null);
                  }
               }
               ...
               private String a(GameProfile var1) {
                  ...
                  if(var2x == null) {
                     throw new class_ly.class_a_in_class_ly("Could not find the filename for " + var1.getName() + " anymore", null);
                  } else {
                     return var2x;
                  }
               }
            ...
            return true;
         } catch (class_ly.class_a_in_class_ly var13) {
   ...
   public static boolean a(class_km var0) {
      boolean var1 = b(var0);
      var1 = var1 && c(var0);
      return var1;
   }

   private static boolean b(class_km var0) {
      boolean var1 = false;
      if(b.exists() && b.isFile()) {
         var1 = true;
      }
   ...
   private static boolean c(class_km var0) {
      File var1 = d(var0);
   ...
   private static File d(class_km var0) {
