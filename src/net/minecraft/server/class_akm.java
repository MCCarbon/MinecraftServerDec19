...
public class class_akm extends class_alp {
   ...
   public void b(class_aen var1, class_cj var2, class_anl var3, Random var4) {
      ...
      if(this.N) {
         if(var5) {
            var1.a((class_cj)var2, (class_anl)class_agk.aE.S().a(a, var3.b(a)), 3);
            if(this.a(var1, var2, true)) {
               ...
               var1.a((class_cj)var2, (class_agj)var1.p(var2).c(), 160);
            }
         }
      } else if(!var5 && !this.a(var1, var2, false)) {
         var1.a((class_cj)var2, (class_anl)class_agk.aF.S().a(a, var3.b(a)), 3);
      }
