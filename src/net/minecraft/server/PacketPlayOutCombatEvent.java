...
public class PacketPlayOutCombatEvent implements Packet {
   ...
   public void decode(PacketDataSerializer var1) throws IOException {
      this.a = (PacketPlayOutCombatEvent.class_a_in_class_gy)var1.readEnum(PacketPlayOutCombatEvent.class_a_in_class_gy.class);
      if(this.a == PacketPlayOutCombatEvent.class_a_in_class_gy.b) {
         this.d = var1.readVarInt();
         this.c = var1.readInt();
      } else if(this.a == PacketPlayOutCombatEvent.class_a_in_class_gy.c) {
   ...
   static class SyntheticClass_1 {
      // $FF: synthetic field
      static final int[] a = new int[PacketPlayOutCombatEvent.class_a_in_class_gy.values().length];

      static {
         try {
            a[PacketPlayOutCombatEvent.class_a_in_class_gy.b.ordinal()] = 1;
         } catch (NoSuchFieldError var2) {
            ;
         }

         try {
            a[PacketPlayOutCombatEvent.class_a_in_class_gy.c.ordinal()] = 2;
