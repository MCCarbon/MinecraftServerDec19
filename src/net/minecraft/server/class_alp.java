...
public class class_alp extends Block {
   ...
   protected class_alp() {
      super(Material.q);
      this.setBlockData(this.blockStateList.getFirst().set(a, class_cq.b));
   ...
   private boolean e(World var1, class_cj var2) {
      if(World.a((class_aer)var1, (class_cj)var2)) {
         return true;
      } else {
   ...
   protected boolean f(World var1, class_cj var2, IBlockData var3) {
