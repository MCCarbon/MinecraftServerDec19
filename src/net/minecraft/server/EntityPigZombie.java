...
public class EntityPigZombie extends EntityZombie {
	...
	public EntityPigZombie(class_ago var1) {
		super(var1);
		ab = true;
	}
	...
	@Override
	protected void n() {
		bo.a(1, new EntityPigZombie.class_b_in_class_yd(this));
		bo.a(2, new EntityPigZombie.class_a_in_class_yd(this));
	}
	...
	static class class_a_in_class_yd extends class_uf {
		public class_a_in_class_yd(EntityPigZombie var1) {
			super(var1, class_yu.class, true);
		}

		@Override
		public boolean a() {
			return ((EntityPigZombie) e).cF() && super.a();
		}
	}

	static class class_b_in_class_yd extends class_uc {
		public class_b_in_class_yd(EntityPigZombie var1) {
