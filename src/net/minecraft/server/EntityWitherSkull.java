...
public class EntityWitherSkull extends class_za {
	private static final class_jz a;

	public EntityWitherSkull(class_ago var1) {
		super(var1);
		this.a(0.3125F, 0.3125F);
	}

	public EntityWitherSkull(class_ago var1, EntityLiving var2, double var3, double var5, double var7) {
		...
		if (!o.D) {
			if (var1.d != null) {
				...
				if (var1.d instanceof EntityLiving) {
					...
					if (var2 > 0) {
						((EntityLiving) var1.d).c(new class_qr(class_qs.t, 20 * var2, 1));
					}
				}
			}
	...
	static {
		a = DataWatcher.claimId(EntityWitherSkull.class, class_kb.g);
	}
}
