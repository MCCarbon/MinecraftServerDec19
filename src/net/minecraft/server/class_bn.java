		...
		if (var2.length < 1) {
			...
			if ((var2.length != 1) && (var2.length != 2)) {
				if (var2.length < (var3 + 3)) {
					...
					class_i.class_a_in_class_i var9 = a(((Entity) var4).y, var2.length > var14 ? var2[var14++] : "~", false);
					class_i.class_a_in_class_i var10 = a(((Entity) var4).z, var2.length > var14 ? var2[var14] : "~", false);
					float var12;
					...
					a(var1, this, "commands.tp.success.coordinates", new Object[] { ((Entity) var4).e_(), Double.valueOf(var6.a()), Double.valueOf(var7.a()), Double.valueOf(var8.a()) });
				}
			} else {
				...
				if (var5.o != ((Entity) var4).o) {
					...
					a(var1, this, "commands.tp.success", new Object[] { ((Entity) var4).e_(), var5.e_() });
				}
			}
		}
	}
