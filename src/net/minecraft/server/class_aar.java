...
public class class_aar {
   ...
   public static int b(class_aar var0) {
      return var0 == null?0:e.getId(var0);
   }

   public static class_aar c(int var0) {
      return (class_aar)e.get(var0);
   }

   public static class_aar a(Block var0) {
      return (class_aar)a.get(var0);
   }

   public static class_aar d(String var0) {
      class_aar var1 = (class_aar)e.get(new MinecraftKey(var0));
      if(var1 == null) {
         try {
   ...
   public class_aar a(CreativeTab var1) {
      this.l = var1;
      return this;
   }
   ...
   public static void t() {
      a((Block)class_agk.b, (class_aar)(new class_aba(class_agk.b, class_agk.b, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.c, (class_aar)(new class_abx(class_agk.c, false)));
      a((Block)class_agk.d, (class_aar)(new class_aba(class_agk.d, class_agk.d, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.e);
      a((Block)class_agk.f, (class_aar)(new class_aba(class_agk.f, class_agk.f, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.g, (class_aar)(new class_aba(class_agk.g, class_agk.g, new Function() {
         public String a(class_aas var1) {
            return class_ajw.class_a_in_class_ajw.a(var1.i()).d();
         }
      ...
      c(class_agk.h);
      a((Block)class_agk.m, (class_aar)(new class_aba(class_agk.m, class_agk.m, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.p);
      c(class_agk.q);
      a((Block)class_agk.r, (class_aar)(new class_aba(class_agk.r, class_agk.r, new Function() {
         public String a(class_aas var1) {
            return class_ajw.class_a_in_class_ajw.a(var1.i()).d();
         }
      ...
      a((Block)class_agk.s, (class_aar)(new class_aba(class_agk.s, class_agk.s, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.t, (class_aar)(new class_aaw(class_agk.t)).b("leaves"));
      a((Block)class_agk.u, (class_aar)(new class_aaw(class_agk.u)).b("leaves"));
      a((Block)class_agk.v, (class_aar)(new class_aba(class_agk.v, class_agk.v, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.y);
      c(class_agk.z);
      a((Block)class_agk.A, (class_aar)(new class_aba(class_agk.A, class_agk.A, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.D);
      c(class_agk.E);
      a((Block)class_agk.F, (class_aar)(new class_abd(class_agk.F)));
      c(class_agk.G);
      a((Block)class_agk.H, (class_aar)(new class_abx(class_agk.H, true)).a(new String[]{"shrub", "grass", "fern"}));
      c((Block)class_agk.I);
      a((Block)class_agk.J, (class_aar)(new class_abd(class_agk.J)));
      a((Block)class_agk.L, (class_aar)(new class_aaa(class_agk.L)).b("cloth"));
      a((Block)class_agk.N, (class_aar)(new class_aba(class_agk.N, class_agk.N, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.O, (class_aar)(new class_aba(class_agk.O, class_agk.O, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.R);
      c(class_agk.S);
      a((Block)class_agk.U, (class_aar)(new class_abq(class_agk.U, class_agk.U, class_agk.T)).b("stoneSlab"));
      c(class_agk.V);
      c(class_agk.W);
      c(class_agk.X);
      c(class_agk.Y);
      ...
      c(class_agk.cU);
      c(class_agk.cV);
      a((Block)class_agk.cX, (class_aar)(new class_abq(class_agk.cX, class_agk.cX, class_agk.cW)).b("purpurSlab"));
      c(class_agk.ac);
      c(class_agk.ad);
      c((Block)class_agk.ae);
      c(class_agk.ag);
      c(class_agk.ah);
      c(class_agk.ai);
      c(class_agk.ak);
      ...
      c(class_agk.aF);
      c(class_agk.aG);
      a((Block)class_agk.aH, (class_aar)(new class_abr(class_agk.aH)));
      c(class_agk.aI);
      c(class_agk.aJ);
      c((Block)class_agk.aK);
      c(class_agk.aL);
      c(class_agk.aN);
      c(class_agk.aO);
      c(class_agk.aP);
      ...
      c(class_agk.aZ);
      c(class_agk.bd);
      a((Block)class_agk.be, (class_aar)(new class_aba(class_agk.be, class_agk.be, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.bf, (class_aar)(new class_aba(class_agk.bf, class_agk.bf, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.bj);
      c(class_agk.bk);
      a((Block)class_agk.bn, (class_aar)(new class_abx(class_agk.bn, false)));
      c(class_agk.bo);
      c(class_agk.bp);
      c(class_agk.bq);
      c(class_agk.br);
      ...
      c(class_agk.bu);
      c(class_agk.bv);
      c((Block)class_agk.bw);
      a((Block)class_agk.bx, (class_aar)(new class_aca(class_agk.bx)));
      c(class_agk.by);
      c(class_agk.bz);
      c(class_agk.bA);
      c(class_agk.bC);
      ...
      c(class_agk.bI);
      c(class_agk.bJ);
      a((Block)class_agk.bM, (class_aar)(new class_abq(class_agk.bM, class_agk.bM, class_agk.bL)).b("woodSlab"));
      c(class_agk.bO);
      c(class_agk.bP);
      c(class_agk.bQ);
      c((Block)class_agk.bR);
      c(class_agk.bT);
      c(class_agk.bU);
      c(class_agk.bV);
      c(class_agk.bW);
      c(class_agk.bX);
      c((Block)class_agk.bY);
      a((Block)class_agk.bZ, (class_aar)(new class_aba(class_agk.bZ, class_agk.bZ, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.cd);
      a((Block)class_agk.cf, (class_aar)(new class_yz(class_agk.cf)).b("anvil"));
      c(class_agk.cg);
      c(class_agk.ch);
      c(class_agk.ci);
      c((Block)class_agk.cl);
      c(class_agk.cn);
      c(class_agk.co);
      c((Block)class_agk.cp);
      a((Block)class_agk.cq, (class_aar)(new class_aba(class_agk.cq, class_agk.cq, new String[]{"default", "chiseled", "lines"})).b("quartzBlock"));
      c(class_agk.cr);
      c(class_agk.cs);
      c(class_agk.ct);
      a((Block)class_agk.cu, (class_aar)(new class_aaa(class_agk.cu)).b("clayHardenedStained"));
      c(class_agk.cv);
      c(class_agk.cw);
      c(class_agk.cx);
      a((Block)class_agk.cy, (class_aar)(new class_aaa(class_agk.cy)).b("woolCarpet"));
      c(class_agk.cz);
      c(class_agk.cA);
      c(class_agk.cB);
      c(class_agk.cC);
      ...
      c(class_agk.cE);
      c(class_agk.da);
      a((Block)class_agk.cF, (class_aar)(new class_zx(class_agk.cF, class_agk.cF, new Function() {
         public String a(class_aas var1) {
      ...
      a((Block)class_agk.cG, (class_aar)(new class_aaa(class_agk.cG)).b("stainedGlass"));
      a((Block)class_agk.cH, (class_aar)(new class_aaa(class_agk.cH)).b("stainedGlassPane"));
      a((Block)class_agk.cI, (class_aar)(new class_aba(class_agk.cI, class_agk.cI, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.cJ);
      a((Block)class_agk.cM, (class_aar)(new class_aba(class_agk.cM, class_agk.cM, new Function() {
         public String a(class_aas var1) {
      ...
      c(class_agk.cN);
      a((Block)class_agk.cP, (class_aar)(new class_abq(class_agk.cP, class_agk.cP, class_agk.cO)).b("stoneSlab2"));
      ...
      a(264, (String)"diamond", (new class_aar()).c("diamond").a(CreativeTab.l));
      a(265, (String)"iron_ingot", (new class_aar()).c("ingotIron").a(CreativeTab.l));
      a(266, (String)"gold_ingot", (new class_aar()).c("ingotGold").a(CreativeTab.l));
      ...
      a(280, (String)"stick", (new class_aar()).n().c("stick").a(CreativeTab.l));
      a(281, (String)"bowl", (new class_aar()).c("bowl").a(CreativeTab.l));
      ...
      a(287, (String)"string", (new class_zh(class_agk.bS)).c("string").a(CreativeTab.l));
      a(288, (String)"feather", (new class_aar()).c("feather").a(CreativeTab.l));
      a(289, (String)"gunpowder", (new class_aar()).c("sulphur").a(CreativeTab.l));
      ...
      a(296, (String)"wheat", (new class_aar()).c("wheat").a(CreativeTab.l));
      ...
      a(318, (String)"flint", (new class_aar()).c("flint").a(CreativeTab.l));
      ...
      a(334, (String)"leather", (new class_aar()).c("leather").a(CreativeTab.l));
      a(335, (String)"milk_bucket", (new class_aay()).c("milk").c(var0));
      a(336, (String)"brick", (new class_aar()).c("brick").a(CreativeTab.l));
      a(337, (String)"clay_ball", (new class_aar()).c("clay").a(CreativeTab.l));
      a(338, (String)"reeds", (new class_zh(class_agk.aM)).c("reeds").a(CreativeTab.l));
      a(339, (String)"paper", (new class_aar()).c("paper").a(CreativeTab.f));
      a(340, (String)"book", (new class_zj()).c("book").a(CreativeTab.f));
      a(341, (String)"slime_ball", (new class_aar()).c("slimeball").a(CreativeTab.f));
      ...
      a(345, (String)"compass", (new class_zs()).c("compass").a(CreativeTab.i));
      a(346, (String)"fishing_rod", (new class_aal()).c("fishingRod"));
      a(347, (String)"clock", (new class_zq()).c("clock").a(CreativeTab.i));
      a(348, (String)"glowstone_dust", (new class_aar()).c("yellowDust").a(CreativeTab.l));
      ...
      a(352, (String)"bone", (new class_aar()).c("bone").n().a(CreativeTab.f));
      a(353, (String)"sugar", (new class_aar()).c("sugar").a(CreativeTab.l));
      a(354, (String)"cake", (new class_zh(class_agk.ba)).d(1).c("cake").a(CreativeTab.h));
      a(355, (String)"bed", (new class_zf()).d(1).c("bed"));
      a(356, (String)"repeater", (new class_zh(class_agk.bb)).c("diode").a(CreativeTab.d));
      ...
      a(369, (String)"blaze_rod", (new class_aar()).c("blazeRod").a(CreativeTab.l).n());
      a(370, (String)"ghast_tear", (new class_aar()).c("ghastTear").a(CreativeTab.k));
      a(371, (String)"gold_nugget", (new class_aar()).c("goldNugget").a(CreativeTab.l));
      ...
      a(376, (String)"fermented_spider_eye", (new class_aar()).c("fermentedSpiderEye").a(CreativeTab.k));
      a(377, (String)"blaze_powder", (new class_aar()).c("blazePowder").a(CreativeTab.k));
      a(378, (String)"magma_cream", (new class_aar()).c("magmaCream").a(CreativeTab.k));
      a(379, (String)"brewing_stand", (new class_zh(class_agk.bD)).c("brewingStand").a(CreativeTab.k));
      a(380, (String)"cauldron", (new class_zh(class_agk.bE)).c("cauldron").a(CreativeTab.k));
      a(381, (String)"ender_eye", (new class_aae()).c("eyeOfEnder"));
      a(382, (String)"speckled_melon", (new class_aar()).c("speckledMelon").a(CreativeTab.k));
      ...
      a(386, (String)"writable_book", (new class_acb()).c("writingBook").a(CreativeTab.f));
      a(387, (String)"written_book", (new class_acc()).c("writtenBook").d(16));
      a(388, (String)"emerald", (new class_aar()).c("emerald").a(CreativeTab.l));
      a(389, (String)"item_frame", (new class_aap(class_va.class)).c("frame"));
      a(390, (String)"flower_pot", (new class_zh(class_agk.ca)).c("flowerPot").a(CreativeTab.c));
      ...
      a(396, (String)"golden_carrot", (new class_aan(6, 1.2F, false)).c("carrotGolden").a(CreativeTab.k));
      a(397, (String)"skull", (new class_abp()).c("skull"));
      a(398, (String)"carrot_on_a_stick", (new class_zo()).c("carrotOnAStick"));
      a(399, (String)"nether_star", (new class_abo()).c("netherStar").a(CreativeTab.l));
      a(400, (String)"pumpkin_pie", (new class_aan(8, 0.3F, false)).c("pumpkinPie").a(CreativeTab.h));
      a(401, (String)"fireworks", (new class_aaj()).c("fireworks"));
      a(402, (String)"firework_charge", (new class_aai()).c("fireworksCharge").a(CreativeTab.f));
      a(403, (String)"enchanted_book", (new class_aad()).d(1).c("enchantedBook"));
      a(404, (String)"comparator", (new class_zh(class_agk.cj)).c("comparator").a(CreativeTab.d));
      a(405, (String)"netherbrick", (new class_aar()).c("netherbrick").a(CreativeTab.l));
      a(406, (String)"quartz", (new class_aar()).c("netherquartz").a(CreativeTab.l));
      ...
      a(409, (String)"prismarine_shard", (new class_aar()).c("prismarineShard").a(CreativeTab.l));
      a(410, (String)"prismarine_crystals", (new class_aar()).c("prismarineCrystals").a(CreativeTab.l));
      ...
      a(414, (String)"rabbit_foot", (new class_aar()).c("rabbitFoot").a(CreativeTab.k));
      a(415, (String)"rabbit_hide", (new class_aar()).c("rabbitHide").a(CreativeTab.l));
      a(416, (String)"armor_stand", (new class_zb()).c("armorStand").d(16));
      a(417, (String)"iron_horse_armor", (new class_aar()).c("horsearmormetal").d(1).a(CreativeTab.f));
      a(418, (String)"golden_horse_armor", (new class_aar()).c("horsearmorgold").d(1).a(CreativeTab.f));
      a(419, (String)"diamond_horse_armor", (new class_aar()).c("horsearmordiamond").d(1).a(CreativeTab.f));
      a(420, (String)"lead", (new class_aav()).c("leash"));
      a(421, (String)"name_tag", (new class_abb()).c("nameTag"));
      a(422, (String)"command_block_minecart", (new class_aaz(class_vn.class_a_in_class_vn.g)).c("minecartCommandBlock").a((CreativeTab)null));
      ...
      a(432, (String)"chorus_fruit", (new class_zp(4, 0.3F)).h().c("chorusFruit").a(CreativeTab.l));
      a(433, (String)"chorus_fruit_popped", (new class_aar()).c("chorusFruitPopped").a(CreativeTab.l));
   ...
   private static void c(Block var0) {
      a((Block)var0, (class_aar)(new class_zg(var0)));
   }

   protected static void a(Block var0, class_aar var1) {
   ...
   private static void a(int var0, MinecraftKey var1, class_aar var2) {
      e.register(var0, var1, var2);
   }
