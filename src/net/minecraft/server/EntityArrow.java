...
public class EntityArrow extends Entity implements class_zd {
	...
	public EntityArrow(class_ago var1) {
		super(var1);
		h = -1;
		i = -1;
		as = -1;
	...
	public EntityArrow(class_ago var1, double var2, double var4, double var6) {
		this(var1);
		this.b(var2, var4, var6);
	}

	public EntityArrow(class_ago var1, EntityLiving var2) {
	...
	protected void a(class_ayl var1) {
		...
		if (var2 != null) {
			...
			if (ay() && !(var2 instanceof EntityEnderman)) {
				var2.e(5);
			}
			...
			if (var2.a(var5, var4)) {
				if (var2 instanceof EntityLiving) {
					...
					if (e instanceof EntityLiving) {
						class_afl.a(var6, e);
						class_afl.b(((EntityLiving) e), var6);
					}
	...
	static {
		...
		g = DataWatcher.claimId(EntityArrow.class, class_kb.a);
	}
}
