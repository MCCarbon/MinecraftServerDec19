...
public class class_arl extends class_apw {
   ...
   public boolean b(class_aen var1, Random var2, class_cj var3) {
      int var4;
      for(var4 = var2.nextInt(4) + 5; var1.p(var3.b()).c().v() == class_atk.h; var3 = var3.b()) {
         ;
      }
         ...
         if(!var5) {
            ...
            if((var17 == class_agk.c || var17 == class_agk.d) && var3.o() < 256 - var4 - 1) {
               ...
               for(var18 = 0; var18 < var4; ++var18) {
                  class_agj var20 = var1.p(var3.b(var18)).c();
               ...
               for(var18 = var3.o() - 3 + var4; var18 <= var3.o() + var4; ++var18) {
                  ...
                  for(var21 = var3.n() - var9; var21 <= var3.n() + var9; ++var21) {
                     for(var12 = var3.p() - var9; var12 <= var3.p() + var9; ++var12) {
                        ...
                        if(var1.p(var22).c().v() == class_atk.j) {
                           class_cj var23 = var22.e();
                           var14 = var22.f();
                           class_cj var15 = var22.c();
                           class_cj var16 = var22.d();
                           if(var2.nextInt(4) == 0 && var1.p(var23).c().v() == class_atk.a) {
                              this.a(var1, var23, class_alu.N);
                           }

                           if(var2.nextInt(4) == 0 && var1.p(var14).c().v() == class_atk.a) {
                              this.a(var1, var14, class_alu.P);
                           }

                           if(var2.nextInt(4) == 0 && var1.p(var15).c().v() == class_atk.a) {
   ...
   private void a(class_aen var1, class_cj var2, class_anw var3) {
      class_anl var4 = class_agk.bn.S().a(var3, Boolean.valueOf(true));
      this.a(var1, var2, var4);
      int var5 = 4;

      for(var2 = var2.b(); var1.p(var2).c().v() == class_atk.a && var5 > 0; --var5) {
         this.a(var1, var2, var4);
         var2 = var2.b();
      }
   ...
   static {
      ...
      b = class_agk.t.S().a(class_ajs.Q, class_ajw.class_a_in_class_ajw.a).a(class_ajs.b, Boolean.valueOf(false));
   }
}
