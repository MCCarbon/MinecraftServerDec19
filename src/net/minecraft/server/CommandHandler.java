...
public class CommandHandler implements class_l {
	...
	public int a(ICommandListener var1, String var2) {
		...
		String var4 = var3[0];
		var3 = a(var3);
		ICommand var5 = (ICommand) b.get(var4);
	...
	public List a(ICommandListener var1, String var2, class_cj var3) {
		...
		if (var4.length == 1) {
			...
			if (var4.length > 1) {
				ICommand var6 = (ICommand) b.get(var5);
