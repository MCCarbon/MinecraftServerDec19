...
public class class_ard extends class_aql {
   public boolean b(class_aen var1, Random var2, class_cj var3) {
      for(int var4 = 0; var4 < 64; ++var4) {
         ...
         if(var1.d(var5) && var1.p(var5.b()).getBlock() == class_agk.c && class_agk.aU.d(var1, var5)) {
            var1.a((class_cj)var5, (IBlockData)class_agk.aU.S().set(class_akd.O, class_cq.class_c_in_class_cq.a.a(var2)), 2);
         }
      }
