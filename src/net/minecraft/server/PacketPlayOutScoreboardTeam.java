...
public class PacketPlayOutScoreboardTeam implements Packet {
   ...
   public PacketPlayOutScoreboardTeam() {
      this.e = class_awp.class_a_in_class_awp.a.e;
      this.f = -1;
      this.g = Lists.newArrayList();
   }

   public PacketPlayOutScoreboardTeam(class_awk var1, int var2) {
      this.e = class_awp.class_a_in_class_awp.a.e;
      this.f = -1;
      this.g = Lists.newArrayList();
      this.a = var1.b();
   ...
   public PacketPlayOutScoreboardTeam(class_awk var1, Collection var2, int var3) {
      this.e = class_awp.class_a_in_class_awp.a.e;
      this.f = -1;
      this.g = Lists.newArrayList();
      if(var3 != 3 && var3 != 4) {
