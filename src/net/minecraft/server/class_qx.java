...
public abstract class class_qx implements class_m {
	...
	public class_qx(class_ago var1) {
		c = b++;
		j = 1.0D;
		f = a;
		J = 0.6F;
	...
	public boolean equals(Object var1) {
		return var1 instanceof class_qx ? ((class_qx) var1).c == c : false;
	}
	...
	public void d(double var1, double var3, double var5) {
		if (T) {
			...
			class_ail var60 = o.p(var26).c();
			if (var60.v() == class_avq.a) {
				class_ail var28 = o.p(var26.b()).c();
	...
	protected void ac() {
		...
		if (var6.b() != -1) {
			o.a(class_cy.L, s + ((V.nextFloat() - 0.5D) * J), aX().b + 0.1D, u + ((V.nextFloat() - 0.5D) * J), -v * 4.0D, 1.5D, -x * 4.0D, new int[] { class_ail.f(var5) });
		}
	...
	public class_xg a(class_acm var1, int var2) {
		return this.a(var1, var2, 0.0F);
	}

	public class_xg a(class_acm var1, int var2, float var3) {
	...
	public void a(class_qx var1) {
		...
		if (var1 == null) {
			...
			if (var1 != null) {
				for (class_qx var2 = var1.m; var2 != null; var2 = var2.m) {
					if (var2 == this) {
						return;
					}
				}
	...
	public void d(class_cj var1) {
		if (aj > 0) {
			...
			if (!o.D && !var1.equals(an)) {
				an = var1;
				class_apr.class_b_in_class_apr var2 = class_aim.aY.e(o, var1);
	...
	public class_qx a(int var1, class_cj var2) {
		if (!o.D && !I) {
			...
			var5.a(this, false);
			o.B.c("reloading");
			class_qx var16 = class_qz.a(class_qz.b(this), var6);
			if (var16 != null) {
				var16.b(this);
				if ((var4 == 1) && (var1 == 1)) {
	...
	public void a(class_c var1) {
		var1.a("Entity Type", new Callable() {
			public String a() throws Exception {
				return class_qz.b(class_qx.this) + " (" + class_qx.this.getClass().getCanonicalName() + ")";
			}
	...
	protected void a(class_rg var1, class_qx var2) {
	...
	public float a(class_ail.class_c_in_class_ail var1) {
		...
		switch (class_qx.SyntheticClass_1.a[var1.ordinal()]) {
			case 1:
				return var2 + 180.0F;
			case 2:
				return var2 + 270.0F;
	...
	public float a(class_ail.class_a_in_class_ail var1) {
		float var2 = class_oa.g(y);
		switch (class_qx.SyntheticClass_1.b[var1.ordinal()]) {
			case 1:
				return -var2;
			case 2:
				return 180.0F - var2;
	...
	static {
		as = class_kc.a(class_qx.class, class_kb.a);
		at = class_kc.a(class_qx.class, class_kb.b);
		au = class_kc.a(class_qx.class, class_kb.d);
		av = class_kc.a(class_qx.class, class_kb.g);
		aw = class_kc.a(class_qx.class, class_kb.g);
	}
