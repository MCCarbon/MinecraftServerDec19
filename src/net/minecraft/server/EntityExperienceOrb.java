...
public class EntityExperienceOrb extends Entity {
	...
	public EntityExperienceOrb(class_ago var1, double var2, double var4, double var6, int var8) {
		super(var1);
		this.a(0.5F, 0.5F);
	...
	public EntityExperienceOrb(class_ago var1) {
		super(var1);
		this.a(0.25F, 0.25F);
	}
	...
	public void r_() {
		...
		float var13 = 0.98F;
		if (C) {
			var13 = o.p(new class_cj(MathHelper.c(s), MathHelper.c(aX().b) - 1, MathHelper.c(u))).c().L * 0.98F;
		}
