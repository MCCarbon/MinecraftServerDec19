...
public class PacketPlayOutPlayerInfo implements Packet {
   ...
   public PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.class_a_in_class_gz var1, EntityPlayer... var2) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         this.b.add(new PacketPlayOutPlayerInfo.class_b_in_class_gz(var6.cf(), var6.h, var6.playerInteractManager.getGameMode(), var6.E()));
      }

   }

   public PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.class_a_in_class_gz var1, Iterable var2) {
      this.a = var1;
      Iterator var3 = var2.iterator();

      while(var3.hasNext()) {
         EntityPlayer var4 = (EntityPlayer)var3.next();
         this.b.add(new PacketPlayOutPlayerInfo.class_b_in_class_gz(var4.cf(), var4.h, var4.playerInteractManager.getGameMode(), var4.E()));
      }

   }

   public void decode(PacketDataSerializer var1) throws IOException {
      this.a = (PacketPlayOutPlayerInfo.class_a_in_class_gz)var1.readEnum(PacketPlayOutPlayerInfo.class_a_in_class_gz.class);
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         case 1:
            ...
            var6 = WorldSettings.EnumGameMode.getById(var1.readVarInt());
         ...
         this.b.add(new PacketPlayOutPlayerInfo.class_b_in_class_gz(var4, var5, var6, var7));
      }
   ...
   public void encode(PacketDataSerializer var1) throws IOException {
      ...
      while(true) {
         while(var2.hasNext()) {
            PacketPlayOutPlayerInfo.class_b_in_class_gz var3 = (PacketPlayOutPlayerInfo.class_b_in_class_gz)var2.next();
            switch(PacketPlayOutPlayerInfo.SyntheticClass_1.a[this.a.ordinal()]) {
            case 1:
   ...
   static class SyntheticClass_1 {
      // $FF: synthetic field
      static final int[] a = new int[PacketPlayOutPlayerInfo.class_a_in_class_gz.values().length];

      static {
         try {
            a[PacketPlayOutPlayerInfo.class_a_in_class_gz.a.ordinal()] = 1;
         } catch (NoSuchFieldError var5) {
            ;
         }

         try {
            a[PacketPlayOutPlayerInfo.class_a_in_class_gz.b.ordinal()] = 2;
         } catch (NoSuchFieldError var4) {
            ;
         }

         try {
            a[PacketPlayOutPlayerInfo.class_a_in_class_gz.c.ordinal()] = 3;
         } catch (NoSuchFieldError var3) {
            ;
         }

         try {
            a[PacketPlayOutPlayerInfo.class_a_in_class_gz.d.ordinal()] = 4;
         } catch (NoSuchFieldError var2) {
            ;
         }

         try {
            a[PacketPlayOutPlayerInfo.class_a_in_class_gz.e.ordinal()] = 5;
   ...
   public class class_b_in_class_gz {
      ...
      public class_b_in_class_gz(GameProfile var2, int var3, WorldSettings.EnumGameMode var4, IChatBaseComponent var5) {
         this.d = var2;
         this.b = var3;
         this.c = var4;
         this.e = var5;
