   ...
   public class_oq a(class_aas var1, class_xa var2, class_aen var3, class_cj var4, class_oo var5, class_cq var6, float var7, float var8, float var9) {
      if(var3.D) {
         ...
         if(var2.a(var4, var6, var1) && var2.a(var15, var6, var1)) {
            boolean var16 = var3.p(var15).getBlock().a(var3, var15);
            ...
            if(var17 && var18 && class_aen.a((class_aer)var3, (class_cj)var4.b()) && class_aen.a((class_aer)var3, (class_cj)var15.b())) {
               IBlockData var19 = class_agk.C.S().set(class_agh.b, Boolean.valueOf(false)).set(class_agh.O, var14).set(class_agh.a, class_agh.class_a_in_class_agh.b);
