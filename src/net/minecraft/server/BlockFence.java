...
public class BlockFence extends Block {
   ...
   public boolean e(IBlockAccess var1, BlockPosition var2) {
      ...
      return var3 == Blocks.BARRIER?false:((!(var3 instanceof BlockFence) || var3.material != this.material) && !(var3 instanceof BlockFenceGate)?(var3.material.isOpaque() && var3.isFullCube()?var3.material != Material.PUMPKIN:false):true);
   }
   ...
   public IBlockData a(IBlockData var1, Block.EnumRotation var2) {
      if(var1.getBlock() != this) {
         ...
         switch(BlockFence.SyntheticClass_1.a[var2.ordinal()]) {
         case 1:
   ...
   public IBlockData a(IBlockData var1, Block.class_a_in_class_agj var2) {
      if(var1.getBlock() != this) {
         ...
         switch(BlockFence.SyntheticClass_1.b[var2.ordinal()]) {
         case 1:
