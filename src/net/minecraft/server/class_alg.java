...
public class class_alg extends class_ago implements class_agl {
   ...
   protected class_alg(Block var1) {
      this.j(this.M.b().set(a, Integer.valueOf(0)).set(b, class_cq.b));
      this.N = var1;
      this.a(true);
      float var2 = 0.125F;
      ...
      if(var1.l(var2.a()) >= 9) {
         ...
         if(var4.nextInt((int)(25.0F / var5) + 1) == 0) {
            ...
            if(var6 < 7) {
               ...
               if(var1.p(var2).getBlock().J == class_atk.a && (var9 == class_agk.ak || var9 == class_agk.d || var9 == class_agk.c)) {
   ...
   public void a(class_aer var1, class_cj var2) {
      this.F = (double)((float)(((Integer)var1.p(var2).get(a)).intValue() * 2 + 2) / 16.0F);
      float var3 = 0.125F;
