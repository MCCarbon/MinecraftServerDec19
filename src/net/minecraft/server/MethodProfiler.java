...
public class MethodProfiler {
      ...
      if(!this.a) {
         ...
         while(var21.hasNext()) {
            ...
            if(var12.length() > var1.length() && var12.startsWith(var1) && var12.indexOf(".", var1.length() + 1) < 0) {
               ...
               var7.add(new MethodProfiler.class_a_in_class_nv(var19, var15, var17));
            }
         }
         ...
         if((float)var8 > var20) {
            var7.add(new MethodProfiler.class_a_in_class_nv("unspecified", (double)((float)var8 - var20) * 100.0D / (double)var8, (double)((float)var8 - var20) * 100.0D / (double)var3));
         }

         Collections.sort(var7);
         var7.add(0, new MethodProfiler.class_a_in_class_nv(var1, 100.0D, (double)var8 * 100.0D / (double)var3));
         return var7;
      }
   }
   ...
   public static final class class_a_in_class_nv implements Comparable {
      ...
      public int a(MethodProfiler.class_a_in_class_nv var1) {
         return var1.a < this.a?-1:(var1.a > this.a?1:var1.c.compareTo(this.c));
      }

      // $FF: synthetic method
      public int compareTo(Object var1) {
         return this.a((MethodProfiler.class_a_in_class_nv)var1);
      }
   }
}
