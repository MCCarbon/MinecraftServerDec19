...
public class EntitySlime extends EntityInsentient implements class_xx {
	...
	public EntitySlime(class_ago var1) {
		super(var1);
		f = new EntitySlime.class_d_in_class_yi(this);
		i.a(1, new EntitySlime.class_b_in_class_yi(this));
		i.a(2, new EntitySlime.class_a_in_class_yi(this));
		i.a(3, new EntitySlime.class_e_in_class_yi(this));
		i.a(5, new EntitySlime.class_c_in_class_yi(this));
		bo.a(1, new class_ue(this));
		bo.a(3, new class_ud(this, EntityVillagerGolem.class));
	}
	...
	public void i(Entity var1) {
		super.i(var1);
		if ((var1 instanceof EntityVillagerGolem) && cB()) {
	...
	static {
		br = DataWatcher.claimId(EntitySlime.class, class_kb.b);
	}

	static class class_c_in_class_yi extends class_sr {
		private EntitySlime a;

		public class_c_in_class_yi(EntitySlime var1) {
			a = var1;
			this.a(5);
		}
		...
		@Override
		public void e() {
			((EntitySlime.class_d_in_class_yi) a.r()).a(1.0D);
		}
	}
	...
	static class class_b_in_class_yi extends class_sr {
		...
		public class_b_in_class_yi(EntitySlime var1) {
			a = var1;
			this.a(5);
		...
		public void e() {
			...
			((EntitySlime.class_d_in_class_yi) a.r()).a(1.2D);
		}
	}
	...
	static class class_e_in_class_yi extends class_sr {
		...
		public class_e_in_class_yi(EntitySlime var1) {
			a = var1;
			this.a(2);
		}
		...
		public void e() {
			...
			((EntitySlime.class_d_in_class_yi) a.r()).a(b, false);
		}
	}
	...
	static class class_a_in_class_yi extends class_sr {
		...
		public class_a_in_class_yi(EntitySlime var1) {
			a = var1;
			this.a(2);
		}
		...
		public void e() {
			a.a(a.w(), 10.0F, 10.0F);
			((EntitySlime.class_d_in_class_yi) a.r()).a(a.y, a.cB());
		}
	}
	...
	static class class_d_in_class_yi extends class_se {
		...
		public class_d_in_class_yi(EntitySlime var1) {
			super(var1);
			i = var1;
		}
