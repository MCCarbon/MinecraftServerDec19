...
public class EntityItemFrame extends class_wt {
	private static final class_jz c;
	private static final class_jz d;
	private float e = 1.0F;

	public EntityItemFrame(class_ago var1) {
		super(var1);
	}

	public EntityItemFrame(class_ago var1, class_cj var2, class_cq var3) {
		super(var1, var2);
		this.a(var3);
	}
	...
	static {
		c = DataWatcher.claimId(EntityItemFrame.class, class_kb.f);
		d = DataWatcher.claimId(EntityItemFrame.class, class_kb.b);
	}
}
