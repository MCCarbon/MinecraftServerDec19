...
public class MobEffect {
	...
	public static final RegistryMaterials<MinecraftKey, MobEffect> b = new RegistryMaterials<MinecraftKey, MobEffect>();
	...
	public static MobEffect a(int var0) {
		return (MobEffect) b.get(var0);
	}

	public static int a(MobEffect var0) {
		return b.getId(var0);
	}

	public static MobEffect b(String var0) {
		return (MobEffect) b.get(new MinecraftKey(var0));
	}

	protected MobEffect(boolean var1, int var2) {
		this.c = var1;
		if (var1) {
			this.g = 0.5D;
		} else {
	...
	protected MobEffect b(int var1, int var2) {
		this.f = var1 + var2 * 8;
		return this;
	}
	...
	public MobEffect c(String var1) {
		this.e = var1;
		return this;
	}
	...
	protected MobEffect a(double var1) {
		this.g = var1;
		return this;
	}
	...
	public MobEffect a(class_qk var1, String var2, double var3, int var5) {
	...
	public static void k() {
		b.register(1, new MinecraftKey("speed"), (new MobEffect(false, 8171462)).c("effect.moveSpeed").b(0, 0).a(class_wl.d, "91AEAA56-376B-4498-935B-2F7F68070635", 0.20000000298023224D, 2).j());
		b.register(2, new MinecraftKey("slowness"), (new MobEffect(true, 5926017)).c("effect.moveSlowdown").b(1, 0).a(class_wl.d, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15000000596046448D, 2));
		b.register(3, new MinecraftKey("haste"), (new MobEffect(false, 14270531)).c("effect.digSpeed").b(2, 0).a(1.5D).j());
		b.register(4, new MinecraftKey("mining_fatigue"), (new MobEffect(true, 4866583)).c("effect.digSlowDown").b(3, 0));
		...
		b.register(8, new MinecraftKey("jump_boost"), (new MobEffect(false, 2293580)).c("effect.jump").b(2, 1).j());
		b.register(9, new MinecraftKey("nausea"), (new MobEffect(true, 5578058)).c("effect.confusion").b(3, 1).a(0.25D));
		b.register(10, new MinecraftKey("regeneration"), (new MobEffect(false, 13458603)).c("effect.regeneration").b(7, 0).a(0.25D).j());
		b.register(11, new MinecraftKey("resistance"), (new MobEffect(false, 10044730)).c("effect.resistance").b(6, 1).j());
		b.register(12, new MinecraftKey("fire_resistance"), (new MobEffect(false, 14981690)).c("effect.fireResistance").b(7, 1).j());
		b.register(13, new MinecraftKey("water_breathing"), (new MobEffect(false, 3035801)).c("effect.waterBreathing").b(0, 2).j());
		b.register(14, new MinecraftKey("invisibility"), (new MobEffect(false, 8356754)).c("effect.invisibility").b(0, 1).j());
		b.register(15, new MinecraftKey("blindness"), (new MobEffect(true, 2039587)).c("effect.blindness").b(5, 1).a(0.25D));
		b.register(16, new MinecraftKey("night_vision"), (new MobEffect(false, 2039713)).c("effect.nightVision").b(4, 1).j());
		b.register(17, new MinecraftKey("hunger"), (new MobEffect(true, 5797459)).c("effect.hunger").b(1, 1));
		...
		b.register(19, new MinecraftKey("poison"), (new MobEffect(true, 5149489)).c("effect.poison").b(6, 0).a(0.25D));
		b.register(20, new MinecraftKey("wither"), (new MobEffect(true, 3484199)).c("effect.wither").b(1, 2).a(0.25D));
		...
		b.register(24, new MinecraftKey("glowing"), (new MobEffect(false, 9740385)).c("effect.glowing").b(4, 2));
		b.register(25, new MinecraftKey("levitation"), (new MobEffect(true, 13565951)).c("potion.levitation").b(3, 2));
	}
