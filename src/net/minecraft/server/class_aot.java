...
public class class_aot {
   ...
   public DataOutputStream b(int var1, int var2) {
      return this.d(var1, var2)?null:new DataOutputStream(new DeflaterOutputStream(new class_aot.class_a_in_class_aot(var1, var2)));
   }
   ...
   class class_a_in_class_aot extends ByteArrayOutputStream {
      private int b;
      private int c;

      public class_a_in_class_aot(int var2, int var3) {
         super(8096);
         this.b = var2;
         this.c = var3;
      }
      ...
      public void close() {
         class_aot.this.a(this.b, this.c, this.buf, this.count);
      }
   }
}
