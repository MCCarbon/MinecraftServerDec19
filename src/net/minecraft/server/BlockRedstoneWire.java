...
public class BlockRedstoneWire extends Block {
   ...
   public boolean canPlace(World var1, BlockPosition var2) {
      return World.a((IBlockAccess)var1, (BlockPosition)var2.down()) || var1.getType(var2.down()).getBlock() == BlockStainedGlassPane.GLOWSTONE;
   }
   ...
   private boolean d(IBlockAccess var1, BlockPosition var2, EnumDirection var3) {
      ...
      return !var8 && var7 && e(var1, var4.up())?true:(a(var5, var3)?true:(var6 == BlockStainedGlassPane.POWERED_REPEATER && var5.get(class_ahh.FACING) == var3?true:!var7 && e(var1, var4.down())));
   }
   ...
   protected static boolean a(IBlockData var0, EnumDirection var1) {
      ...
      if(var2 == BlockStainedGlassPane.REDSTONE_WIRE) {
         return true;
      } else if(BlockStainedGlassPane.UNPOWERED_REPEATER.e(var2)) {
