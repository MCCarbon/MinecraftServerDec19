      ...
      if(var6 == class_cq.a) {
         ...
         if(!var2.a(var4, var6, var1)) {
            ...
            if(var6 == class_cq.b) {
               ...
               var3.a((class_cj)var4, (IBlockData)Blocks.STANDING_BANNER.getBlockData().set(class_ale.a, Integer.valueOf(var10)), 3);
            } else {
               var3.a((class_cj)var4, (IBlockData)Blocks.WALL_BANNER.getBlockData().set(class_alw.a, var6), 3);
            }
