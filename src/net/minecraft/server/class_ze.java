...
public class class_ze extends ItemBlock {
   public class_ze() {
      super(BlockStainedGlassPane.STANDING_BANNER);
      this.h = 16;
   ...
   public class_oq a(ItemStack var1, EntityHuman var2, World var3, BlockPosition var4, EnumUsedHand var5, EnumDirection var6, float var7, float var8, float var9) {
      if(var6 == EnumDirection.DOWN) {
         ...
         if(!var2.a(var4, var6, var1)) {
            return class_oq.b;
         } else if(!BlockStainedGlassPane.STANDING_BANNER.canPlace(var3, var4)) {
            return class_oq.b;
            ...
            if(var6 == EnumDirection.UP) {
               ...
               var3.setTypeAndData((BlockPosition)var4, (IBlockData)BlockStainedGlassPane.STANDING_BANNER.getBlockData().set(class_ale.a, Integer.valueOf(var10)), 3);
            } else {
               var3.setTypeAndData((BlockPosition)var4, (IBlockData)BlockStainedGlassPane.WALL_BANNER.getBlockData().set(class_alw.a, var6), 3);
            }
