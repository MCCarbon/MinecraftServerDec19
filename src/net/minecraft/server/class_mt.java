...
public class class_mt {
   ...
   static {
      ...
      g = (new class_ms("achievement.mineWood", "mineWood", 2, 1, BlockStainedGlassPane.LOG, f)).c();
      h = (new class_ms("achievement.buildWorkBench", "buildWorkBench", 4, -1, BlockStainedGlassPane.CRAFTING_TABLE, g)).c();
      i = (new class_ms("achievement.buildPickaxe", "buildPickaxe", 4, 2, Items.WOODEN_PICKAXE, h)).c();
      j = (new class_ms("achievement.buildFurnace", "buildFurnace", 3, 4, BlockStainedGlassPane.FURNACE, i)).c();
      ...
      q = (new class_ms("achievement.onARail", "onARail", 2, 3, BlockStainedGlassPane.RAIL, k)).b().c();
      ...
      w = (new class_ms("achievement.diamonds", "diamonds", -1, 5, BlockStainedGlassPane.DIAMOND_ORE, k)).c();
      x = (new class_ms("achievement.diamondsToYou", "diamondsToYou", -1, 2, Items.DIAMOND, w)).c();
      y = (new class_ms("achievement.portal", "portal", -1, 7, BlockStainedGlassPane.OBSIDIAN, w)).c();
      ...
      D = (new class_ms("achievement.theEnd2", "theEnd2", 4, 13, BlockStainedGlassPane.DRAGON_EGG, C)).b().c();
      E = (new class_ms("achievement.enchantments", "enchantments", -4, 4, BlockStainedGlassPane.ENCHANTING_TABLE, w)).c();
      F = (new class_ms("achievement.overkill", "overkill", -4, 1, Items.DIAMOND_SWORD, E)).b().c();
      G = (new class_ms("achievement.bookcase", "bookcase", -3, 6, BlockStainedGlassPane.BOOKSHELF, E)).c();
      ...
      K = (new class_ms("achievement.fullBeacon", "fullBeacon", 7, 8, BlockStainedGlassPane.BEACON, J)).b().c();
